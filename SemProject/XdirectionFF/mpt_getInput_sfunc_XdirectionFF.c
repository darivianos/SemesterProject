...
#define S_FUNCTION_NAME  mpt_getInput_sfunc_XdirectionFF   /*Name of the S-function file*/
...
#include "mpt_getInput_XdirectionFF.c"
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* get control law */
    region = mpt_getInput_XdirectionFF(X, U);
