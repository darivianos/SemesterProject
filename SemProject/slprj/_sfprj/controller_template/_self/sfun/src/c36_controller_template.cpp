  ...
  *chartInstance)
{
  ...
  *c36_sfEvent = CALL_EVENT;
  ...
  for (c36_i4 = 0; c36_i4 < 909; c36_i4++) {
    ...
    for (c36_i6 = 0; c36_i6 < 3; c36_i6++) {
      c36_X_ref_x[c36_i6 + 3 * c36_i5] = c36_traj_x[c36_i6 + 3 *
        (_SFD_EML_ARRAY_BOUNDS_CHECK("traj_x", (int32_T)_SFD_INTEGER_CHECK(
           "idx:idx+pred_horizon_x", c36_idx + (real_T)c36_i5), 1, 303, 2, 0) -
         1)];
    }
  }
  ...
  *c36_inData)
{
  ...
  c36_mxArrayOutData = NULL;
  c36_i18 = 0;
  for (c36_i19 = 0; c36_i19 < 303; c36_i19++) {
    for (c36_i20 = 0; c36_i20 < 3; c36_i20++) {
      c36_b_inData[c36_i20 + c36_i18] = (*(real_T (*)[909])c36_inData)[c36_i20 +
        c36_i18];
    }
  ...
  c36_i21 = 0;
  for (c36_i22 = 0; c36_i22 < 303; c36_i22++) {
  ...
  c36_y = NULL;
  sf_mex_assign(&c36_y, sf_mex_create("y", c36_u, 0, 0U, 1U, 0U, 2, 3, 303),
                FALSE);
  sf_mex_assign(&c36_mxArrayOutData, c36_y, FALSE);
  return c36_mxArrayOutData;
}
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c36_X_ref_x = (real_T (*)[93])ssGetOutputPortSignal(chartInstance->S,
            1);
          c36_traj_x = (real_T (*)[909])ssGetInputPortSignal(chartInstance->S, 0);
