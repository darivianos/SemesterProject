  ...
  *chartInstance)
{
  ...
  int32_T c38_i4;
  real_T c38_X_ref_yaw_unbounded[606];
  real_T c38_yaw_meas;
  real_T c38_idx;
  ...
  real_T (*c38_b_X_ref_yaw_unbounded)[606];
  ...
  c38_b_X_ref_yaw_unbounded = (real_T (*)[606])ssGetInputPortSignal
    (chartInstance->S, 0);
  c38_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 37U, *c38_sfEvent);
  for (c38_i2 = 0; c38_i2 < 606; c38_i2++) {
  ...
  *c38_sfEvent = CALL_EVENT;
  ...
  for (c38_i4 = 0; c38_i4 < 606; c38_i4++) {
  ...
  c38_yaw0 = c38_X_ref_yaw_unbounded[(_SFD_EML_ARRAY_BOUNDS_CHECK(
    "X_ref_yaw_unbounded", (int32_T)_SFD_INTEGER_CHECK("idx", c38_idx), 1, 303,
    2, 0) - 1) << 1];
  ...
  *c38_inData)
{
  ...
  c38_mxArrayOutData = NULL;
  c38_i18 = 0;
  for (c38_i19 = 0; c38_i19 < 303; c38_i19++) {
    for (c38_i20 = 0; c38_i20 < 2; c38_i20++) {
      c38_b_inData[c38_i20 + c38_i18] = (*(real_T (*)[606])c38_inData)[c38_i20 +
        c38_i18];
    }
  ...
  c38_i21 = 0;
  for (c38_i22 = 0; c38_i22 < 303; c38_i22++) {
  ...
  c38_y = NULL;
  sf_mex_assign(&c38_y, sf_mex_create("y", c38_u, 0, 0U, 1U, 0U, 2, 2, 303),
                FALSE);
  sf_mex_assign(&c38_mxArrayOutData, c38_y, FALSE);
  return c38_mxArrayOutData;
}
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c38_X_ref_yaw = (real_T (*)[62])ssGetOutputPortSignal(chartInstance->S,
            1);
          c38_X_ref_yaw_unbounded = (real_T (*)[606])ssGetInputPortSignal
            (chartInstance->S, 0);
