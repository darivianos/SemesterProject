  ...
  *chartInstance)
{
  ...
  c41_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 40U, *c41_sfEvent);
  ...
  *c41_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 40U, *c41_sfEvent);
  ...
  *c41_b_flag_failure = c41_flag_failure;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 40U, *c41_sfEvent);
