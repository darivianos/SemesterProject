  ...
  *chartInstance)
{
  ...
  c43_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 42U, *c43_sfEvent);
  ...
  *c43_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 42U, *c43_sfEvent);
  ...
  *c43_b_flag_init = c43_flag_init;
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 42U, *c43_sfEvent);
