  ...
  (SFc16_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c16_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 8U, *c16_sfEvent);
  ...
  (SFc16_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c16_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 8U, *c16_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 8U, *c16_sfEvent);
}
