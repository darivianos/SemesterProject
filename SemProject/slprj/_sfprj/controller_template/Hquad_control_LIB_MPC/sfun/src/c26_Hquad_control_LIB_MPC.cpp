  ...
  (SFc26_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c26_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 9U, *c26_sfEvent);
  ...
  (SFc26_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c26_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 9U, *c26_sfEvent);
  ...
  *c26_b_roll_bias_rot = c26_roll_bias_rot;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 9U, *c26_sfEvent);
}
