...
MODEL                = tst_mpt
MODULES              = rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c tst_mpt_data.c 
MAKEFILE             = tst_mpt.mk
MATLAB_ROOT          = /usr/local/MATLAB/R2013a
ALT_MATLAB_ROOT      = /usr/local/MATLAB/R2013a
MATLAB_BIN           = /usr/local/MATLAB/R2013a/bin
MASTER_ANCHOR_DIR    = 
...
ifeq ($(CLASSIC_INTERFACE), 1)
LINT_SRCS = $(MATLAB_ROOT)/rtw/c/grt/classic_main.c \
