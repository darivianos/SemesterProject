...
static void initialize_c3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance);
static void initialize_params_c3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance);
static void enable_c3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance);
static void disable_c3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance);
static void set_sim_state_c3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance, const
   mxArray *c3_st);
static void finalize_c3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance);
static void sf_c3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance);
static void c3_chartstep_c3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance);
static void initSimStructsc3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance);
static void registerMessagesc3_Simulator_Template_FreeFlight_vTST
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance);
...
static void c3_e_emlrt_marshallIn
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance, const
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[200]);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[26]);
static void c3_round(SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct
...
static uint8_T c3_g_emlrt_marshallIn
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance, const
   mxArray *c3_b_is_active_c3_Simulator_Template_FreeFlight_vTST, const char_T
   *c3_identifier);
static uint8_T c3_h_emlrt_marshallIn
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance, const
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_round(SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct
  ...
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Simulator_Template_FreeFlight_vTST = 0U;
}
  ...
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance)
{
  ...
  c3_c_hoistedGlobal =
    chartInstance->c3_is_active_c3_Simulator_Template_FreeFlight_vTST;
   ...
   mxArray *c3_st)
{
  ...
  *c3_flag_oob = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c3_is_active_c3_Simulator_Template_FreeFlight_vTST =
    ...
    "is_active_c3_Simulator_Template_FreeFlight_vTST");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_Simulator_Template_FreeFlight_vTST(chartInstance);
  ...
  (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_Simulator_Template_FreeFlight_vTST(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance;
  chartInstance = (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c3_Simulator_Template_FreeFlight_vTST_get_eml_resolved_functions_info(void)
{
   ...
   *c3_identifier)
{
  ...
  c3_y = c3_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Simulator_Template_FreeFlight_vTST), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Simulator_Template_FreeFlight_vTST);
  return c3_y;
}
...
void sf_c3_Simulator_Template_FreeFlight_vTST_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_Simulator_Template_FreeFlight_vTST_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_Simulator_Template_FreeFlight_vTST_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c3_Simulator_Template_FreeFlight_vTST(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"U\",},{M[1],M[16],T\"flag_oob\",},{M[8],M[0],T\"is_active_c3_Simulator_Template_FreeFlight_vTST\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Simulator_Template_FreeFlight_vTST_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_Simulator_Template_FreeFlight_vTST(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c3_Simulator_Template_FreeFlight_vTST
    ((SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct*) chartInstanceVar);
  initialize_c3_Simulator_Template_FreeFlight_vTST
    ((SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_Simulator_Template_FreeFlight_vTST(void
  *chartInstanceVar)
{
  enable_c3_Simulator_Template_FreeFlight_vTST
    ((SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_Simulator_Template_FreeFlight_vTST(void
  *chartInstanceVar)
{
  disable_c3_Simulator_Template_FreeFlight_vTST
    ((SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_Simulator_Template_FreeFlight_vTST(void
  *chartInstanceVar)
{
  sf_c3_Simulator_Template_FreeFlight_vTST
    ((SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c3_Simulator_Template_FreeFlight_vTST(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_Simulator_Template_FreeFlight_vTST
    ((SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c3_Simulator_Template_FreeFlight_vTST();/* state var info */
...
extern void sf_internal_set_sim_state_c3_Simulator_Template_FreeFlight_vTST
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c3_Simulator_Template_FreeFlight_vTST
    ((SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c3_Simulator_Template_FreeFlight_vTST(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_Simulator_Template_FreeFlight_vTST(S);
}

static void sf_opaque_set_sim_state_c3_Simulator_Template_FreeFlight_vTST
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_Simulator_Template_FreeFlight_vTST(S, st);
}

static void sf_opaque_terminate_c3_Simulator_Template_FreeFlight_vTST(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c3_Simulator_Template_FreeFlight_vTST
      ((SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_Simulator_Template_FreeFlight_vTST
    ((SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Simulator_Template_FreeFlight_vTST(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Simulator_Template_FreeFlight_vTST(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c3_Simulator_Template_FreeFlight_vTST(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Simulator_Template_FreeFlight_vTST(SimStruct *S)
{
  SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *chartInstance;
  chartInstance = (SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct *)
    utMalloc(sizeof(SFc3_Simulator_Template_FreeFlight_vTSTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Simulator_Template_FreeFlight_vTST;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Simulator_Template_FreeFlight_vTST;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_Simulator_Template_FreeFlight_vTST;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_Simulator_Template_FreeFlight_vTST;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_Simulator_Template_FreeFlight_vTST;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_Simulator_Template_FreeFlight_vTST;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_Simulator_Template_FreeFlight_vTST;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_Simulator_Template_FreeFlight_vTST;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_Simulator_Template_FreeFlight_vTST;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_Simulator_Template_FreeFlight_vTST;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_Simulator_Template_FreeFlight_vTST;
...
void c3_Simulator_Template_FreeFlight_vTST_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Simulator_Template_FreeFlight_vTST(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Simulator_Template_FreeFlight_vTST(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Simulator_Template_FreeFlight_vTST(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Simulator_Template_FreeFlight_vTST_method_dispatcher.\n"
