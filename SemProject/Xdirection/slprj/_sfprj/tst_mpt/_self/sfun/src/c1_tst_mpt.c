...
static void initialize_c1_tst_mpt(SFc1_tst_mptInstanceStruct *chartInstance);
static void initialize_params_c1_tst_mpt(SFc1_tst_mptInstanceStruct
  *chartInstance);
static void enable_c1_tst_mpt(SFc1_tst_mptInstanceStruct *chartInstance);
static void disable_c1_tst_mpt(SFc1_tst_mptInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_tst_mpt(SFc1_tst_mptInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_tst_mpt(SFc1_tst_mptInstanceStruct
  *chartInstance);
static void set_sim_state_c1_tst_mpt(SFc1_tst_mptInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_tst_mpt(SFc1_tst_mptInstanceStruct *chartInstance);
static void sf_c1_tst_mpt(SFc1_tst_mptInstanceStruct *chartInstance);
static void c1_chartstep_c1_tst_mpt(SFc1_tst_mptInstanceStruct *chartInstance);
static void initSimStructsc1_tst_mpt(SFc1_tst_mptInstanceStruct *chartInstance);
static void registerMessagesc1_tst_mpt(SFc1_tst_mptInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_tst_mptInstanceStruct *chartInstance,
  const mxArray *c1_flag_oob, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_tst_mptInstanceStruct *chartInstance,
...
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_tst_mptInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[4]);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_h_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_tst_mptInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[100]);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_i_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_tst_mptInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[400]);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[26]);
static void c1_round(SFc1_tst_mptInstanceStruct *chartInstance, real_T c1_x[4],
                     real_T c1_b_x[4]);
static void c1_eml_scalar_eg(SFc1_tst_mptInstanceStruct *chartInstance);
static const mxArray *c1_j_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_f_emlrt_marshallIn(SFc1_tst_mptInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_g_emlrt_marshallIn(SFc1_tst_mptInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_tst_mpt, const char_T *c1_identifier);
static uint8_T c1_h_emlrt_marshallIn(SFc1_tst_mptInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_round(SFc1_tst_mptInstanceStruct *chartInstance, real_T c1_x[4]);
static void init_dsm_address_info(SFc1_tst_mptInstanceStruct *chartInstance);
...
static void initialize_c1_tst_mpt(SFc1_tst_mptInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_tst_mpt = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_c_hoistedGlobal = chartInstance->c1_is_active_c1_tst_mpt;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_flag_oob = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 1)), "flag_oob");
  chartInstance->c1_is_active_c1_tst_mpt = c1_g_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 2)), "is_active_c1_tst_mpt");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_tst_mpt(chartInstance);
...
static void sf_c1_tst_mpt(SFc1_tst_mptInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_tst_mpt(chartInstance);
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_tst_mptMachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u;
  const mxArray *c1_y = NULL;
  SFc1_tst_mptInstanceStruct *chartInstance;
  chartInstance = (SFc1_tst_mptInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_tst_mpt_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_b_is_active_c1_tst_mpt, const char_T *c1_identifier)
{
  ...
  c1_y = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_tst_mpt), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_tst_mpt);
  return c1_y;
}
...
void sf_c1_tst_mpt_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_tst_mpt_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_tst_mpt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c1_tst_mpt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"U\",},{M[1],M[16],T\"flag_oob\",},{M[8],M[0],T\"is_active_c1_tst_mpt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_tst_mpt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_tst_mptInstanceStruct *chartInstance;
    chartInstance = (SFc1_tst_mptInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_tst_mptMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_tst_mptMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _tst_mptMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_tst_mpt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_tst_mptInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c1_tst_mpt((SFc1_tst_mptInstanceStruct*) chartInstanceVar);
  initialize_c1_tst_mpt((SFc1_tst_mptInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_tst_mpt(void *chartInstanceVar)
{
  enable_c1_tst_mpt((SFc1_tst_mptInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_tst_mpt(void *chartInstanceVar)
{
  disable_c1_tst_mpt((SFc1_tst_mptInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_tst_mpt(void *chartInstanceVar)
{
  sf_c1_tst_mpt((SFc1_tst_mptInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_tst_mpt(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_tst_mpt((SFc1_tst_mptInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_tst_mpt();/* state var info */
...
extern void sf_internal_set_sim_state_c1_tst_mpt(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_tst_mpt((SFc1_tst_mptInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_tst_mpt(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_tst_mpt(S);
}

static void sf_opaque_set_sim_state_c1_tst_mpt(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_tst_mpt(S, st);
}

static void sf_opaque_terminate_c1_tst_mpt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_tst_mptInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_tst_mpt_optimization_info();
    }

    finalize_c1_tst_mpt((SFc1_tst_mptInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_tst_mpt((SFc1_tst_mptInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_tst_mpt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_tst_mpt((SFc1_tst_mptInstanceStruct*)(((ChartInfoStruct
      *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_tst_mpt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_tst_mpt_optimization_info();
...
static void mdlRTW_c1_tst_mpt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_tst_mpt(SimStruct *S)
{
  SFc1_tst_mptInstanceStruct *chartInstance;
  chartInstance = (SFc1_tst_mptInstanceStruct *)utMalloc(sizeof
    (SFc1_tst_mptInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_tst_mptInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_tst_mpt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_tst_mpt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_tst_mpt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_tst_mpt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_tst_mpt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_tst_mpt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_tst_mpt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_tst_mpt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_tst_mpt;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_tst_mpt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_tst_mpt;
...
void c1_tst_mpt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_tst_mpt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_tst_mpt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_tst_mpt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_tst_mpt_method_dispatcher.\n"
