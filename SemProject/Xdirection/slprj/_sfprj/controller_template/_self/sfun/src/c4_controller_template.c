...
static void initSimStructsc4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance);
static void registerMessagesc4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance);
...
static uint8_T c4_e_emlrt_marshallIn(SFc4_controller_templateInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_controller_template, const
  ...
  (SFc4_controller_templateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_controller_template = 0U;
}
  ...
  (SFc4_controller_templateInstanceStruct *chartInstance)
{
  ...
  c4_c_hoistedGlobal = chartInstance->c4_is_active_c4_controller_template;
  ...
  (SFc4_controller_templateInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_flag_oob = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 1)), "flag_oob");
  chartInstance->c4_is_active_c4_controller_template = c4_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 2)),
     "is_active_c4_controller_template");
  sf_mex_destroy(&c4_u);
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_controller_template), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_controller_template);
  return c4_y;
}
...
mxArray *sf_c4_controller_template_third_party_uses_info(void)
{
...
{
  SFc4_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc4_controller_templateInstanceStruct *)utMalloc(sizeof
