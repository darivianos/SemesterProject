...
static void initSimStructsc1_controller_template
  (SFc1_controller_templateInstanceStruct *chartInstance);
static void registerMessagesc1_controller_template
  (SFc1_controller_templateInstanceStruct *chartInstance);
...
static uint8_T c1_g_emlrt_marshallIn(SFc1_controller_templateInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_controller_template, const
  ...
  (SFc1_controller_templateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_controller_template = 0U;
}
  ...
  (SFc1_controller_templateInstanceStruct *chartInstance)
{
  ...
  c1_c_hoistedGlobal = chartInstance->c1_is_active_c1_controller_template;
  ...
  (SFc1_controller_templateInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_flag_oob = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 1)), "flag_oob");
  chartInstance->c1_is_active_c1_controller_template = c1_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_controller_template");
  sf_mex_destroy(&c1_u);
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_controller_template), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_controller_template);
  return c1_y;
}
...
mxArray *sf_c1_controller_template_third_party_uses_info(void)
{
...
{
  SFc1_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc1_controller_templateInstanceStruct *)utMalloc(sizeof
