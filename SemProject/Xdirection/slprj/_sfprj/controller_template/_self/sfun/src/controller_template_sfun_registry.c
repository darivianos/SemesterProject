...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_controller_template_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Hquad_control_LIB_MPC_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_controller_template_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_controller_template_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "controller_template") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_controller_template_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_controller_template_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "controller_template") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_controller_template_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_controller_template_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "controller_template") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_controller_template_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_controller_template_method_dispatcher(SimStruct *S,
  ...
  method, void *data)
{
  if (!strcmp(machineName,"controller_template")) {
    return(sf_controller_template_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void controller_template_terminator(void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    controller_template_terminator();
...
extern void controller_template_initializer(void);
extern void Hquad_control_LIB_MPC_initializer(void);
extern void controller_template_register_exported_symbols(SimStruct* S);
extern void Hquad_control_LIB_MPC_register_exported_symbols(SimStruct* S);
extern void controller_template_debug_initialize(struct SfDebugInstanceStruct*);
...
{
  controller_template_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      controller_template_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    controller_template_initializer();
    if (!simModeIsRTWGen) {
