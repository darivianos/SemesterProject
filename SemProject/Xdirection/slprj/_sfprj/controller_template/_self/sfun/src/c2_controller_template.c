...
static void sf_c2_controller_template(SFc2_controller_templateInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_controller_template
  (SFc2_controller_templateInstanceStruct *chartInstance);
static void initSimStructsc2_controller_template
  (SFc2_controller_templateInstanceStruct *chartInstance);
static void registerMessagesc2_controller_template
  (SFc2_controller_templateInstanceStruct *chartInstance);
...
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_controller_templateInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[4]);
...
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_controller_templateInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[100]);
...
static const mxArray *c2_i_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_controller_templateInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[400]);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[26]);
static void c2_round(SFc2_controller_templateInstanceStruct *chartInstance,
                     real_T c2_x[4], real_T c2_b_x[4]);
static void c2_eml_scalar_eg(SFc2_controller_templateInstanceStruct
  *chartInstance);
static const mxArray *c2_j_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_controller_templateInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_controller_templateInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_controller_template, const
  char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_controller_templateInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_round(SFc2_controller_templateInstanceStruct *chartInstance,
  real_T c2_x[4]);
  ...
  (SFc2_controller_templateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_controller_template = 0U;
}
  ...
  (SFc2_controller_templateInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_controller_template;
  ...
  (SFc2_controller_templateInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_flag_oob = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 1)), "flag_oob");
  chartInstance->c2_is_active_c2_controller_template = c2_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_controller_template");
  sf_mex_destroy(&c2_u);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_controller_template(chartInstance);
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_controller_template), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_controller_template);
  return c2_y;
}
...
mxArray *sf_c2_controller_template_third_party_uses_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_controller_template(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"U\",},{M[1],M[16],T\"flag_oob\",},{M[8],M[0],T\"is_active_c2_controller_template\",}}"
  };
...
{
  SFc2_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc2_controller_templateInstanceStruct *)utMalloc(sizeof
