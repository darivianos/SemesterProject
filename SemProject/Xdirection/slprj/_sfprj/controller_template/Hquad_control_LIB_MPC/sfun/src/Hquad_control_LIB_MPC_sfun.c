  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"Hquad_control_LIB_MPC")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1485185517U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4203088817U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3488985756U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(477497452U);
        } else if (nrhs==4) {
  ...
  debugInstance)
{
  _Hquad_control_LIB_MPCMachineNumber_ = sf_debug_initialize_machine
    (debugInstance,"Hquad_control_LIB_MPC","sfun",1,11,0,0,0);
