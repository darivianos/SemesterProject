#include "HquadHybridModel_sfun.h"
#include "sfcdebug.h"
...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_HquadHybridModel_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Hqaud_model_LIB_SI_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_HquadHybridModel_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_HquadHybridModel_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "HquadHybridModel") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_HquadHybridModel_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_HquadHybridModel_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "HquadHybridModel") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_HquadHybridModel_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_HquadHybridModel_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "HquadHybridModel") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_HquadHybridModel_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_HquadHybridModel_method_dispatcher(SimStruct *S, unsigned
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"HquadHybridModel")) {
    return(sf_HquadHybridModel_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void HquadHybridModel_terminator(void);
...
extern void HquadHybridModel_initializer(void);
extern void Hqaud_model_LIB_SI_initializer(void);
extern void HquadHybridModel_register_exported_symbols(SimStruct* S);
extern void Hqaud_model_LIB_SI_register_exported_symbols(SimStruct* S);
extern void HquadHybridModel_debug_initialize(struct SfDebugInstanceStruct*);
...
{
  HquadHybridModel_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      HquadHybridModel_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    HquadHybridModel_initializer();
    if (!simModeIsRTWGen) {
