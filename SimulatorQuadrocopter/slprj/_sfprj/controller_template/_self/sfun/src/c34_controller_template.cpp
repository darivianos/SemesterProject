  ...
  *chartInstance)
{
  ...
  *c34_sfEvent = CALL_EVENT;
  ...
  for (c34_i4 = 0; c34_i4 < 806; c34_i4++) {
    ...
    for (c34_i6 = 0; c34_i6 < 2; c34_i6++) {
      c34_X_ref_z[c34_i6 + (c34_i5 << 1)] = c34_traj_z[c34_i6 +
        ((_SFD_EML_ARRAY_BOUNDS_CHECK("traj_z", (int32_T)_SFD_INTEGER_CHECK(
            "idx:idx+pred_horizon_z", c34_idx + (real_T)c34_i5), 1, 403, 2, 0) -
          1) << 1)];
    }
  }
  ...
  *c34_inData)
{
  ...
  c34_mxArrayOutData = NULL;
  c34_i18 = 0;
  for (c34_i19 = 0; c34_i19 < 403; c34_i19++) {
    for (c34_i20 = 0; c34_i20 < 2; c34_i20++) {
      c34_b_inData[c34_i20 + c34_i18] = (*(real_T (*)[806])c34_inData)[c34_i20 +
        c34_i18];
    }
  ...
  c34_i21 = 0;
  for (c34_i22 = 0; c34_i22 < 403; c34_i22++) {
  ...
  c34_y = NULL;
  sf_mex_assign(&c34_y, sf_mex_create("y", c34_u, 0, 0U, 1U, 0U, 2, 2, 403),
                FALSE);
  sf_mex_assign(&c34_mxArrayOutData, c34_y, FALSE);
  return c34_mxArrayOutData;
}
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c34_X_ref_z = (real_T (*)[62])ssGetOutputPortSignal(chartInstance->S,
            1);
          c34_traj_z = (real_T (*)[806])ssGetInputPortSignal(chartInstance->S, 0);
