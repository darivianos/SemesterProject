...
{
  extern unsigned int sf_controller_template_process_testpoint_info_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Hquad_control_LIB_MPC_process_testpoint_info_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_controller_template_process_testpoint_info_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
extern void controller_template_debug_initialize(void);
...
extern "C" void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      controller_template_debug_initialize();
    }
