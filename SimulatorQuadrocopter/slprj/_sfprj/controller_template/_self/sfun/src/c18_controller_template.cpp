...
static const char * c18_debug_family_names[5] = { "nargin", "nargout", "u",
  "thres", "y" };
  ...
  (SFc18_controller_templateInstanceStruct *chartInstance)
{
  ...
  c18_b_hoistedGlobal = *c18_is_active_c18_controller_template;
  ...
  (SFc18_controller_templateInstanceStruct *chartInstance, const mxArray *c18_st)
{
  ...
  *c18_is_active_c18_controller_template = c18_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c18_u, 1)), "is_active_c18_controller_template");
  ...
  *chartInstance)
{
  ...
  real_T *c18_d_y;
  real_T *c18_b_thres;
  c18_b_thres = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c18_d_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_DATA_RANGE_CHECK(*c18_b_thres, 2U);
  *c18_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 17U, *c18_sfEvent);
  c18_hoistedGlobal = *c18_b_u;
  c18_b_hoistedGlobal = *c18_b_thres;
  c18_u = c18_hoistedGlobal;
  c18_thres = c18_b_hoistedGlobal;
  ...
  sf_debug_symbol_scope_add_eml(&c18_thres, 3U, c18_sf_marshallOut);
  ...
  c18_x = c18_u;
  c18_b_x = c18_x;
  c18_b_y = muDoubleScalarAbs(c18_b_x);
  c18_c_x = c18_thres;
  c18_d_x = c18_c_x;
  c18_c_y = muDoubleScalarAbs(c18_d_x);
  if (CV_EML_IF(0, 1, 0, c18_b_y < c18_c_y)) {
    _SFD_EML_CALL(0U, *c18_sfEvent, 4);
    c18_y = 0.0;
  } else {
    _SFD_EML_CALL(0U, *c18_sfEvent, 6);
    c18_y = c18_u;
  }
...
const mxArray *sf_c18_controller_template_get_eml_resolved_functions_info(void)
{
  ...
  c18_ResolvedFunctionInfo c18_info[2];
  c18_ResolvedFunctionInfo (*c18_b_info)[2];
  const mxArray *c18_m0 = NULL;
  int32_T c18_i0;
  c18_ResolvedFunctionInfo *c18_r0;
  c18_nameCaptureInfo = NULL;
  c18_nameCaptureInfo = NULL;
  c18_b_info = (c18_ResolvedFunctionInfo (*)[2])c18_info;
  ...
  sf_mex_assign(&c18_m0, sf_mex_createstruct("nameCaptureInfo", 1, 2), FALSE);
...
static const mxArray *sf_get_sim_state_info_c18_controller_template(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c18_controller_template\",}}"
  };
