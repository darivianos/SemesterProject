  ...
  *chartInstance)
{
  ...
  *c31_sfEvent = CALL_EVENT;
  ...
  for (c31_i4 = 0; c31_i4 < 1332; c31_i4++) {
    ...
    for (c31_i6 = 0; c31_i6 < 3; c31_i6++) {
      c31_X_ref_x[c31_i6 + 3 * c31_i5] = c31_traj_x[c31_i6 + 3 *
        (_SFD_EML_ARRAY_BOUNDS_CHECK("traj_x", (int32_T)_SFD_INTEGER_CHECK(
           "idx:idx+pred_horizon_x", c31_idx + (real_T)c31_i5), 1, 444, 2, 0) -
         1)];
    }
  }
  ...
  *c31_inData)
{
  ...
  c31_mxArrayOutData = NULL;
  c31_i18 = 0;
  for (c31_i19 = 0; c31_i19 < 444; c31_i19++) {
    for (c31_i20 = 0; c31_i20 < 3; c31_i20++) {
      c31_b_inData[c31_i20 + c31_i18] = (*(real_T (*)[1332])c31_inData)[c31_i20
        + c31_i18];
    }
  ...
  c31_i21 = 0;
  for (c31_i22 = 0; c31_i22 < 444; c31_i22++) {
  ...
  c31_y = NULL;
  sf_mex_assign(&c31_y, sf_mex_create("y", c31_u, 0, 0U, 1U, 0U, 2, 3, 444),
                FALSE);
  sf_mex_assign(&c31_mxArrayOutData, c31_y, FALSE);
  return c31_mxArrayOutData;
}
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c31_X_ref_x = (real_T (*)[93])ssGetOutputPortSignal(chartInstance->S,
            1);
          c31_traj_x = (real_T (*)[1332])ssGetInputPortSignal(chartInstance->S,
            0);
