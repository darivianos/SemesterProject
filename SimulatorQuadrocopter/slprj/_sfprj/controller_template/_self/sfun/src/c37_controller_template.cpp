  ...
  *chartInstance)
{
  ...
  *c37_sfEvent = CALL_EVENT;
  ...
  for (c37_i4 = 0; c37_i4 < 1209; c37_i4++) {
    ...
    for (c37_i6 = 0; c37_i6 < 3; c37_i6++) {
      c37_X_ref_y[c37_i6 + 3 * c37_i5] = c37_traj_y[c37_i6 + 3 *
        (_SFD_EML_ARRAY_BOUNDS_CHECK("traj_y", (int32_T)_SFD_INTEGER_CHECK(
           "idx:idx+pred_horizon_y", c37_idx + (real_T)c37_i5), 1, 403, 2, 0) -
         1)];
    }
  }
  ...
  *c37_inData)
{
  ...
  c37_mxArrayOutData = NULL;
  c37_i18 = 0;
  for (c37_i19 = 0; c37_i19 < 403; c37_i19++) {
    for (c37_i20 = 0; c37_i20 < 3; c37_i20++) {
      c37_b_inData[c37_i20 + c37_i18] = (*(real_T (*)[1209])c37_inData)[c37_i20
        + c37_i18];
    }
  ...
  c37_i21 = 0;
  for (c37_i22 = 0; c37_i22 < 403; c37_i22++) {
  ...
  c37_y = NULL;
  sf_mex_assign(&c37_y, sf_mex_create("y", c37_u, 0, 0U, 1U, 0U, 2, 3, 403),
                FALSE);
  sf_mex_assign(&c37_mxArrayOutData, c37_y, FALSE);
  return c37_mxArrayOutData;
}
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c37_X_ref_y = (real_T (*)[93])ssGetOutputPortSignal(chartInstance->S,
            1);
          c37_traj_y = (real_T (*)[1209])ssGetInputPortSignal(chartInstance->S,
            0);
