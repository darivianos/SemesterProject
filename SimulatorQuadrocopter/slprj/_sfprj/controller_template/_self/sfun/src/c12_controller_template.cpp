  ...
  *c12_sfEvent = CALL_EVENT;
  ...
  for (c12_i5 = 0; c12_i5 < 31; c12_i5++) {
    for (c12_i6 = 0; c12_i6 < 3; c12_i6++) {
      c12_X_ref_y[c12_i6 + 3 * c12_i5] = c12_traj_y[c12_i6 + 3 *
        (_SFD_EML_ARRAY_BOUNDS_CHECK("traj_y", (int32_T)_SFD_INTEGER_CHECK(
           "idx:idx+pred_horizon_y", c12_idx + (real_T)c12_i5), 1, 10, 2, 0) - 1)];
    }
  }
  ...
  *c12_inData)
{
  ...
  c12_mxArrayOutData = NULL;
  c12_i18 = 0;
  for (c12_i19 = 0; c12_i19 < 10; c12_i19++) {
    for (c12_i20 = 0; c12_i20 < 3; c12_i20++) {
      c12_b_inData[c12_i20 + c12_i18] = (*(real_T (*)[30])c12_inData)[c12_i20 +
        c12_i18];
    }
  ...
  for (c12_i22 = 0; c12_i22 < 10; c12_i22++) {
    for (c12_i23 = 0; c12_i23 < 3; c12_i23++) {
      c12_u[c12_i23 + c12_i21] = c12_b_inData[c12_i23 + c12_i21];
    }
  ...
  c12_y = NULL;
  sf_mex_assign(&c12_y, sf_mex_create("y", c12_u, 0, 0U, 1U, 0U, 2, 3, 10),
                FALSE);
  sf_mex_assign(&c12_mxArrayOutData, c12_y, FALSE);
  return c12_mxArrayOutData;
}
  ...
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId)
{
  int32_T c12_y;
  int32_T c12_i24;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), &c12_i24, 1, 6, 0U, 0, 0U, 0);
  c12_y = c12_i24;
  sf_mex_destroy(&c12_u);
  return c12_y;
}
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c12_X_ref_y = (real_T (*)[93])ssGetOutputPortSignal(chartInstance->S,
            1);
          c12_traj_y = (real_T (*)[30])ssGetInputPortSignal(chartInstance->S, 0);
