  ...
  *chartInstance)
{
  ...
  int32_T c33_i4;
  real_T c33_X_ref_yaw_unbounded[806];
  real_T c33_yaw_meas;
  real_T c33_idx;
  ...
  real_T (*c33_b_X_ref_yaw_unbounded)[806];
  ...
  c33_b_X_ref_yaw_unbounded = (real_T (*)[806])ssGetInputPortSignal
    (chartInstance->S, 0);
  c33_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 32U, *c33_sfEvent);
  for (c33_i2 = 0; c33_i2 < 806; c33_i2++) {
  ...
  *c33_sfEvent = CALL_EVENT;
  ...
  for (c33_i4 = 0; c33_i4 < 806; c33_i4++) {
  ...
  c33_yaw0 = c33_X_ref_yaw_unbounded[(_SFD_EML_ARRAY_BOUNDS_CHECK(
    "X_ref_yaw_unbounded", (int32_T)_SFD_INTEGER_CHECK("idx", c33_idx), 1, 403,
    2, 0) - 1) << 1];
  ...
  *c33_inData)
{
  ...
  c33_mxArrayOutData = NULL;
  c33_i18 = 0;
  for (c33_i19 = 0; c33_i19 < 403; c33_i19++) {
    for (c33_i20 = 0; c33_i20 < 2; c33_i20++) {
      c33_b_inData[c33_i20 + c33_i18] = (*(real_T (*)[806])c33_inData)[c33_i20 +
        c33_i18];
    }
  ...
  c33_i21 = 0;
  for (c33_i22 = 0; c33_i22 < 403; c33_i22++) {
  ...
  c33_y = NULL;
  sf_mex_assign(&c33_y, sf_mex_create("y", c33_u, 0, 0U, 1U, 0U, 2, 2, 403),
                FALSE);
  sf_mex_assign(&c33_mxArrayOutData, c33_y, FALSE);
  return c33_mxArrayOutData;
}
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c33_X_ref_yaw = (real_T (*)[62])ssGetOutputPortSignal(chartInstance->S,
            1);
          c33_X_ref_yaw_unbounded = (real_T (*)[806])ssGetInputPortSignal
            (chartInstance->S, 0);
