  ...
  *chartInstance)
{
  ...
  *c39_sfEvent = CALL_EVENT;
  ...
  for (c39_i4 = 0; c39_i4 < 806; c39_i4++) {
    ...
    for (c39_i6 = 0; c39_i6 < 2; c39_i6++) {
      c39_X_ref_z[c39_i6 + (c39_i5 << 1)] = c39_traj_z[c39_i6 +
        ((_SFD_EML_ARRAY_BOUNDS_CHECK("traj_z", (int32_T)_SFD_INTEGER_CHECK(
            "idx:idx+pred_horizon_z", c39_idx + (real_T)c39_i5), 1, 403, 2, 0) -
          1) << 1)];
    }
  }
  ...
  *c39_inData)
{
  ...
  c39_mxArrayOutData = NULL;
  c39_i18 = 0;
  for (c39_i19 = 0; c39_i19 < 403; c39_i19++) {
    for (c39_i20 = 0; c39_i20 < 2; c39_i20++) {
      c39_b_inData[c39_i20 + c39_i18] = (*(real_T (*)[806])c39_inData)[c39_i20 +
        c39_i18];
    }
  ...
  c39_i21 = 0;
  for (c39_i22 = 0; c39_i22 < 403; c39_i22++) {
  ...
  c39_y = NULL;
  sf_mex_assign(&c39_y, sf_mex_create("y", c39_u, 0, 0U, 1U, 0U, 2, 2, 403),
                FALSE);
  sf_mex_assign(&c39_mxArrayOutData, c39_y, FALSE);
  return c39_mxArrayOutData;
}
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c39_X_ref_z = (real_T (*)[62])ssGetOutputPortSignal(chartInstance->S,
            1);
          c39_traj_z = (real_T (*)[806])ssGetInputPortSignal(chartInstance->S, 0);
