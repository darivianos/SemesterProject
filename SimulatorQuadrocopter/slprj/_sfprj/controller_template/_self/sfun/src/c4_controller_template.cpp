...
static const char * c4_debug_family_names[25] = { "tolerance", "nr",
  "MPT_ABSTOL", "minreg", "Hi", "Ki", "abspos", "ireg", "sumViol", "isinside",
  "j", "F", "G", "nc", "hx", "nargin", "nargout", "X", "Hn", "Kn", "Fi", "Gi",
  "Nc", "U", "flag_oob" };

/* Function Declarations */
static void initialize_c4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance);
static void initialize_params_c4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance);
static void enable_c4_controller_template(SFc4_controller_templateInstanceStruct
  *chartInstance);
static void disable_c4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance);
static void ext_mode_exec_c4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance);
static void set_sim_state_c4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance);
static void sf_c4_controller_template(SFc4_controller_templateInstanceStruct
  *chartInstance);
static void c4_chartstep_c4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance);
static void initSimStructsc4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_controller_templateInstanceStruct
  *chartInstance, const mxArray *c4_flag_oob, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_controller_templateInstanceStruct
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_c_emlrt_marshallIn(SFc4_controller_templateInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[100]);
...
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_d_emlrt_marshallIn(SFc4_controller_templateInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_e_emlrt_marshallIn(SFc4_controller_templateInstanceStruct
  *chartInstance, const mxArray *c4_is_active_c4_controller_template, const
  char_T *c4_identifier);
static uint8_T c4_f_emlrt_marshallIn(SFc4_controller_templateInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_controller_templateInstanceStruct
  *chartInstance);
...
{
  int32_T *c4_sfEvent;
  uint8_T *c4_is_active_c4_controller_template;
  c4_is_active_c4_controller_template = (uint8_T *)ssGetDWork(chartInstance->S,
    3);
  c4_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c4_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c4_is_active_c4_controller_template = 0U;
}
...
static void ext_mode_exec_c4_controller_template
  (SFc4_controller_templateInstanceStruct *chartInstance)
{
  c4_update_debugger_state_c4_controller_template(chartInstance);
}
  ...
  (SFc4_controller_templateInstanceStruct *chartInstance)
{
  ...
  c4_c_hoistedGlobal = *c4_is_active_c4_controller_template;
  ...
  (SFc4_controller_templateInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_flag_oob = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 1)), "flag_oob");
  *c4_is_active_c4_controller_template = c4_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 2)), "is_active_c4_controller_template");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_controller_template(chartInstance);
  ...
  *chartInstance)
{
  ...
  *c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_controller_template(chartInstance);
  ...
  (SFc4_controller_templateInstanceStruct *chartInstance)
{
  ...
  c4_b_Nc = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  ...
  sf_debug_symbol_scope_push_eml(0U, 25U, 25U, c4_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml_importable(&c4_minreg, 3U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c4_Hi, 4U, c4_c_sf_marshallOut,
    c4_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c4_Ki, 5U, c4_c_sf_marshallOut,
    c4_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_abspos, 6U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c4_ireg, 7U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c4_sumViol, 8U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_isinside, 9U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c4_j, 10U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c4_F, 11U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_G, 12U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_nc, 13U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_hx, 14U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_nargin, 15U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_nargout, 16U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c4_X, 17U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c4_Hn, 18U, c4_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c4_Kn, 19U, c4_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_Fi, 20U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_Gi, 21U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_Nc, 22U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c4_U, 23U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_flag_oob, 24U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c4_isinside = 1.0;
  c4_i6 = (int32_T)c4_Nc;
  sf_debug_for_loop_vector_check(1.0, 1.0, c4_Nc, mxDOUBLE_CLASS, c4_i6);
  c4_loop_ub = c4_i6;
  c4_i = 0;
  while (c4_i <= c4_loop_ub - 1) {
    ...
    c4_Hi[_SFD_EML_ARRAY_BOUNDS_CHECK("Hi", (int32_T)_SFD_INTEGER_CHECK("i",
      ...
      (int32_T)_SFD_INTEGER_CHECK("abspos + i - 1", (c4_abspos + c4_b_i) - 1.0),
      1, 2, 1, 0) - 1];
    CV_EML_FOR(0, 1, 2, 0);
    c4_i++;
  ...
  CV_EML_FOR(0, 1, 1, 0);
  c4_i7 = (int32_T)c4_Nc;
  sf_debug_for_loop_vector_check(1.0, 1.0, c4_Nc, mxDOUBLE_CLASS, c4_i7);
  c4_b_loop_ub = c4_i7;
  c4_c_i = 0;
  ...
  c4_nc = c4_Nc;
  c4_i8 = (int32_T)c4_nc;
  sf_debug_for_loop_vector_check(1.0, 1.0, c4_nc, mxDOUBLE_CLASS, c4_i8);
  c4_c_loop_ub = c4_i8;
  c4_ic = 0;
  while (c4_ic <= c4_c_loop_ub - 1) {
    ...
    c4_a = c4_Hi[_SFD_EML_ARRAY_BOUNDS_CHECK("Hi", (int32_T)_SFD_INTEGER_CHECK(
      "ic", c4_b_ic), 1, 100, 1, 0) - 1];
    c4_b_b = c4_X;
    c4_hx = c4_a * c4_b_b;
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc4_controller_templateInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_controller_template_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_is_active_c4_controller_template), &c4_thisId);
  sf_mex_destroy(&c4_is_active_c4_controller_template);
  return c4_y;
}
...
void sf_c4_controller_template_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2119636207U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(523979873U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(197878413U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1555630342U);
}

mxArray *sf_c4_controller_template_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("ekZxSgXMhkGSTeJX8mCnKF");
...
static const mxArray *sf_get_sim_state_info_c4_controller_template(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"U\",},{M[1],M[16],T\"flag_oob\",},{M[8],M[0],T\"is_active_c4_controller_template\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_controller_template_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_controller_templateInstanceStruct *chartInstance;
    chartInstance = (SFc4_controller_templateInstanceStruct *) ((ChartInfoStruct
...
static void sf_opaque_initialize_c4_controller_template(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc4_controller_templateInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc4_controller_templateInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_controller_template
    ((SFc4_controller_templateInstanceStruct*) chartInstanceVar);
  initialize_c4_controller_template((SFc4_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_controller_template(void *chartInstanceVar)
{
  enable_c4_controller_template((SFc4_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_controller_template(void *chartInstanceVar)
{
  disable_c4_controller_template((SFc4_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_controller_template(void *chartInstanceVar)
{
  sf_c4_controller_template((SFc4_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c4_controller_template(void
  *chartInstanceVar)
{
  ext_mode_exec_c4_controller_template((SFc4_controller_templateInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_controller_template(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_controller_template
    ((SFc4_controller_templateInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_controller_template();/* state var info */
...
extern void sf_internal_set_sim_state_c4_controller_template(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_controller_template((SFc4_controller_templateInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_controller_template(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c4_controller_template(S);
}

static void sf_opaque_set_sim_state_c4_controller_template(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_controller_template(S, st);
}

static void sf_opaque_terminate_c4_controller_template(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_controller_templateInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_controller_template((SFc4_controller_templateInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_controller_template((SFc4_controller_templateInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_controller_template(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_controller_template
      ((SFc4_controller_templateInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c4_controller_template_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c4_controller_template\",T\"is_active_c4_controller_template\"}}"
  };
...
static void mdlSetWorkWidths_c4_controller_template(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_optimization_info();
  ...
  ssSetChecksum0(S,(684654114U));
  ssSetChecksum1(S,(420973005U));
  ssSetChecksum2(S,(3866107437U));
  ssSetChecksum3(S,(3707951463U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c4_controller_template(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_controller_template(SimStruct *S)
{
  SFc4_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc4_controller_templateInstanceStruct *)malloc(sizeof
    (SFc4_controller_templateInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_controller_templateInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_controller_template;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_controller_template;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_controller_template;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_controller_template;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_controller_template;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_controller_template;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_controller_template;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_controller_template;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_controller_template;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_controller_template;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_controller_template;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c4_controller_template;
...
void c4_controller_template_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_controller_template(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_controller_template(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_controller_template(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_controller_template_method_dispatcher.\n"
