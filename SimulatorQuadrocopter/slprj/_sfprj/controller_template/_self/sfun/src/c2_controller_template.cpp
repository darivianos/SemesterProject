...
static void c2_mrdivide(SFc2_controller_templateInstanceStruct *chartInstance,
  real_T c2_A[4], real_T c2_B, real_T c2_y[4]);
  ...
  (SFc2_controller_templateInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = *c2_is_active_c2_controller_template;
  ...
  (SFc2_controller_templateInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_flag_oob = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 1)), "flag_oob");
  *c2_is_active_c2_controller_template = c2_g_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 2)), "is_active_c2_controller_template");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_controller_template(chartInstance);
