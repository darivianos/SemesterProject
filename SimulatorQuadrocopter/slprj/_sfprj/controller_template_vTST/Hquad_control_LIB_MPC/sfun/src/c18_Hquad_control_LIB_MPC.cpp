...
static void c18_update_debugger_state_c18_Hquad_control_LIB_MPC
  (SFc18_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
static void ext_mode_exec_c18_Hquad_control_LIB_MPC
  (SFc18_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
...
static uint8_T c18_f_emlrt_marshallIn(SFc18_Hquad_control_LIB_MPCInstanceStruct *
  chartInstance, const mxArray *c18_is_active_c18_Hquad_control_LIB_MPC, const
  ...
  (SFc18_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c18_is_active_c18_Hquad_control_LIB_MPC = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c18_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c18_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c18_is_active_c18_Hquad_control_LIB_MPC = 0U;
}
  ...
  (SFc18_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c18_hoistedGlobal = *c18_is_active_c18_Hquad_control_LIB_MPC;
   ...
   *c18_st)
{
  ...
  *c18_is_active_c18_Hquad_control_LIB_MPC = c18_f_emlrt_marshallIn
  ...
  (SFc18_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c18_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 8U, *c18_sfEvent);
  ...
  *c18_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 8U, *c18_sfEvent);
  ...
  sf_debug_symbol_scope_push_eml(0U, 7U, 7U, c18_debug_family_names,
    c18_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(&c18_pred_horizon, 0U, c18_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c18_X_ref_temp, 1U,
    c18_c_sf_marshallOut, c18_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c18_nargin, 2U, c18_b_sf_marshallOut,
    c18_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c18_nargout, 3U,
    c18_b_sf_marshallOut, c18_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c18_x_ref, 4U, c18_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c18_x_dot_ref, 5U, c18_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c18_X_ref, 6U, c18_sf_marshallOut,
    c18_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, *c18_sfEvent, 3);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 8U, *c18_sfEvent);
...
const mxArray *sf_c18_Hquad_control_LIB_MPC_get_eml_resolved_functions_info(void)
{
  ...
  (*c18_b_info)[3].name = "eml_index_plus";
  (*c18_b_info)[3].dominantType = "int32";
  (*c18_b_info)[3].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  (*c18_b_info)[3].fileTimeLo = 1286818778U;
  ...
  (*c18_b_info)[4].name = "eml_assert_valid_size_arg";
  (*c18_b_info)[4].dominantType = "double";
  (*c18_b_info)[4].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  (*c18_b_info)[4].fileTimeLo = 1286818694U;
  (*c18_b_info)[4].fileTimeHi = 0U;
  (*c18_b_info)[4].mFileTimeLo = 0U;
  (*c18_b_info)[4].mFileTimeHi = 0U;
  (*c18_b_info)[5].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m!isintegral";
  (*c18_b_info)[5].name = "isinf";
  (*c18_b_info)[5].dominantType = "double";
  (*c18_b_info)[5].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  (*c18_b_info)[5].fileTimeLo = 1286818760U;
  (*c18_b_info)[5].fileTimeHi = 0U;
  (*c18_b_info)[5].mFileTimeLo = 0U;
  (*c18_b_info)[5].mFileTimeHi = 0U;
  (*c18_b_info)[6].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  (*c18_b_info)[6].name = "intmax";
  (*c18_b_info)[6].dominantType = "char";
  (*c18_b_info)[6].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  (*c18_b_info)[6].fileTimeLo = 1286818756U;
  (*c18_b_info)[6].fileTimeHi = 0U;
  (*c18_b_info)[6].mFileTimeLo = 0U;
  (*c18_b_info)[6].mFileTimeHi = 0U;
  (*c18_b_info)[7].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m!reshape_varargin_to_size";
  (*c18_b_info)[7].name = "eml_index_prod";
  (*c18_b_info)[7].dominantType = "int32";
  (*c18_b_info)[7].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_prod.m";
  (*c18_b_info)[7].fileTimeLo = 1286818780U;
  (*c18_b_info)[7].fileTimeHi = 0U;
  (*c18_b_info)[7].mFileTimeLo = 0U;
  (*c18_b_info)[7].mFileTimeHi = 0U;
  (*c18_b_info)[8].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_prod.m";
  (*c18_b_info)[8].name = "eml_index_times";
  (*c18_b_info)[8].dominantType = "int32";
  (*c18_b_info)[8].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_times.m";
  (*c18_b_info)[8].fileTimeLo = 1286818780U;
  (*c18_b_info)[8].fileTimeHi = 0U;
  (*c18_b_info)[8].mFileTimeLo = 0U;
  (*c18_b_info)[8].mFileTimeHi = 0U;
  (*c18_b_info)[9].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m!reshape_varargin_to_size";
  (*c18_b_info)[9].name = "eml_index_rdivide";
  (*c18_b_info)[9].dominantType = "int32";
  (*c18_b_info)[9].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_rdivide.m";
  (*c18_b_info)[9].fileTimeLo = 1286818780U;
  (*c18_b_info)[9].fileTimeHi = 0U;
  (*c18_b_info)[9].mFileTimeLo = 0U;
  (*c18_b_info)[9].mFileTimeHi = 0U;
  (*c18_b_info)[10].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  (*c18_b_info)[10].name = "eml_scalar_eg";
  (*c18_b_info)[10].dominantType = "double";
  (*c18_b_info)[10].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  (*c18_b_info)[10].fileTimeLo = 1286818796U;
  (*c18_b_info)[10].fileTimeHi = 0U;
  (*c18_b_info)[10].mFileTimeLo = 0U;
  (*c18_b_info)[10].mFileTimeHi = 0U;
  sf_mex_assign(&c18_m0, sf_mex_createstruct("nameCaptureInfo", 1, 11), FALSE);
  for (c18_i28 = 0; c18_i28 < 11; c18_i28++) {
  ...
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData)
{
  ...
  c18_thisId.fIdentifier = c18_identifier;
  c18_thisId.fParent = NULL;
  c18_y = c18_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c18_sfEvent),
    &c18_thisId);
  ...
  char_T *c18_identifier)
{
  ...
  c18_y = c18_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_is_active_c18_Hquad_control_LIB_MPC), &c18_thisId);
  sf_mex_destroy(&c18_is_active_c18_Hquad_control_LIB_MPC);
  return c18_y;
}
...
static void sf_opaque_initialize_c18_Hquad_control_LIB_MPC(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc18_Hquad_control_LIB_MPCInstanceStruct*)
    chartInstanceVar)->S);
...
static void sf_opaque_ext_mode_exec_c18_Hquad_control_LIB_MPC(void
  *chartInstanceVar)
{
  ext_mode_exec_c18_Hquad_control_LIB_MPC
    ((SFc18_Hquad_control_LIB_MPCInstanceStruct*) chartInstanceVar);
}
...
mxArray *sf_c18_Hquad_control_LIB_MPC_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c18_Hquad_control_LIB_MPC\",T\"is_active_c18_Hquad_control_LIB_MPC\"}}"
  };
...
static void mdlSetWorkWidths_c18_Hquad_control_LIB_MPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,infoStruct,18,2);
      sf_mark_chart_reusable_outputs(S,infoStruct,18,1);
    }
...
{
  SFc18_Hquad_control_LIB_MPCInstanceStruct *chartInstance;
  chartInstance = (SFc18_Hquad_control_LIB_MPCInstanceStruct *)malloc(sizeof
  ...
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c18_Hquad_control_LIB_MPC;
