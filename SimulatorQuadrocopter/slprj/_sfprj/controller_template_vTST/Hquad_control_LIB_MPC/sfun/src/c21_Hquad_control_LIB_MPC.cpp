...
static void c21_update_debugger_state_c21_Hquad_control_LIB_MPC
  (SFc21_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
static void ext_mode_exec_c21_Hquad_control_LIB_MPC
  (SFc21_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
...
static uint8_T c21_f_emlrt_marshallIn(SFc21_Hquad_control_LIB_MPCInstanceStruct *
  chartInstance, const mxArray *c21_is_active_c21_Hquad_control_LIB_MPC, const
  ...
  (SFc21_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c21_is_active_c21_Hquad_control_LIB_MPC = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c21_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c21_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c21_is_active_c21_Hquad_control_LIB_MPC = 0U;
}
  ...
  (SFc21_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c21_hoistedGlobal = *c21_is_active_c21_Hquad_control_LIB_MPC;
   ...
   *c21_st)
{
  ...
  *c21_is_active_c21_Hquad_control_LIB_MPC = c21_f_emlrt_marshallIn
  ...
  (SFc21_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c21_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 11U, *c21_sfEvent);
  ...
  *c21_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 11U, *c21_sfEvent);
  ...
  sf_debug_symbol_scope_push_eml(0U, 7U, 7U, c21_debug_family_names,
    c21_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(&c21_pred_horizon, 0U, c21_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c21_X_ref_temp, 1U,
    c21_c_sf_marshallOut, c21_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c21_nargin, 2U, c21_b_sf_marshallOut,
    c21_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c21_nargout, 3U,
    c21_b_sf_marshallOut, c21_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c21_x_ref, 4U, c21_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c21_x_dot_ref, 5U, c21_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c21_X_ref, 6U, c21_sf_marshallOut,
    c21_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 11U, *c21_sfEvent);
...
const mxArray *sf_c21_Hquad_control_LIB_MPC_get_eml_resolved_functions_info(void)
{
  ...
  c21_ResolvedFunctionInfo c21_info[11];
  c21_ResolvedFunctionInfo (*c21_b_info)[11];
  const mxArray *c21_m0 = NULL;
  int32_T c21_i26;
  c21_ResolvedFunctionInfo *c21_r0;
  c21_nameCaptureInfo = NULL;
  c21_nameCaptureInfo = NULL;
  c21_b_info = (c21_ResolvedFunctionInfo (*)[11])c21_info;
  ...
  (*c21_b_info)[3].name = "eml_index_plus";
  (*c21_b_info)[3].dominantType = "int32";
  (*c21_b_info)[3].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  (*c21_b_info)[3].fileTimeLo = 1286818778U;
  ...
  (*c21_b_info)[4].name = "eml_assert_valid_size_arg";
  (*c21_b_info)[4].dominantType = "double";
  (*c21_b_info)[4].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  (*c21_b_info)[4].fileTimeLo = 1286818694U;
  (*c21_b_info)[4].fileTimeHi = 0U;
  (*c21_b_info)[4].mFileTimeLo = 0U;
  (*c21_b_info)[4].mFileTimeHi = 0U;
  (*c21_b_info)[5].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m!isintegral";
  (*c21_b_info)[5].name = "isinf";
  (*c21_b_info)[5].dominantType = "double";
  (*c21_b_info)[5].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  (*c21_b_info)[5].fileTimeLo = 1286818760U;
  (*c21_b_info)[5].fileTimeHi = 0U;
  (*c21_b_info)[5].mFileTimeLo = 0U;
  (*c21_b_info)[5].mFileTimeHi = 0U;
  (*c21_b_info)[6].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  (*c21_b_info)[6].name = "intmax";
  (*c21_b_info)[6].dominantType = "char";
  (*c21_b_info)[6].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  (*c21_b_info)[6].fileTimeLo = 1286818756U;
  (*c21_b_info)[6].fileTimeHi = 0U;
  (*c21_b_info)[6].mFileTimeLo = 0U;
  (*c21_b_info)[6].mFileTimeHi = 0U;
  (*c21_b_info)[7].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m!reshape_varargin_to_size";
  (*c21_b_info)[7].name = "eml_index_prod";
  (*c21_b_info)[7].dominantType = "int32";
  (*c21_b_info)[7].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_prod.m";
  (*c21_b_info)[7].fileTimeLo = 1286818780U;
  (*c21_b_info)[7].fileTimeHi = 0U;
  (*c21_b_info)[7].mFileTimeLo = 0U;
  (*c21_b_info)[7].mFileTimeHi = 0U;
  (*c21_b_info)[8].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_prod.m";
  (*c21_b_info)[8].name = "eml_index_times";
  (*c21_b_info)[8].dominantType = "int32";
  (*c21_b_info)[8].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_times.m";
  (*c21_b_info)[8].fileTimeLo = 1286818780U;
  (*c21_b_info)[8].fileTimeHi = 0U;
  (*c21_b_info)[8].mFileTimeLo = 0U;
  (*c21_b_info)[8].mFileTimeHi = 0U;
  (*c21_b_info)[9].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m!reshape_varargin_to_size";
  (*c21_b_info)[9].name = "eml_index_rdivide";
  (*c21_b_info)[9].dominantType = "int32";
  (*c21_b_info)[9].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_rdivide.m";
  (*c21_b_info)[9].fileTimeLo = 1286818780U;
  (*c21_b_info)[9].fileTimeHi = 0U;
  (*c21_b_info)[9].mFileTimeLo = 0U;
  (*c21_b_info)[9].mFileTimeHi = 0U;
  (*c21_b_info)[10].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  (*c21_b_info)[10].name = "eml_scalar_eg";
  (*c21_b_info)[10].dominantType = "double";
  (*c21_b_info)[10].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  (*c21_b_info)[10].fileTimeLo = 1286818796U;
  (*c21_b_info)[10].fileTimeHi = 0U;
  (*c21_b_info)[10].mFileTimeLo = 0U;
  (*c21_b_info)[10].mFileTimeHi = 0U;
  sf_mex_assign(&c21_m0, sf_mex_createstruct("nameCaptureInfo", 1, 11), FALSE);
  for (c21_i26 = 0; c21_i26 < 11; c21_i26++) {
  ...
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData)
{
  ...
  c21_thisId.fIdentifier = c21_identifier;
  c21_thisId.fParent = NULL;
  c21_y = c21_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c21_sfEvent),
    &c21_thisId);
  ...
  char_T *c21_identifier)
{
  ...
  c21_y = c21_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_is_active_c21_Hquad_control_LIB_MPC), &c21_thisId);
  sf_mex_destroy(&c21_is_active_c21_Hquad_control_LIB_MPC);
  return c21_y;
}
...
static void sf_opaque_initialize_c21_Hquad_control_LIB_MPC(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc21_Hquad_control_LIB_MPCInstanceStruct*)
    chartInstanceVar)->S);
...
static void sf_opaque_ext_mode_exec_c21_Hquad_control_LIB_MPC(void
  *chartInstanceVar)
{
  ext_mode_exec_c21_Hquad_control_LIB_MPC
    ((SFc21_Hquad_control_LIB_MPCInstanceStruct*) chartInstanceVar);
}
...
mxArray *sf_c21_Hquad_control_LIB_MPC_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c21_Hquad_control_LIB_MPC\",T\"is_active_c21_Hquad_control_LIB_MPC\"}}"
  };
...
static void mdlSetWorkWidths_c21_Hquad_control_LIB_MPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,infoStruct,21,2);
...
{
  SFc21_Hquad_control_LIB_MPCInstanceStruct *chartInstance;
  chartInstance = (SFc21_Hquad_control_LIB_MPCInstanceStruct *)malloc(sizeof
  ...
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c21_Hquad_control_LIB_MPC;
