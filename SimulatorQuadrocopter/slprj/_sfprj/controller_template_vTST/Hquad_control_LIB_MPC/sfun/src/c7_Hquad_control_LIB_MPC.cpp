...
static void c7_update_debugger_state_c7_Hquad_control_LIB_MPC
  (SFc7_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
static void ext_mode_exec_c7_Hquad_control_LIB_MPC
  (SFc7_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
...
static uint8_T c7_k_emlrt_marshallIn(SFc7_Hquad_control_LIB_MPCInstanceStruct
  *chartInstance, const mxArray *c7_is_active_c7_Hquad_control_LIB_MPC, const
  ...
  (SFc7_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c7_is_active_c7_Hquad_control_LIB_MPC = (uint8_T *)ssGetDWork(chartInstance->S,
    3);
  c7_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c7_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c7_is_active_c7_Hquad_control_LIB_MPC = 0U;
}
  ...
  (SFc7_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c7_c_hoistedGlobal = *c7_is_active_c7_Hquad_control_LIB_MPC;
  ...
  (SFc7_Hquad_control_LIB_MPCInstanceStruct *chartInstance, const mxArray *c7_st)
{
  ...
  *c7_u_opt = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c7_u, 3)), "u_opt");
  *c7_is_active_c7_Hquad_control_LIB_MPC = c7_k_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c7_u, 4)), "is_active_c7_Hquad_control_LIB_MPC");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_Hquad_control_LIB_MPC(chartInstance);
  ...
  *chartInstance)
{
  ...
  c7_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, *c7_sfEvent);
  ...
  (SFc7_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c7_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, *c7_sfEvent);
  ...
  _SFD_EML_CALL(0U, *c7_sfEvent, 14);
  ...
  _SFD_EML_CALL(0U, *c7_sfEvent, 18);
  ...
  _SFD_EML_CALL(0U, *c7_sfEvent, 25);
  ...
  _SFD_EML_CALL(0U, *c7_sfEvent, 32);
  ...
  *c7_c_J_star = c7_J_star;
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 3U, *c7_sfEvent);
}
...
static void c7_info_helper(c7_ResolvedFunctionInfo c7_info[24])
{
  ...
  c7_info[13].fileTimeLo = 1367485014U;
  ...
  real_T *c7_actual_num_iters)
{
  ...
  *c7_actual_num_iters = rtInf;
  ...
  _SFD_SCRIPT_CALL(0U, *c7_sfEvent, 45);
  for (c7_i148 = 0; c7_i148 < 30; c7_i148++) {
    c7_W_i[c7_i148] = c7_V_i[c7_i148];
  }

  _SFD_SCRIPT_CALL(0U, *c7_sfEvent, 47);
  ...
  while (c7_i <= c7_loop_ub - 1) {
    ...
    CV_SCRIPT_FOR(0, 0, 1);
    _SFD_SCRIPT_CALL(0U, *c7_sfEvent, 59);
    ...
    _SFD_SCRIPT_CALL(0U, *c7_sfEvent, 62);
  ...
  CV_SCRIPT_FOR(0, 0, 0);
  _SFD_SCRIPT_CALL(0U, *c7_sfEvent, 80);
  for (c7_i165 = 0; c7_i165 < 30; c7_i165++) {
    c7_V[c7_i165] = c7_V_i[c7_i165];
  }

  _SFD_SCRIPT_CALL(0U, *c7_sfEvent, 81);
  ...
  *c7_J = (c7_g_y + c7_h_y) + c7_MM;
  _SFD_SCRIPT_CALL(0U, *c7_sfEvent, 82);
  CV_SCRIPT_IF(0, 5, CV_SCRIPT_MCDC(0, 1, !(CV_SCRIPT_COND(0, 1, c7_MONITOR !=
    0.0) != 0.0)));
  _SFD_SCRIPT_CALL(0U, *c7_sfEvent, 83);
  ...
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData)
{
  ...
  c7_thisId.fIdentifier = c7_identifier;
  c7_thisId.fParent = NULL;
  c7_y = c7_j_emlrt_marshallIn(chartInstance, sf_mex_dup(c7_sfEvent), &c7_thisId);
  ...
  char_T *c7_identifier)
{
  ...
  c7_y = c7_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_is_active_c7_Hquad_control_LIB_MPC), &c7_thisId);
  sf_mex_destroy(&c7_is_active_c7_Hquad_control_LIB_MPC);
  return c7_y;
}
...
{
  sf_check_dwork_consistency(((SFc7_Hquad_control_LIB_MPCInstanceStruct*)
    chartInstanceVar)->S);
...
static void sf_opaque_ext_mode_exec_c7_Hquad_control_LIB_MPC(void
  *chartInstanceVar)
{
  ext_mode_exec_c7_Hquad_control_LIB_MPC
    ((SFc7_Hquad_control_LIB_MPCInstanceStruct*) chartInstanceVar);
}
...
mxArray *sf_c7_Hquad_control_LIB_MPC_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c7_Hquad_control_LIB_MPC\",T\"is_active_c7_Hquad_control_LIB_MPC\"}}"
  };
...
static void mdlSetWorkWidths_c7_Hquad_control_LIB_MPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(233327123U));
  ssSetChecksum1(S,(2129283165U));
  ssSetChecksum2(S,(718437040U));
  ssSetChecksum3(S,(4094574572U));
...
static void mdlStart_c7_Hquad_control_LIB_MPC(SimStruct *S)
{
  ...
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c7_Hquad_control_LIB_MPC;
