...
static void c4_update_debugger_state_c4_Hquad_control_LIB_MPC
  (SFc4_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
static void ext_mode_exec_c4_Hquad_control_LIB_MPC
  (SFc4_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
...
static uint8_T c4_f_emlrt_marshallIn(SFc4_Hquad_control_LIB_MPCInstanceStruct
  *chartInstance, const mxArray *c4_is_active_c4_Hquad_control_LIB_MPC, const
  ...
  (SFc4_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c4_is_active_c4_Hquad_control_LIB_MPC = (uint8_T *)ssGetDWork(chartInstance->S,
    3);
  c4_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c4_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c4_is_active_c4_Hquad_control_LIB_MPC = 0U;
}
  ...
  (SFc4_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c4_e_hoistedGlobal = *c4_is_active_c4_Hquad_control_LIB_MPC;
  ...
  (SFc4_Hquad_control_LIB_MPCInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_roll_rot = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 3)), "roll_rot");
  *c4_is_active_c4_Hquad_control_LIB_MPC = c4_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 4)), "is_active_c4_Hquad_control_LIB_MPC");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_Hquad_control_LIB_MPC(chartInstance);
  ...
  (SFc4_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  _SFD_EML_CALL(0U, *c4_sfEvent, 10);
  ...
  _SFD_EML_CALL(0U, *c4_sfEvent, 14);
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  c4_thisId.fIdentifier = c4_identifier;
  c4_thisId.fParent = NULL;
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_sfEvent), &c4_thisId);
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_is_active_c4_Hquad_control_LIB_MPC), &c4_thisId);
  sf_mex_destroy(&c4_is_active_c4_Hquad_control_LIB_MPC);
  return c4_y;
}
...
{
  sf_check_dwork_consistency(((SFc4_Hquad_control_LIB_MPCInstanceStruct*)
    chartInstanceVar)->S);
...
static void sf_opaque_ext_mode_exec_c4_Hquad_control_LIB_MPC(void
  *chartInstanceVar)
{
  ext_mode_exec_c4_Hquad_control_LIB_MPC
    ((SFc4_Hquad_control_LIB_MPCInstanceStruct*) chartInstanceVar);
}
...
mxArray *sf_c4_Hquad_control_LIB_MPC_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c4_Hquad_control_LIB_MPC\",T\"is_active_c4_Hquad_control_LIB_MPC\"}}"
  };
...
{
  SFc4_Hquad_control_LIB_MPCInstanceStruct *chartInstance;
  chartInstance = (SFc4_Hquad_control_LIB_MPCInstanceStruct *)malloc(sizeof
  ...
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c4_Hquad_control_LIB_MPC;
