...
static void initialize_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance);
static void initialize_params_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance);
static void enable_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance);
static void disable_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance);
static void ext_mode_exec_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance);
static void set_sim_state_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance, const mxArray
   *c3_st);
static void finalize_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance);
static void sf_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance);
static void c3_chartstep_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance);
static void initSimStructsc3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c3_flag_oob, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_controller_template_vTSTInstanceStruct *
...
static const mxArray *c3_g_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[2]);
...
static const mxArray *c3_h_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_d_emlrt_marshallIn(SFc3_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[100]);
...
static const mxArray *c3_i_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_e_emlrt_marshallIn(SFc3_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[200]);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[18]);
static void c3_round(SFc3_controller_template_vTSTInstanceStruct *chartInstance,
                     real_T c3_x[2], real_T c3_b_x[2]);
static void c3_mrdivide(SFc3_controller_template_vTSTInstanceStruct
  *chartInstance, real_T c3_A[2], real_T c3_B, real_T c3_y[2]);
static void c3_eml_scalar_eg(SFc3_controller_template_vTSTInstanceStruct
  *chartInstance);
static const mxArray *c3_j_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_f_emlrt_marshallIn(SFc3_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_g_emlrt_marshallIn(SFc3_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c3_is_active_c3_controller_template_vTST, const
  char_T *c3_identifier);
static uint8_T c3_h_emlrt_marshallIn(SFc3_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_round(SFc3_controller_template_vTSTInstanceStruct
  *chartInstance, real_T c3_x[2]);
static void init_dsm_address_info(SFc3_controller_template_vTSTInstanceStruct
  *chartInstance);
...
{
  int32_T *c3_sfEvent;
  uint8_T *c3_is_active_c3_controller_template_vTST;
  c3_is_active_c3_controller_template_vTST = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c3_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c3_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c3_is_active_c3_controller_template_vTST = 0U;
}
...
static void ext_mode_exec_c3_controller_template_vTST
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance)
{
  c3_update_debugger_state_c3_controller_template_vTST(chartInstance);
}
  ...
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance)
{
  ...
  c3_c_hoistedGlobal = *c3_is_active_c3_controller_template_vTST;
   ...
   *c3_st)
{
  ...
  *c3_flag_oob = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 1)), "flag_oob");
  *c3_is_active_c3_controller_template_vTST = c3_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
     "is_active_c3_controller_template_vTST");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_controller_template_vTST(chartInstance);
  ...
  (SFc3_controller_template_vTSTInstanceStruct *chartInstance)
{
  ...
  *c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_controller_template_vTST(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_controller_template_vTSTInstanceStruct *chartInstance;
  chartInstance = (SFc3_controller_template_vTSTInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c3_controller_template_vTST_get_eml_resolved_functions_info
  (void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_is_active_c3_controller_template_vTST), &c3_thisId);
  sf_mex_destroy(&c3_is_active_c3_controller_template_vTST);
  return c3_y;
}
...
void sf_c3_controller_template_vTST_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_controller_template_vTST_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_controller_template_vTST(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"U\",},{M[1],M[16],T\"flag_oob\",},{M[8],M[0],T\"is_active_c3_controller_template_vTST\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_controller_template_vTST_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_controller_template_vTST(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc3_controller_template_vTSTInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc3_controller_template_vTSTInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_controller_template_vTST
    ((SFc3_controller_template_vTSTInstanceStruct*) chartInstanceVar);
  initialize_c3_controller_template_vTST
    ((SFc3_controller_template_vTSTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_controller_template_vTST(void *chartInstanceVar)
{
  enable_c3_controller_template_vTST
    ((SFc3_controller_template_vTSTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_controller_template_vTST(void *chartInstanceVar)
{
  disable_c3_controller_template_vTST
    ((SFc3_controller_template_vTSTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_controller_template_vTST(void *chartInstanceVar)
{
  sf_c3_controller_template_vTST((SFc3_controller_template_vTSTInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c3_controller_template_vTST(void
  *chartInstanceVar)
{
  ext_mode_exec_c3_controller_template_vTST
    ((SFc3_controller_template_vTSTInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_controller_template_vTST
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_controller_template_vTST
    ((SFc3_controller_template_vTSTInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_controller_template_vTST();/* state var info */
...
extern void sf_internal_set_sim_state_c3_controller_template_vTST(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_controller_template_vTST
    ((SFc3_controller_template_vTSTInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_controller_template_vTST
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_controller_template_vTST(S);
}

static void sf_opaque_set_sim_state_c3_controller_template_vTST(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c3_controller_template_vTST(S, st);
}

static void sf_opaque_terminate_c3_controller_template_vTST(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_controller_template_vTSTInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_controller_template_vTST
      ((SFc3_controller_template_vTSTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_controller_template_vTST
    ((SFc3_controller_template_vTSTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_controller_template_vTST(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_controller_template_vTST
      ((SFc3_controller_template_vTSTInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c3_controller_template_vTST_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c3_controller_template_vTST\",T\"is_active_c3_controller_template_vTST\"}}"
  };
...
static void mdlSetWorkWidths_c3_controller_template_vTST(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_vTST_optimization_info();
...
static void mdlRTW_c3_controller_template_vTST(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_controller_template_vTST(SimStruct *S)
{
  SFc3_controller_template_vTSTInstanceStruct *chartInstance;
  chartInstance = (SFc3_controller_template_vTSTInstanceStruct *)malloc(sizeof
    (SFc3_controller_template_vTSTInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_controller_template_vTSTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_controller_template_vTST;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_controller_template_vTST;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_controller_template_vTST;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_controller_template_vTST;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_controller_template_vTST;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_controller_template_vTST;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_controller_template_vTST;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_controller_template_vTST;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_controller_template_vTST;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_controller_template_vTST;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_controller_template_vTST;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c3_controller_template_vTST;
...
void c3_controller_template_vTST_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_controller_template_vTST(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_controller_template_vTST(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_controller_template_vTST(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_controller_template_vTST_method_dispatcher.\n"
