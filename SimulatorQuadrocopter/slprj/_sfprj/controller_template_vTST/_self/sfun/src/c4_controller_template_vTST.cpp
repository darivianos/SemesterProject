...
static void initialize_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance);
static void initialize_params_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance);
static void enable_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance);
static void disable_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance);
static void ext_mode_exec_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance);
static void set_sim_state_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance, const mxArray
   *c4_st);
static void finalize_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance);
static void sf_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance);
static void c4_chartstep_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance);
static void initSimStructsc4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c4_flag_oob, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_controller_template_vTSTInstanceStruct *
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_c_emlrt_marshallIn(SFc4_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[100]);
...
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_d_emlrt_marshallIn(SFc4_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_e_emlrt_marshallIn(SFc4_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c4_is_active_c4_controller_template_vTST, const
  char_T *c4_identifier);
static uint8_T c4_f_emlrt_marshallIn(SFc4_controller_template_vTSTInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_controller_template_vTSTInstanceStruct
  *chartInstance);
...
{
  int32_T *c4_sfEvent;
  uint8_T *c4_is_active_c4_controller_template_vTST;
  c4_is_active_c4_controller_template_vTST = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c4_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c4_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c4_is_active_c4_controller_template_vTST = 0U;
}
...
static void ext_mode_exec_c4_controller_template_vTST
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance)
{
  c4_update_debugger_state_c4_controller_template_vTST(chartInstance);
}
  ...
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance)
{
  ...
  c4_c_hoistedGlobal = *c4_is_active_c4_controller_template_vTST;
   ...
   *c4_st)
{
  ...
  *c4_flag_oob = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 1)), "flag_oob");
  *c4_is_active_c4_controller_template_vTST = c4_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 2)),
     "is_active_c4_controller_template_vTST");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_controller_template_vTST(chartInstance);
  ...
  (SFc4_controller_template_vTSTInstanceStruct *chartInstance)
{
  ...
  *c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_controller_template_vTST(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_controller_template_vTSTInstanceStruct *chartInstance;
  chartInstance = (SFc4_controller_template_vTSTInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c4_controller_template_vTST_get_eml_resolved_functions_info
  (void)
{
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_is_active_c4_controller_template_vTST), &c4_thisId);
  sf_mex_destroy(&c4_is_active_c4_controller_template_vTST);
  return c4_y;
}
...
void sf_c4_controller_template_vTST_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_controller_template_vTST_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_controller_template_vTST(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"U\",},{M[1],M[16],T\"flag_oob\",},{M[8],M[0],T\"is_active_c4_controller_template_vTST\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_controller_template_vTST_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c4_controller_template_vTST(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc4_controller_template_vTSTInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc4_controller_template_vTSTInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_controller_template_vTST
    ((SFc4_controller_template_vTSTInstanceStruct*) chartInstanceVar);
  initialize_c4_controller_template_vTST
    ((SFc4_controller_template_vTSTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_controller_template_vTST(void *chartInstanceVar)
{
  enable_c4_controller_template_vTST
    ((SFc4_controller_template_vTSTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_controller_template_vTST(void *chartInstanceVar)
{
  disable_c4_controller_template_vTST
    ((SFc4_controller_template_vTSTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_controller_template_vTST(void *chartInstanceVar)
{
  sf_c4_controller_template_vTST((SFc4_controller_template_vTSTInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c4_controller_template_vTST(void
  *chartInstanceVar)
{
  ext_mode_exec_c4_controller_template_vTST
    ((SFc4_controller_template_vTSTInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_controller_template_vTST
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_controller_template_vTST
    ((SFc4_controller_template_vTSTInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_controller_template_vTST();/* state var info */
...
extern void sf_internal_set_sim_state_c4_controller_template_vTST(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_controller_template_vTST
    ((SFc4_controller_template_vTSTInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_controller_template_vTST
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c4_controller_template_vTST(S);
}

static void sf_opaque_set_sim_state_c4_controller_template_vTST(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c4_controller_template_vTST(S, st);
}

static void sf_opaque_terminate_c4_controller_template_vTST(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_controller_template_vTSTInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_controller_template_vTST
      ((SFc4_controller_template_vTSTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_controller_template_vTST
    ((SFc4_controller_template_vTSTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_controller_template_vTST(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_controller_template_vTST
      ((SFc4_controller_template_vTSTInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c4_controller_template_vTST_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c4_controller_template_vTST\",T\"is_active_c4_controller_template_vTST\"}}"
  };
...
static void mdlSetWorkWidths_c4_controller_template_vTST(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_vTST_optimization_info();
...
static void mdlRTW_c4_controller_template_vTST(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_controller_template_vTST(SimStruct *S)
{
  SFc4_controller_template_vTSTInstanceStruct *chartInstance;
  chartInstance = (SFc4_controller_template_vTSTInstanceStruct *)malloc(sizeof
    (SFc4_controller_template_vTSTInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_controller_template_vTSTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_controller_template_vTST;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_controller_template_vTST;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_controller_template_vTST;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_controller_template_vTST;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_controller_template_vTST;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_controller_template_vTST;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_controller_template_vTST;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_controller_template_vTST;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_controller_template_vTST;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_controller_template_vTST;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_controller_template_vTST;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c4_controller_template_vTST;
...
void c4_controller_template_vTST_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_controller_template_vTST(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_controller_template_vTST(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_controller_template_vTST(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_controller_template_vTST_method_dispatcher.\n"
