...
static void initialize_c12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance);
static void initialize_params_c12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance);
static void enable_c12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance);
static void disable_c12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance);
static void ext_mode_exec_c12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance);
static void set_sim_state_c12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c12_st);
static void finalize_c12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance);
static void sf_c12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance);
static void initSimStructsc12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance);
...
static real_T c12_emlrt_marshallIn
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c12_pitch_cmd_out, const char_T *c12_identifier);
...
static uint8_T c12_d_emlrt_marshallIn
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c12_is_active_c12_controller_template_rectangle, const char_T
   *c12_identifier);
...
{
  int32_T *c12_sfEvent;
  uint8_T *c12_is_active_c12_controller_template_rectangle;
  c12_is_active_c12_controller_template_rectangle = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c12_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c12_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c12_is_active_c12_controller_template_rectangle = 0U;
}
...
static void ext_mode_exec_c12_controller_template_rectangle
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance)
{
  c12_update_debugger_state_c12_controller_template_rectangle(chartInstance);
}
  ...
  (SFc12_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c12_b_hoistedGlobal = *c12_is_active_c12_controller_template_rectangle;
   ...
   mxArray *c12_st)
{
  ...
  *c12_is_active_c12_controller_template_rectangle = c12_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 1)),
     "is_active_c12_controller_template_rectangle");
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc12_controller_template_rectangleInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c12_controller_template_rectangle_get_eml_resolved_functions_info(void)
{
   ...
   *c12_identifier)
{
  ...
  c12_y = c12_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_is_active_c12_controller_template_rectangle), &c12_thisId);
  sf_mex_destroy(&c12_is_active_c12_controller_template_rectangle);
  return c12_y;
}
...
void sf_c12_controller_template_rectangle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c12_controller_template_rectangle_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_controller_template_rectangle
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"pitch_cmd_out\",},{M[8],M[0],T\"is_active_c12_controller_template_rectangle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_controller_template_rectangle_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c12_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc12_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc12_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_controller_template_rectangle
    ((SFc12_controller_template_rectangleInstanceStruct*) chartInstanceVar);
  initialize_c12_controller_template_rectangle
    ((SFc12_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_controller_template_rectangle(void
  *chartInstanceVar)
{
  enable_c12_controller_template_rectangle
    ((SFc12_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_controller_template_rectangle(void
  *chartInstanceVar)
{
  disable_c12_controller_template_rectangle
    ((SFc12_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_c12_controller_template_rectangle
    ((SFc12_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c12_controller_template_rectangle(void
  *chartInstanceVar)
{
  ext_mode_exec_c12_controller_template_rectangle
    ((SFc12_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c12_controller_template_rectangle(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_controller_template_rectangle
    ((SFc12_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_controller_template_rectangle();/* state var info */
...
extern void sf_internal_set_sim_state_c12_controller_template_rectangle
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c12_controller_template_rectangle
    ((SFc12_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c12_controller_template_rectangle
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c12_controller_template_rectangle(S);
}

static void sf_opaque_set_sim_state_c12_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c12_controller_template_rectangle(S, st);
}

static void sf_opaque_terminate_c12_controller_template_rectangle(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_controller_template_rectangleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c12_controller_template_rectangle
      ((SFc12_controller_template_rectangleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_controller_template_rectangle
    ((SFc12_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_controller_template_rectangle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c12_controller_template_rectangle
      ((SFc12_controller_template_rectangleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c12_controller_template_rectangle_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c12_controller_template_rectangle\",T\"is_active_c12_controller_template_rectangle\"}}"
  };
...
static void mdlSetWorkWidths_c12_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_rectangle_optimization_info();
...
static void mdlRTW_c12_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_controller_template_rectangle(SimStruct *S)
{
  SFc12_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc12_controller_template_rectangleInstanceStruct *)malloc
    (sizeof(SFc12_controller_template_rectangleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_controller_template_rectangle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_controller_template_rectangle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_controller_template_rectangle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c12_controller_template_rectangle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_controller_template_rectangle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_controller_template_rectangle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_controller_template_rectangle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_controller_template_rectangle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_controller_template_rectangle;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_controller_template_rectangle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_controller_template_rectangle;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c12_controller_template_rectangle;
...
void c12_controller_template_rectangle_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_controller_template_rectangle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_controller_template_rectangle_method_dispatcher.\n"
