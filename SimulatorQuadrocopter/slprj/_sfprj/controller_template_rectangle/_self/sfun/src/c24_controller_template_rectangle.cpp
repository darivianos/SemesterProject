...
static void initialize_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance);
static void initialize_params_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance);
static void enable_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance);
static void disable_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance);
static void c24_update_debugger_state_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance);
static void ext_mode_exec_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance);
static void set_sim_state_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c24_st);
static void finalize_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance);
static void sf_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance);
static void c24_chartstep_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance);
static void initSimStructsc24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance);
...
static real_T c24_emlrt_marshallIn
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c24_flag_oob, const char_T *c24_identifier);
...
static const mxArray *c24_g_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static void c24_c_emlrt_marshallIn
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId, real_T c24_y[4]);
...
static const mxArray *c24_h_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static void c24_d_emlrt_marshallIn
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId, real_T c24_y[1000]);
...
static const mxArray *c24_i_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static void c24_e_emlrt_marshallIn
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId, real_T c24_y[4000]);
...
static void c24_round(SFc24_controller_template_rectangleInstanceStruct
                      *chartInstance, real_T c24_x[4], real_T c24_b_x[4]);
static void c24_mrdivide(SFc24_controller_template_rectangleInstanceStruct
  *chartInstance, real_T c24_A[4], real_T c24_B, real_T c24_y[4]);
static void c24_eml_scalar_eg(SFc24_controller_template_rectangleInstanceStruct *
  chartInstance);
static const mxArray *c24_j_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static int32_T c24_f_emlrt_marshallIn
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void c24_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData);
static uint8_T c24_g_emlrt_marshallIn
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c24_is_active_c24_controller_template_rectangle, const char_T
   *c24_identifier);
static uint8_T c24_h_emlrt_marshallIn
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void c24_b_round(SFc24_controller_template_rectangleInstanceStruct
  *chartInstance, real_T c24_x[4]);
...
{
  int32_T *c24_sfEvent;
  uint8_T *c24_is_active_c24_controller_template_rectangle;
  c24_is_active_c24_controller_template_rectangle = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c24_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c24_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c24_is_active_c24_controller_template_rectangle = 0U;
}
...
static void ext_mode_exec_c24_controller_template_rectangle
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance)
{
  c24_update_debugger_state_c24_controller_template_rectangle(chartInstance);
}
  ...
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c24_c_hoistedGlobal = *c24_is_active_c24_controller_template_rectangle;
   ...
   mxArray *c24_st)
{
  ...
  *c24_flag_oob = c24_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c24_u, 1)), "flag_oob");
  *c24_is_active_c24_controller_template_rectangle = c24_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c24_u, 2)),
     "is_active_c24_controller_template_rectangle");
  ...
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c24_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 23U, *c24_sfEvent);
  ...
  *c24_sfEvent = CALL_EVENT;
  c24_chartstep_c24_controller_template_rectangle(chartInstance);
  ...
  (SFc24_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c24_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 23U, *c24_sfEvent);
  ...
  *c24_b_flag_oob = c24_flag_oob;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 23U, *c24_sfEvent);
}
  ...
  *c24_inData)
{
  ...
  const mxArray *c24_y = NULL;
  SFc24_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc24_controller_template_rectangleInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c24_controller_template_rectangle_get_eml_resolved_functions_info(void)
{
   ...
   *c24_identifier)
{
  ...
  c24_y = c24_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c24_is_active_c24_controller_template_rectangle), &c24_thisId);
  sf_mex_destroy(&c24_is_active_c24_controller_template_rectangle);
  return c24_y;
}
...
void sf_c24_controller_template_rectangle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c24_controller_template_rectangle_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c24_controller_template_rectangle
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"U\",},{M[1],M[16],T\"flag_oob\",},{M[8],M[0],T\"is_active_c24_controller_template_rectangle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c24_controller_template_rectangle_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c24_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc24_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc24_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c24_controller_template_rectangle
    ((SFc24_controller_template_rectangleInstanceStruct*) chartInstanceVar);
  initialize_c24_controller_template_rectangle
    ((SFc24_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c24_controller_template_rectangle(void
  *chartInstanceVar)
{
  enable_c24_controller_template_rectangle
    ((SFc24_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c24_controller_template_rectangle(void
  *chartInstanceVar)
{
  disable_c24_controller_template_rectangle
    ((SFc24_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c24_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_c24_controller_template_rectangle
    ((SFc24_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c24_controller_template_rectangle(void
  *chartInstanceVar)
{
  ext_mode_exec_c24_controller_template_rectangle
    ((SFc24_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c24_controller_template_rectangle(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c24_controller_template_rectangle
    ((SFc24_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c24_controller_template_rectangle();/* state var info */
...
extern void sf_internal_set_sim_state_c24_controller_template_rectangle
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c24_controller_template_rectangle
    ((SFc24_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c24_controller_template_rectangle
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c24_controller_template_rectangle(S);
}

static void sf_opaque_set_sim_state_c24_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c24_controller_template_rectangle(S, st);
}

static void sf_opaque_terminate_c24_controller_template_rectangle(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc24_controller_template_rectangleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c24_controller_template_rectangle
      ((SFc24_controller_template_rectangleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc24_controller_template_rectangle
    ((SFc24_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c24_controller_template_rectangle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c24_controller_template_rectangle
      ((SFc24_controller_template_rectangleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c24_controller_template_rectangle_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c24_controller_template_rectangle\",T\"is_active_c24_controller_template_rectangle\"}}"
  };
...
static void mdlSetWorkWidths_c24_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_rectangle_optimization_info();
...
static void mdlRTW_c24_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c24_controller_template_rectangle(SimStruct *S)
{
  SFc24_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc24_controller_template_rectangleInstanceStruct *)malloc
    (sizeof(SFc24_controller_template_rectangleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c24_controller_template_rectangle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c24_controller_template_rectangle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c24_controller_template_rectangle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c24_controller_template_rectangle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c24_controller_template_rectangle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c24_controller_template_rectangle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c24_controller_template_rectangle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c24_controller_template_rectangle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c24_controller_template_rectangle;
  chartInstance->chartInfo.mdlStart = mdlStart_c24_controller_template_rectangle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c24_controller_template_rectangle;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c24_controller_template_rectangle;
...
void c24_controller_template_rectangle_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c24_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c24_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c24_controller_template_rectangle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c24_controller_template_rectangle_method_dispatcher.\n"
