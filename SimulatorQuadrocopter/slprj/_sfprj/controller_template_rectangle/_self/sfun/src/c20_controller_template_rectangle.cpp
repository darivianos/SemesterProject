...
static void initialize_c20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance);
static void initialize_params_c20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance);
static void enable_c20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance);
static void disable_c20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance);
static void c20_update_debugger_state_c20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance);
static void ext_mode_exec_c20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance);
static void set_sim_state_c20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c20_st);
static void finalize_c20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance);
static void sf_c20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance);
static void initSimStructsc20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance);
...
static const mxArray *c20_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static void c20_emlrt_marshallIn
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c20_X_ref_y, const char_T *c20_identifier, real_T c20_y[93]);
static void c20_b_emlrt_marshallIn
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId, real_T c20_y[93]);
...
static const mxArray *c20_c_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static real_T c20_c_emlrt_marshallIn
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance, const
...
static const mxArray *c20_d_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static int32_T c20_d_emlrt_marshallIn
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
...
static uint8_T c20_e_emlrt_marshallIn
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c20_is_active_c20_controller_template_rectangle, const char_T
   *c20_identifier);
static uint8_T c20_f_emlrt_marshallIn
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
...
{
  int32_T *c20_sfEvent;
  uint8_T *c20_is_active_c20_controller_template_rectangle;
  c20_is_active_c20_controller_template_rectangle = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c20_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c20_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c20_is_active_c20_controller_template_rectangle = 0U;
}
...
static void ext_mode_exec_c20_controller_template_rectangle
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance)
{
  c20_update_debugger_state_c20_controller_template_rectangle(chartInstance);
}
  ...
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c20_hoistedGlobal = *c20_is_active_c20_controller_template_rectangle;
   ...
   mxArray *c20_st)
{
  ...
  *c20_is_active_c20_controller_template_rectangle = c20_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c20_u, 1)),
     "is_active_c20_controller_template_rectangle");
  ...
  (SFc20_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  *c20_sfEvent = CALL_EVENT;
  ...
  for (c20_i4 = 0; c20_i4 < 303; c20_i4++) {
    ...
    for (c20_i6 = 0; c20_i6 < 3; c20_i6++) {
      c20_X_ref_y[c20_i6 + 3 * c20_i5] = c20_traj_y[c20_i6 + 3 *
        (_SFD_EML_ARRAY_BOUNDS_CHECK("traj_y", (int32_T)_SFD_INTEGER_CHECK(
           "idx:idx+pred_horizon_y", c20_idx + (real_T)c20_i5), 1, 101, 2, 0) -
         1)];
    }
  }
  ...
  *c20_inData)
{
  ...
  const mxArray *c20_y = NULL;
  SFc20_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc20_controller_template_rectangleInstanceStruct *)
    chartInstanceVoid;
  ...
  *c20_inData)
{
  ...
  c20_mxArrayOutData = NULL;
  c20_i18 = 0;
  for (c20_i19 = 0; c20_i19 < 101; c20_i19++) {
    for (c20_i20 = 0; c20_i20 < 3; c20_i20++) {
      c20_b_inData[c20_i20 + c20_i18] = (*(real_T (*)[303])c20_inData)[c20_i20 +
        c20_i18];
    }
  ...
  c20_i21 = 0;
  for (c20_i22 = 0; c20_i22 < 101; c20_i22++) {
  ...
  c20_y = NULL;
  sf_mex_assign(&c20_y, sf_mex_create("y", c20_u, 0, 0U, 1U, 0U, 2, 3, 101),
                FALSE);
  sf_mex_assign(&c20_mxArrayOutData, c20_y, FALSE);
  return c20_mxArrayOutData;
}
...
const mxArray
  *sf_c20_controller_template_rectangle_get_eml_resolved_functions_info(void)
{
   ...
   *c20_identifier)
{
  ...
  c20_y = c20_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c20_is_active_c20_controller_template_rectangle), &c20_thisId);
  sf_mex_destroy(&c20_is_active_c20_controller_template_rectangle);
  return c20_y;
}
...
void sf_c20_controller_template_rectangle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c20_controller_template_rectangle_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c20_controller_template_rectangle
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[18],T\"X_ref_y\",},{M[8],M[0],T\"is_active_c20_controller_template_rectangle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c20_controller_template_rectangle_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c20_X_ref_y = (real_T (*)[93])ssGetOutputPortSignal(chartInstance->S,
            1);
          c20_traj_y = (real_T (*)[303])ssGetInputPortSignal(chartInstance->S, 0);
...
static void sf_opaque_initialize_c20_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc20_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc20_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c20_controller_template_rectangle
    ((SFc20_controller_template_rectangleInstanceStruct*) chartInstanceVar);
  initialize_c20_controller_template_rectangle
    ((SFc20_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c20_controller_template_rectangle(void
  *chartInstanceVar)
{
  enable_c20_controller_template_rectangle
    ((SFc20_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c20_controller_template_rectangle(void
  *chartInstanceVar)
{
  disable_c20_controller_template_rectangle
    ((SFc20_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c20_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_c20_controller_template_rectangle
    ((SFc20_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c20_controller_template_rectangle(void
  *chartInstanceVar)
{
  ext_mode_exec_c20_controller_template_rectangle
    ((SFc20_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c20_controller_template_rectangle(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c20_controller_template_rectangle
    ((SFc20_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c20_controller_template_rectangle();/* state var info */
...
extern void sf_internal_set_sim_state_c20_controller_template_rectangle
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c20_controller_template_rectangle
    ((SFc20_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c20_controller_template_rectangle
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c20_controller_template_rectangle(S);
}

static void sf_opaque_set_sim_state_c20_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c20_controller_template_rectangle(S, st);
}

static void sf_opaque_terminate_c20_controller_template_rectangle(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc20_controller_template_rectangleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c20_controller_template_rectangle
      ((SFc20_controller_template_rectangleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc20_controller_template_rectangle
    ((SFc20_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c20_controller_template_rectangle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c20_controller_template_rectangle
      ((SFc20_controller_template_rectangleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c20_controller_template_rectangle_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c20_controller_template_rectangle\",T\"is_active_c20_controller_template_rectangle\"}}"
  };
...
static void mdlSetWorkWidths_c20_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_rectangle_optimization_info();
...
static void mdlRTW_c20_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c20_controller_template_rectangle(SimStruct *S)
{
  SFc20_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc20_controller_template_rectangleInstanceStruct *)malloc
    (sizeof(SFc20_controller_template_rectangleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c20_controller_template_rectangle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c20_controller_template_rectangle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c20_controller_template_rectangle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c20_controller_template_rectangle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c20_controller_template_rectangle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c20_controller_template_rectangle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c20_controller_template_rectangle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c20_controller_template_rectangle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c20_controller_template_rectangle;
  chartInstance->chartInfo.mdlStart = mdlStart_c20_controller_template_rectangle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c20_controller_template_rectangle;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c20_controller_template_rectangle;
...
void c20_controller_template_rectangle_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c20_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c20_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c20_controller_template_rectangle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c20_controller_template_rectangle_method_dispatcher.\n"
