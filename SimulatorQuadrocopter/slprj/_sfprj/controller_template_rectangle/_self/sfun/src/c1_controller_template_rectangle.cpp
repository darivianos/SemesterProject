...
static void initialize_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance);
static void initialize_params_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance);
static void enable_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance);
static void disable_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance);
static void ext_mode_exec_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance);
static void set_sim_state_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c1_st);
static void finalize_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance);
static void sf_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance);
static void c1_chartstep_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance);
static void initSimStructsc1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance);
...
static void c1_d_emlrt_marshallIn
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[1000]);
...
static void c1_e_emlrt_marshallIn
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[4000]);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[18]);
static void c1_round(SFc1_controller_template_rectangleInstanceStruct
                     *chartInstance, real_T c1_x[4], real_T c1_b_x[4]);
static void c1_mrdivide(SFc1_controller_template_rectangleInstanceStruct
  *chartInstance, real_T c1_A[4], real_T c1_B, real_T c1_y[4]);
static void c1_eml_scalar_eg(SFc1_controller_template_rectangleInstanceStruct
  *chartInstance);
...
static uint8_T c1_g_emlrt_marshallIn
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c1_is_active_c1_controller_template_rectangle, const char_T
   *c1_identifier);
static uint8_T c1_h_emlrt_marshallIn
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_round(SFc1_controller_template_rectangleInstanceStruct
...
{
  int32_T *c1_sfEvent;
  uint8_T *c1_is_active_c1_controller_template_rectangle;
  c1_is_active_c1_controller_template_rectangle = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c1_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c1_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c1_is_active_c1_controller_template_rectangle = 0U;
}
...
static void ext_mode_exec_c1_controller_template_rectangle
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance)
{
  c1_update_debugger_state_c1_controller_template_rectangle(chartInstance);
}
  ...
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c1_c_hoistedGlobal = *c1_is_active_c1_controller_template_rectangle;
   ...
   mxArray *c1_st)
{
  ...
  *c1_flag_oob = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 1)), "flag_oob");
  *c1_is_active_c1_controller_template_rectangle = c1_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_controller_template_rectangle");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_controller_template_rectangle(chartInstance);
  ...
  (SFc1_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  *c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_controller_template_rectangle(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc1_controller_template_rectangleInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c1_controller_template_rectangle_get_eml_resolved_functions_info(void)
{
   ...
   *c1_identifier)
{
  ...
  c1_y = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_is_active_c1_controller_template_rectangle), &c1_thisId);
  sf_mex_destroy(&c1_is_active_c1_controller_template_rectangle);
  return c1_y;
}
...
void sf_c1_controller_template_rectangle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_controller_template_rectangle_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_controller_template_rectangle
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"U\",},{M[1],M[16],T\"flag_oob\",},{M[8],M[0],T\"is_active_c1_controller_template_rectangle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_controller_template_rectangle_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc1_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc1_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_controller_template_rectangle
    ((SFc1_controller_template_rectangleInstanceStruct*) chartInstanceVar);
  initialize_c1_controller_template_rectangle
    ((SFc1_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_controller_template_rectangle(void
  *chartInstanceVar)
{
  enable_c1_controller_template_rectangle
    ((SFc1_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_controller_template_rectangle(void
  *chartInstanceVar)
{
  disable_c1_controller_template_rectangle
    ((SFc1_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_c1_controller_template_rectangle
    ((SFc1_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c1_controller_template_rectangle(void
  *chartInstanceVar)
{
  ext_mode_exec_c1_controller_template_rectangle
    ((SFc1_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_controller_template_rectangle
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_controller_template_rectangle
    ((SFc1_controller_template_rectangleInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_controller_template_rectangle();/* state var info */
...
extern void sf_internal_set_sim_state_c1_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_controller_template_rectangle
    ((SFc1_controller_template_rectangleInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_controller_template_rectangle
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_controller_template_rectangle(S);
}

static void sf_opaque_set_sim_state_c1_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_controller_template_rectangle(S, st);
}

static void sf_opaque_terminate_c1_controller_template_rectangle(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_controller_template_rectangleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_controller_template_rectangle
      ((SFc1_controller_template_rectangleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_controller_template_rectangle
    ((SFc1_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_controller_template_rectangle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_controller_template_rectangle
      ((SFc1_controller_template_rectangleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c1_controller_template_rectangle_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c1_controller_template_rectangle\",T\"is_active_c1_controller_template_rectangle\"}}"
  };
...
static void mdlSetWorkWidths_c1_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_rectangle_optimization_info();
...
static void mdlRTW_c1_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_controller_template_rectangle(SimStruct *S)
{
  SFc1_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc1_controller_template_rectangleInstanceStruct *)malloc
    (sizeof(SFc1_controller_template_rectangleInstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc1_controller_template_rectangleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_controller_template_rectangle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_controller_template_rectangle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_controller_template_rectangle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_controller_template_rectangle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_controller_template_rectangle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_controller_template_rectangle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_controller_template_rectangle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_controller_template_rectangle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_controller_template_rectangle;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_controller_template_rectangle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_controller_template_rectangle;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c1_controller_template_rectangle;
...
void c1_controller_template_rectangle_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_controller_template_rectangle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_controller_template_rectangle_method_dispatcher.\n"
