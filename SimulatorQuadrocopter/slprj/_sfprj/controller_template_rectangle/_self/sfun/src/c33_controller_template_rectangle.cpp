...
static void initialize_c33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance);
static void initialize_params_c33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance);
static void enable_c33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance);
static void disable_c33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance);
static void c33_update_debugger_state_c33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance);
static void ext_mode_exec_c33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance);
static void set_sim_state_c33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c33_st);
static void finalize_c33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance);
static void sf_c33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance);
static void initSimStructsc33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance);
...
static const mxArray *c33_sf_marshallOut(void *chartInstanceVoid, void
  *c33_inData);
static void c33_emlrt_marshallIn
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c33_X_ref_yaw, const char_T *c33_identifier, real_T c33_y[62]);
static void c33_b_emlrt_marshallIn
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c33_u, const emlrtMsgIdentifier *c33_parentId, real_T c33_y[62]);
...
static uint8_T c33_e_emlrt_marshallIn
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c33_is_active_c33_controller_template_rectangle, const char_T
   *c33_identifier);
...
{
  int32_T *c33_sfEvent;
  uint8_T *c33_is_active_c33_controller_template_rectangle;
  c33_is_active_c33_controller_template_rectangle = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c33_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c33_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c33_is_active_c33_controller_template_rectangle = 0U;
}
...
static void ext_mode_exec_c33_controller_template_rectangle
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance)
{
  c33_update_debugger_state_c33_controller_template_rectangle(chartInstance);
}
  ...
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c33_hoistedGlobal = *c33_is_active_c33_controller_template_rectangle;
   ...
   mxArray *c33_st)
{
  ...
  *c33_is_active_c33_controller_template_rectangle = c33_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c33_u, 1)),
     "is_active_c33_controller_template_rectangle");
  ...
  (SFc33_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  int32_T c33_i4;
  real_T c33_X_ref_yaw_unbounded[202];
  real_T c33_yaw_meas;
  real_T c33_idx;
  ...
  real_T (*c33_b_X_ref_yaw_unbounded)[202];
  ...
  c33_b_X_ref_yaw_unbounded = (real_T (*)[202])ssGetInputPortSignal
    (chartInstance->S, 0);
  c33_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 32U, *c33_sfEvent);
  for (c33_i2 = 0; c33_i2 < 202; c33_i2++) {
  ...
  *c33_sfEvent = CALL_EVENT;
  ...
  for (c33_i4 = 0; c33_i4 < 202; c33_i4++) {
  ...
  c33_yaw0 = c33_X_ref_yaw_unbounded[(_SFD_EML_ARRAY_BOUNDS_CHECK(
    "X_ref_yaw_unbounded", (int32_T)_SFD_INTEGER_CHECK("idx", c33_idx), 1, 101,
    2, 0) - 1) << 1];
  ...
  *c33_inData)
{
  ...
  const mxArray *c33_y = NULL;
  SFc33_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc33_controller_template_rectangleInstanceStruct *)
    chartInstanceVoid;
  ...
  *c33_inData)
{
  ...
  c33_mxArrayOutData = NULL;
  c33_i18 = 0;
  for (c33_i19 = 0; c33_i19 < 101; c33_i19++) {
    for (c33_i20 = 0; c33_i20 < 2; c33_i20++) {
      c33_b_inData[c33_i20 + c33_i18] = (*(real_T (*)[202])c33_inData)[c33_i20 +
        c33_i18];
    }
  ...
  c33_i21 = 0;
  for (c33_i22 = 0; c33_i22 < 101; c33_i22++) {
  ...
  c33_y = NULL;
  sf_mex_assign(&c33_y, sf_mex_create("y", c33_u, 0, 0U, 1U, 0U, 2, 2, 101),
                FALSE);
  sf_mex_assign(&c33_mxArrayOutData, c33_y, FALSE);
  return c33_mxArrayOutData;
}
...
const mxArray
  *sf_c33_controller_template_rectangle_get_eml_resolved_functions_info(void)
{
   ...
   *c33_identifier)
{
  ...
  c33_y = c33_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c33_is_active_c33_controller_template_rectangle), &c33_thisId);
  sf_mex_destroy(&c33_is_active_c33_controller_template_rectangle);
  return c33_y;
}
...
void sf_c33_controller_template_rectangle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c33_controller_template_rectangle_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c33_controller_template_rectangle
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[18],T\"X_ref_yaw\",},{M[8],M[0],T\"is_active_c33_controller_template_rectangle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c33_controller_template_rectangle_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c33_X_ref_yaw = (real_T (*)[62])ssGetOutputPortSignal(chartInstance->S,
            1);
          c33_X_ref_yaw_unbounded = (real_T (*)[202])ssGetInputPortSignal
            (chartInstance->S, 0);
...
static void sf_opaque_initialize_c33_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc33_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc33_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c33_controller_template_rectangle
    ((SFc33_controller_template_rectangleInstanceStruct*) chartInstanceVar);
  initialize_c33_controller_template_rectangle
    ((SFc33_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c33_controller_template_rectangle(void
  *chartInstanceVar)
{
  enable_c33_controller_template_rectangle
    ((SFc33_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c33_controller_template_rectangle(void
  *chartInstanceVar)
{
  disable_c33_controller_template_rectangle
    ((SFc33_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c33_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_c33_controller_template_rectangle
    ((SFc33_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c33_controller_template_rectangle(void
  *chartInstanceVar)
{
  ext_mode_exec_c33_controller_template_rectangle
    ((SFc33_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c33_controller_template_rectangle(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c33_controller_template_rectangle
    ((SFc33_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c33_controller_template_rectangle();/* state var info */
...
extern void sf_internal_set_sim_state_c33_controller_template_rectangle
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c33_controller_template_rectangle
    ((SFc33_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c33_controller_template_rectangle
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c33_controller_template_rectangle(S);
}

static void sf_opaque_set_sim_state_c33_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c33_controller_template_rectangle(S, st);
}

static void sf_opaque_terminate_c33_controller_template_rectangle(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc33_controller_template_rectangleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c33_controller_template_rectangle
      ((SFc33_controller_template_rectangleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc33_controller_template_rectangle
    ((SFc33_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c33_controller_template_rectangle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c33_controller_template_rectangle
      ((SFc33_controller_template_rectangleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c33_controller_template_rectangle_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c33_controller_template_rectangle\",T\"is_active_c33_controller_template_rectangle\"}}"
  };
...
static void mdlSetWorkWidths_c33_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_rectangle_optimization_info();
...
static void mdlRTW_c33_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c33_controller_template_rectangle(SimStruct *S)
{
  SFc33_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc33_controller_template_rectangleInstanceStruct *)malloc
    (sizeof(SFc33_controller_template_rectangleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c33_controller_template_rectangle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c33_controller_template_rectangle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c33_controller_template_rectangle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c33_controller_template_rectangle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c33_controller_template_rectangle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c33_controller_template_rectangle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c33_controller_template_rectangle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c33_controller_template_rectangle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c33_controller_template_rectangle;
  chartInstance->chartInfo.mdlStart = mdlStart_c33_controller_template_rectangle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c33_controller_template_rectangle;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c33_controller_template_rectangle;
...
void c33_controller_template_rectangle_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c33_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c33_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c33_controller_template_rectangle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c33_controller_template_rectangle_method_dispatcher.\n"
