...
static void initialize_c28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance);
static void initialize_params_c28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance);
static void enable_c28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance);
static void disable_c28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance);
static void c28_update_debugger_state_c28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance);
static void ext_mode_exec_c28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance);
static void set_sim_state_c28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c28_st);
static void finalize_c28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance);
static void sf_c28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance);
static void initSimStructsc28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance);
...
static real_T c28_emlrt_marshallIn
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c28_psi_prime, const char_T *c28_identifier);
...
static uint8_T c28_d_emlrt_marshallIn
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c28_is_active_c28_controller_template_rectangle, const char_T
   *c28_identifier);
...
{
  int32_T *c28_sfEvent;
  uint8_T *c28_is_active_c28_controller_template_rectangle;
  c28_is_active_c28_controller_template_rectangle = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c28_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c28_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c28_is_active_c28_controller_template_rectangle = 0U;
}
...
static void ext_mode_exec_c28_controller_template_rectangle
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance)
{
  c28_update_debugger_state_c28_controller_template_rectangle(chartInstance);
}
  ...
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c28_b_hoistedGlobal = *c28_is_active_c28_controller_template_rectangle;
   ...
   mxArray *c28_st)
{
  ...
  *c28_psi_prime = c28_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c28_u, 0)), "psi_prime");
  *c28_is_active_c28_controller_template_rectangle = c28_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c28_u, 1)),
     "is_active_c28_controller_template_rectangle");
  ...
  (SFc28_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c28_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 27U, *c28_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c28_b_psi_meas, 0U);
  _SFD_DATA_RANGE_CHECK(*c28_b_psi_prime, 1U);
  *c28_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 27U, *c28_sfEvent);
  ...
  *c28_b_psi_prime = c28_psi_prime;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 27U, *c28_sfEvent);
  ...
  *c28_inData)
{
  ...
  const mxArray *c28_y = NULL;
  SFc28_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc28_controller_template_rectangleInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c28_controller_template_rectangle_get_eml_resolved_functions_info(void)
{
   ...
   *c28_identifier)
{
  ...
  c28_y = c28_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c28_is_active_c28_controller_template_rectangle), &c28_thisId);
  sf_mex_destroy(&c28_is_active_c28_controller_template_rectangle);
  return c28_y;
}
...
void sf_c28_controller_template_rectangle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c28_controller_template_rectangle_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c28_controller_template_rectangle
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"psi_prime\",},{M[8],M[0],T\"is_active_c28_controller_template_rectangle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c28_controller_template_rectangle_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c28_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc28_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc28_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c28_controller_template_rectangle
    ((SFc28_controller_template_rectangleInstanceStruct*) chartInstanceVar);
  initialize_c28_controller_template_rectangle
    ((SFc28_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c28_controller_template_rectangle(void
  *chartInstanceVar)
{
  enable_c28_controller_template_rectangle
    ((SFc28_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c28_controller_template_rectangle(void
  *chartInstanceVar)
{
  disable_c28_controller_template_rectangle
    ((SFc28_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c28_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_c28_controller_template_rectangle
    ((SFc28_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c28_controller_template_rectangle(void
  *chartInstanceVar)
{
  ext_mode_exec_c28_controller_template_rectangle
    ((SFc28_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c28_controller_template_rectangle(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c28_controller_template_rectangle
    ((SFc28_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c28_controller_template_rectangle();/* state var info */
...
extern void sf_internal_set_sim_state_c28_controller_template_rectangle
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c28_controller_template_rectangle
    ((SFc28_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c28_controller_template_rectangle
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c28_controller_template_rectangle(S);
}

static void sf_opaque_set_sim_state_c28_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c28_controller_template_rectangle(S, st);
}

static void sf_opaque_terminate_c28_controller_template_rectangle(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc28_controller_template_rectangleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c28_controller_template_rectangle
      ((SFc28_controller_template_rectangleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc28_controller_template_rectangle
    ((SFc28_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c28_controller_template_rectangle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c28_controller_template_rectangle
      ((SFc28_controller_template_rectangleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c28_controller_template_rectangle_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c28_controller_template_rectangle\",T\"is_active_c28_controller_template_rectangle\"}}"
  };
...
static void mdlSetWorkWidths_c28_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_rectangle_optimization_info();
...
static void mdlRTW_c28_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c28_controller_template_rectangle(SimStruct *S)
{
  SFc28_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc28_controller_template_rectangleInstanceStruct *)malloc
    (sizeof(SFc28_controller_template_rectangleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c28_controller_template_rectangle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c28_controller_template_rectangle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c28_controller_template_rectangle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c28_controller_template_rectangle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c28_controller_template_rectangle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c28_controller_template_rectangle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c28_controller_template_rectangle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c28_controller_template_rectangle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c28_controller_template_rectangle;
  chartInstance->chartInfo.mdlStart = mdlStart_c28_controller_template_rectangle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c28_controller_template_rectangle;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c28_controller_template_rectangle;
...
void c28_controller_template_rectangle_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c28_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c28_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c28_controller_template_rectangle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c28_controller_template_rectangle_method_dispatcher.\n"
