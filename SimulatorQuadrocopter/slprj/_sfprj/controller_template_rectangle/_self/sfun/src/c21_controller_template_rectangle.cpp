...
static void initialize_c21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance);
static void initialize_params_c21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance);
static void enable_c21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance);
static void disable_c21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance);
static void ext_mode_exec_c21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance);
static void set_sim_state_c21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c21_st);
static void finalize_c21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance);
static void sf_c21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance);
static void initSimStructsc21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance);
...
static void c21_emlrt_marshallIn
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c21_X_ref_yaw, const char_T *c21_identifier, real_T c21_y[62]);
static void c21_b_emlrt_marshallIn
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId, real_T c21_y[62]);
...
static uint8_T c21_e_emlrt_marshallIn
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c21_is_active_c21_controller_template_rectangle, const char_T
   *c21_identifier);
...
{
  int32_T *c21_sfEvent;
  uint8_T *c21_is_active_c21_controller_template_rectangle;
  c21_is_active_c21_controller_template_rectangle = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c21_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c21_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c21_is_active_c21_controller_template_rectangle = 0U;
}
...
static void ext_mode_exec_c21_controller_template_rectangle
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance)
{
  c21_update_debugger_state_c21_controller_template_rectangle(chartInstance);
}
  ...
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c21_hoistedGlobal = *c21_is_active_c21_controller_template_rectangle;
   ...
   mxArray *c21_st)
{
  ...
  *c21_is_active_c21_controller_template_rectangle = c21_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c21_u, 1)),
     "is_active_c21_controller_template_rectangle");
  ...
  (SFc21_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  int32_T c21_i4;
  real_T c21_X_ref_yaw_unbounded[202];
  real_T c21_yaw_meas;
  real_T c21_idx;
  ...
  real_T (*c21_b_X_ref_yaw_unbounded)[202];
  ...
  c21_b_X_ref_yaw_unbounded = (real_T (*)[202])ssGetInputPortSignal
    (chartInstance->S, 0);
  c21_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 20U, *c21_sfEvent);
  for (c21_i2 = 0; c21_i2 < 202; c21_i2++) {
  ...
  *c21_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 20U, *c21_sfEvent);
  c21_hoistedGlobal = *c21_b_yaw_meas;
  c21_b_hoistedGlobal = *c21_b_idx;
  for (c21_i4 = 0; c21_i4 < 202; c21_i4++) {
  ...
  c21_yaw0 = c21_X_ref_yaw_unbounded[(_SFD_EML_ARRAY_BOUNDS_CHECK(
    "X_ref_yaw_unbounded", (int32_T)_SFD_INTEGER_CHECK("idx", c21_idx), 1, 101,
    2, 0) - 1) << 1];
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 20U, *c21_sfEvent);
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc21_controller_template_rectangleInstanceStruct *)
    chartInstanceVoid;
  ...
  *c21_inData)
{
  ...
  c21_mxArrayOutData = NULL;
  c21_i18 = 0;
  for (c21_i19 = 0; c21_i19 < 101; c21_i19++) {
    for (c21_i20 = 0; c21_i20 < 2; c21_i20++) {
      c21_b_inData[c21_i20 + c21_i18] = (*(real_T (*)[202])c21_inData)[c21_i20 +
        c21_i18];
    }
  ...
  c21_i21 = 0;
  for (c21_i22 = 0; c21_i22 < 101; c21_i22++) {
  ...
  c21_y = NULL;
  sf_mex_assign(&c21_y, sf_mex_create("y", c21_u, 0, 0U, 1U, 0U, 2, 2, 101),
                FALSE);
  sf_mex_assign(&c21_mxArrayOutData, c21_y, FALSE);
  return c21_mxArrayOutData;
}
...
const mxArray
  *sf_c21_controller_template_rectangle_get_eml_resolved_functions_info(void)
{
   ...
   *c21_identifier)
{
  ...
  c21_y = c21_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_is_active_c21_controller_template_rectangle), &c21_thisId);
  sf_mex_destroy(&c21_is_active_c21_controller_template_rectangle);
  return c21_y;
}
...
void sf_c21_controller_template_rectangle_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1540486928U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3245237629U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1674137610U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2009261664U);
}

mxArray *sf_c21_controller_template_rectangle_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("kNRgDY1XE01NCdVVyracaC");
...
static const mxArray *sf_get_sim_state_info_c21_controller_template_rectangle
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[18],T\"X_ref_yaw\",},{M[8],M[0],T\"is_active_c21_controller_template_rectangle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_controller_template_rectangle_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c21_X_ref_yaw = (real_T (*)[62])ssGetOutputPortSignal(chartInstance->S,
            1);
          c21_X_ref_yaw_unbounded = (real_T (*)[202])ssGetInputPortSignal
            (chartInstance->S, 0);
...
static void sf_opaque_initialize_c21_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc21_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc21_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c21_controller_template_rectangle
    ((SFc21_controller_template_rectangleInstanceStruct*) chartInstanceVar);
  initialize_c21_controller_template_rectangle
    ((SFc21_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c21_controller_template_rectangle(void
  *chartInstanceVar)
{
  enable_c21_controller_template_rectangle
    ((SFc21_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_controller_template_rectangle(void
  *chartInstanceVar)
{
  disable_c21_controller_template_rectangle
    ((SFc21_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_c21_controller_template_rectangle
    ((SFc21_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c21_controller_template_rectangle(void
  *chartInstanceVar)
{
  ext_mode_exec_c21_controller_template_rectangle
    ((SFc21_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c21_controller_template_rectangle(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_controller_template_rectangle
    ((SFc21_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c21_controller_template_rectangle();/* state var info */
...
extern void sf_internal_set_sim_state_c21_controller_template_rectangle
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c21_controller_template_rectangle
    ((SFc21_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c21_controller_template_rectangle
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c21_controller_template_rectangle(S);
}

static void sf_opaque_set_sim_state_c21_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c21_controller_template_rectangle(S, st);
}

static void sf_opaque_terminate_c21_controller_template_rectangle(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_controller_template_rectangleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c21_controller_template_rectangle
      ((SFc21_controller_template_rectangleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc21_controller_template_rectangle
    ((SFc21_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_controller_template_rectangle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c21_controller_template_rectangle
      ((SFc21_controller_template_rectangleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c21_controller_template_rectangle_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c21_controller_template_rectangle\",T\"is_active_c21_controller_template_rectangle\"}}"
  };
...
static void mdlSetWorkWidths_c21_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_rectangle_optimization_info();
  ...
  ssSetChecksum0(S,(177409063U));
  ssSetChecksum1(S,(1114999715U));
  ssSetChecksum2(S,(3846012499U));
  ssSetChecksum3(S,(860685749U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c21_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_controller_template_rectangle(SimStruct *S)
{
  SFc21_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc21_controller_template_rectangleInstanceStruct *)malloc
    (sizeof(SFc21_controller_template_rectangleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c21_controller_template_rectangle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c21_controller_template_rectangle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c21_controller_template_rectangle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c21_controller_template_rectangle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c21_controller_template_rectangle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c21_controller_template_rectangle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c21_controller_template_rectangle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_controller_template_rectangle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_controller_template_rectangle;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_controller_template_rectangle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c21_controller_template_rectangle;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c21_controller_template_rectangle;
...
void c21_controller_template_rectangle_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_controller_template_rectangle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_controller_template_rectangle_method_dispatcher.\n"
