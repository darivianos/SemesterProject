...
static void initialize_c31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance);
static void initialize_params_c31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance);
static void enable_c31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance);
static void disable_c31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance);
static void c31_update_debugger_state_c31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance);
static void ext_mode_exec_c31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance);
static void set_sim_state_c31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c31_st);
static void finalize_c31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance);
static void sf_c31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance);
static void initSimStructsc31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance);
...
static const mxArray *c31_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_emlrt_marshallIn
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c31_X_ref_x, const char_T *c31_identifier, real_T c31_y[93]);
static void c31_b_emlrt_marshallIn
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId, real_T c31_y[93]);
...
static uint8_T c31_e_emlrt_marshallIn
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c31_is_active_c31_controller_template_rectangle, const char_T
   *c31_identifier);
...
{
  int32_T *c31_sfEvent;
  uint8_T *c31_is_active_c31_controller_template_rectangle;
  c31_is_active_c31_controller_template_rectangle = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c31_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c31_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c31_is_active_c31_controller_template_rectangle = 0U;
}
...
static void ext_mode_exec_c31_controller_template_rectangle
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance)
{
  c31_update_debugger_state_c31_controller_template_rectangle(chartInstance);
}
  ...
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c31_hoistedGlobal = *c31_is_active_c31_controller_template_rectangle;
   ...
   mxArray *c31_st)
{
  ...
  *c31_is_active_c31_controller_template_rectangle = c31_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c31_u, 1)),
     "is_active_c31_controller_template_rectangle");
  ...
  (SFc31_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  *c31_sfEvent = CALL_EVENT;
  ...
  for (c31_i4 = 0; c31_i4 < 303; c31_i4++) {
    ...
    for (c31_i6 = 0; c31_i6 < 3; c31_i6++) {
      c31_X_ref_x[c31_i6 + 3 * c31_i5] = c31_traj_x[c31_i6 + 3 *
        (_SFD_EML_ARRAY_BOUNDS_CHECK("traj_x", (int32_T)_SFD_INTEGER_CHECK(
           "idx:idx+pred_horizon_x", c31_idx + (real_T)c31_i5), 1, 101, 2, 0) -
         1)];
    }
  }
  ...
  *c31_inData)
{
  ...
  const mxArray *c31_y = NULL;
  SFc31_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc31_controller_template_rectangleInstanceStruct *)
    chartInstanceVoid;
  ...
  *c31_inData)
{
  ...
  c31_mxArrayOutData = NULL;
  c31_i18 = 0;
  for (c31_i19 = 0; c31_i19 < 101; c31_i19++) {
    for (c31_i20 = 0; c31_i20 < 3; c31_i20++) {
      c31_b_inData[c31_i20 + c31_i18] = (*(real_T (*)[303])c31_inData)[c31_i20 +
        c31_i18];
    }
  ...
  c31_i21 = 0;
  for (c31_i22 = 0; c31_i22 < 101; c31_i22++) {
  ...
  c31_y = NULL;
  sf_mex_assign(&c31_y, sf_mex_create("y", c31_u, 0, 0U, 1U, 0U, 2, 3, 101),
                FALSE);
  sf_mex_assign(&c31_mxArrayOutData, c31_y, FALSE);
  return c31_mxArrayOutData;
}
...
const mxArray
  *sf_c31_controller_template_rectangle_get_eml_resolved_functions_info(void)
{
   ...
   *c31_identifier)
{
  ...
  c31_y = c31_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c31_is_active_c31_controller_template_rectangle), &c31_thisId);
  sf_mex_destroy(&c31_is_active_c31_controller_template_rectangle);
  return c31_y;
}
...
void sf_c31_controller_template_rectangle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c31_controller_template_rectangle_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c31_controller_template_rectangle
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[18],T\"X_ref_x\",},{M[8],M[0],T\"is_active_c31_controller_template_rectangle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c31_controller_template_rectangle_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c31_X_ref_x = (real_T (*)[93])ssGetOutputPortSignal(chartInstance->S,
            1);
          c31_traj_x = (real_T (*)[303])ssGetInputPortSignal(chartInstance->S, 0);
...
static void sf_opaque_initialize_c31_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc31_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc31_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c31_controller_template_rectangle
    ((SFc31_controller_template_rectangleInstanceStruct*) chartInstanceVar);
  initialize_c31_controller_template_rectangle
    ((SFc31_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c31_controller_template_rectangle(void
  *chartInstanceVar)
{
  enable_c31_controller_template_rectangle
    ((SFc31_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c31_controller_template_rectangle(void
  *chartInstanceVar)
{
  disable_c31_controller_template_rectangle
    ((SFc31_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c31_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_c31_controller_template_rectangle
    ((SFc31_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c31_controller_template_rectangle(void
  *chartInstanceVar)
{
  ext_mode_exec_c31_controller_template_rectangle
    ((SFc31_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c31_controller_template_rectangle(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c31_controller_template_rectangle
    ((SFc31_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c31_controller_template_rectangle();/* state var info */
...
extern void sf_internal_set_sim_state_c31_controller_template_rectangle
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c31_controller_template_rectangle
    ((SFc31_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c31_controller_template_rectangle
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c31_controller_template_rectangle(S);
}

static void sf_opaque_set_sim_state_c31_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c31_controller_template_rectangle(S, st);
}

static void sf_opaque_terminate_c31_controller_template_rectangle(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc31_controller_template_rectangleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c31_controller_template_rectangle
      ((SFc31_controller_template_rectangleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc31_controller_template_rectangle
    ((SFc31_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c31_controller_template_rectangle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c31_controller_template_rectangle
      ((SFc31_controller_template_rectangleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c31_controller_template_rectangle_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c31_controller_template_rectangle\",T\"is_active_c31_controller_template_rectangle\"}}"
  };
...
static void mdlSetWorkWidths_c31_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_rectangle_optimization_info();
...
static void mdlRTW_c31_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c31_controller_template_rectangle(SimStruct *S)
{
  SFc31_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc31_controller_template_rectangleInstanceStruct *)malloc
    (sizeof(SFc31_controller_template_rectangleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c31_controller_template_rectangle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c31_controller_template_rectangle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c31_controller_template_rectangle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c31_controller_template_rectangle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c31_controller_template_rectangle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c31_controller_template_rectangle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c31_controller_template_rectangle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c31_controller_template_rectangle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c31_controller_template_rectangle;
  chartInstance->chartInfo.mdlStart = mdlStart_c31_controller_template_rectangle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c31_controller_template_rectangle;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c31_controller_template_rectangle;
...
void c31_controller_template_rectangle_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c31_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c31_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c31_controller_template_rectangle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c31_controller_template_rectangle_method_dispatcher.\n"
