...
static void initialize_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance);
static void initialize_params_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance);
static void enable_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance);
static void disable_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance);
static void ext_mode_exec_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance);
static void set_sim_state_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c5_st);
static void finalize_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance);
static void sf_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance);
static void c5_chartstep_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance);
static void initSimStructsc5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_controller_template_rectangleInstanceStruct
...
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static void c5_eml_scalar_eg(SFc5_controller_template_rectangleInstanceStruct
  *chartInstance);
static void c5_b_eml_scalar_eg(SFc5_controller_template_rectangleInstanceStruct *
  chartInstance);
...
static uint8_T c5_e_emlrt_marshallIn
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c5_is_active_c5_controller_template_rectangle, const char_T
   *c5_identifier);
...
{
  int32_T *c5_sfEvent;
  uint8_T *c5_is_active_c5_controller_template_rectangle;
  c5_is_active_c5_controller_template_rectangle = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c5_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c5_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c5_is_active_c5_controller_template_rectangle = 0U;
}
...
static void ext_mode_exec_c5_controller_template_rectangle
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance)
{
  c5_update_debugger_state_c5_controller_template_rectangle(chartInstance);
}
  ...
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal = *c5_is_active_c5_controller_template_rectangle;
   ...
   mxArray *c5_st)
{
  ...
  *c5_is_active_c5_controller_template_rectangle = c5_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
     "is_active_c5_controller_template_rectangle");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_controller_template_rectangle(chartInstance);
  ...
  (SFc5_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  *c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_controller_template_rectangle(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc5_controller_template_rectangleInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c5_controller_template_rectangle_get_eml_resolved_functions_info(void)
{
   ...
   *c5_identifier)
{
  ...
  c5_y = c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_is_active_c5_controller_template_rectangle), &c5_thisId);
  sf_mex_destroy(&c5_is_active_c5_controller_template_rectangle);
  return c5_y;
}
...
void sf_c5_controller_template_rectangle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_controller_template_rectangle_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_controller_template_rectangle
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c5_controller_template_rectangle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_controller_template_rectangle_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc5_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc5_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_controller_template_rectangle
    ((SFc5_controller_template_rectangleInstanceStruct*) chartInstanceVar);
  initialize_c5_controller_template_rectangle
    ((SFc5_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_controller_template_rectangle(void
  *chartInstanceVar)
{
  enable_c5_controller_template_rectangle
    ((SFc5_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_controller_template_rectangle(void
  *chartInstanceVar)
{
  disable_c5_controller_template_rectangle
    ((SFc5_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_c5_controller_template_rectangle
    ((SFc5_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c5_controller_template_rectangle(void
  *chartInstanceVar)
{
  ext_mode_exec_c5_controller_template_rectangle
    ((SFc5_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_controller_template_rectangle
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_controller_template_rectangle
    ((SFc5_controller_template_rectangleInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_controller_template_rectangle();/* state var info */
...
extern void sf_internal_set_sim_state_c5_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_controller_template_rectangle
    ((SFc5_controller_template_rectangleInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_controller_template_rectangle
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c5_controller_template_rectangle(S);
}

static void sf_opaque_set_sim_state_c5_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_controller_template_rectangle(S, st);
}

static void sf_opaque_terminate_c5_controller_template_rectangle(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_controller_template_rectangleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_controller_template_rectangle
      ((SFc5_controller_template_rectangleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_controller_template_rectangle
    ((SFc5_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_controller_template_rectangle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_controller_template_rectangle
      ((SFc5_controller_template_rectangleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c5_controller_template_rectangle_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c5_controller_template_rectangle\",T\"is_active_c5_controller_template_rectangle\"}}"
  };
...
static void mdlSetWorkWidths_c5_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_rectangle_optimization_info();
...
static void mdlRTW_c5_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_controller_template_rectangle(SimStruct *S)
{
  SFc5_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc5_controller_template_rectangleInstanceStruct *)malloc
    (sizeof(SFc5_controller_template_rectangleInstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc5_controller_template_rectangleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_controller_template_rectangle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_controller_template_rectangle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_controller_template_rectangle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_controller_template_rectangle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_controller_template_rectangle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_controller_template_rectangle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_controller_template_rectangle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_controller_template_rectangle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_controller_template_rectangle;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_controller_template_rectangle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_controller_template_rectangle;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c5_controller_template_rectangle;
...
void c5_controller_template_rectangle_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_controller_template_rectangle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_controller_template_rectangle_method_dispatcher.\n"
