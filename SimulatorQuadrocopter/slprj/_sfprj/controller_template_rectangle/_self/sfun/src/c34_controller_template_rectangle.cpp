...
static void initialize_c34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance);
static void initialize_params_c34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance);
static void enable_c34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance);
static void disable_c34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance);
static void c34_update_debugger_state_c34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance);
static void ext_mode_exec_c34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance);
static void set_sim_state_c34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c34_st);
static void finalize_c34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance);
static void sf_c34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance);
static void initSimStructsc34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance);
...
static const mxArray *c34_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static void c34_emlrt_marshallIn
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c34_X_ref_z, const char_T *c34_identifier, real_T c34_y[62]);
static void c34_b_emlrt_marshallIn
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c34_u, const emlrtMsgIdentifier *c34_parentId, real_T c34_y[62]);
...
static uint8_T c34_e_emlrt_marshallIn
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c34_is_active_c34_controller_template_rectangle, const char_T
   *c34_identifier);
...
{
  int32_T *c34_sfEvent;
  uint8_T *c34_is_active_c34_controller_template_rectangle;
  c34_is_active_c34_controller_template_rectangle = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c34_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c34_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c34_is_active_c34_controller_template_rectangle = 0U;
}
...
static void ext_mode_exec_c34_controller_template_rectangle
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance)
{
  c34_update_debugger_state_c34_controller_template_rectangle(chartInstance);
}
  ...
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c34_hoistedGlobal = *c34_is_active_c34_controller_template_rectangle;
   ...
   mxArray *c34_st)
{
  ...
  *c34_is_active_c34_controller_template_rectangle = c34_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c34_u, 1)),
     "is_active_c34_controller_template_rectangle");
  ...
  (SFc34_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  real_T (*c34_b_traj_z)[202];
  c34_b_idx = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c34_b_X_ref_z = (real_T (*)[62])ssGetOutputPortSignal(chartInstance->S, 1);
  c34_b_traj_z = (real_T (*)[202])ssGetInputPortSignal(chartInstance->S, 0);
  c34_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 33U, *c34_sfEvent);
  for (c34_i2 = 0; c34_i2 < 202; c34_i2++) {
  ...
  *c34_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 33U, *c34_sfEvent);
  c34_hoistedGlobal = *c34_b_idx;
  for (c34_i4 = 0; c34_i4 < 202; c34_i4++) {
    ...
    for (c34_i6 = 0; c34_i6 < 2; c34_i6++) {
      c34_X_ref_z[c34_i6 + (c34_i5 << 1)] = c34_traj_z[c34_i6 +
        ((_SFD_EML_ARRAY_BOUNDS_CHECK("traj_z", (int32_T)_SFD_INTEGER_CHECK(
            "idx:idx+pred_horizon_z", c34_idx + (real_T)c34_i5), 1, 101, 2, 0) -
          1) << 1)];
    }
  }
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 33U, *c34_sfEvent);
  ...
  *c34_inData)
{
  ...
  const mxArray *c34_y = NULL;
  SFc34_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc34_controller_template_rectangleInstanceStruct *)
    chartInstanceVoid;
  ...
  *c34_inData)
{
  ...
  c34_mxArrayOutData = NULL;
  c34_i18 = 0;
  for (c34_i19 = 0; c34_i19 < 101; c34_i19++) {
    for (c34_i20 = 0; c34_i20 < 2; c34_i20++) {
      c34_b_inData[c34_i20 + c34_i18] = (*(real_T (*)[202])c34_inData)[c34_i20 +
        c34_i18];
    }
  ...
  c34_i21 = 0;
  for (c34_i22 = 0; c34_i22 < 101; c34_i22++) {
  ...
  c34_y = NULL;
  sf_mex_assign(&c34_y, sf_mex_create("y", c34_u, 0, 0U, 1U, 0U, 2, 2, 101),
                FALSE);
  sf_mex_assign(&c34_mxArrayOutData, c34_y, FALSE);
  return c34_mxArrayOutData;
}
...
const mxArray
  *sf_c34_controller_template_rectangle_get_eml_resolved_functions_info(void)
{
   ...
   *c34_identifier)
{
  ...
  c34_y = c34_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c34_is_active_c34_controller_template_rectangle), &c34_thisId);
  sf_mex_destroy(&c34_is_active_c34_controller_template_rectangle);
  return c34_y;
}
...
void sf_c34_controller_template_rectangle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c34_controller_template_rectangle_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c34_controller_template_rectangle
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[18],T\"X_ref_z\",},{M[8],M[0],T\"is_active_c34_controller_template_rectangle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c34_controller_template_rectangle_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c34_X_ref_z = (real_T (*)[62])ssGetOutputPortSignal(chartInstance->S,
            1);
          c34_traj_z = (real_T (*)[202])ssGetInputPortSignal(chartInstance->S, 0);
...
static void sf_opaque_initialize_c34_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc34_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc34_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c34_controller_template_rectangle
    ((SFc34_controller_template_rectangleInstanceStruct*) chartInstanceVar);
  initialize_c34_controller_template_rectangle
    ((SFc34_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c34_controller_template_rectangle(void
  *chartInstanceVar)
{
  enable_c34_controller_template_rectangle
    ((SFc34_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c34_controller_template_rectangle(void
  *chartInstanceVar)
{
  disable_c34_controller_template_rectangle
    ((SFc34_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c34_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_c34_controller_template_rectangle
    ((SFc34_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c34_controller_template_rectangle(void
  *chartInstanceVar)
{
  ext_mode_exec_c34_controller_template_rectangle
    ((SFc34_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c34_controller_template_rectangle(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c34_controller_template_rectangle
    ((SFc34_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c34_controller_template_rectangle();/* state var info */
...
extern void sf_internal_set_sim_state_c34_controller_template_rectangle
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c34_controller_template_rectangle
    ((SFc34_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c34_controller_template_rectangle
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c34_controller_template_rectangle(S);
}

static void sf_opaque_set_sim_state_c34_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c34_controller_template_rectangle(S, st);
}

static void sf_opaque_terminate_c34_controller_template_rectangle(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc34_controller_template_rectangleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c34_controller_template_rectangle
      ((SFc34_controller_template_rectangleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc34_controller_template_rectangle
    ((SFc34_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c34_controller_template_rectangle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c34_controller_template_rectangle
      ((SFc34_controller_template_rectangleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c34_controller_template_rectangle_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c34_controller_template_rectangle\",T\"is_active_c34_controller_template_rectangle\"}}"
  };
...
static void mdlSetWorkWidths_c34_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_rectangle_optimization_info();
...
static void mdlRTW_c34_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c34_controller_template_rectangle(SimStruct *S)
{
  SFc34_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc34_controller_template_rectangleInstanceStruct *)malloc
    (sizeof(SFc34_controller_template_rectangleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c34_controller_template_rectangle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c34_controller_template_rectangle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c34_controller_template_rectangle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c34_controller_template_rectangle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c34_controller_template_rectangle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c34_controller_template_rectangle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c34_controller_template_rectangle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c34_controller_template_rectangle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c34_controller_template_rectangle;
  chartInstance->chartInfo.mdlStart = mdlStart_c34_controller_template_rectangle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c34_controller_template_rectangle;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c34_controller_template_rectangle;
...
void c34_controller_template_rectangle_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c34_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c34_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c34_controller_template_rectangle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c34_controller_template_rectangle_method_dispatcher.\n"
