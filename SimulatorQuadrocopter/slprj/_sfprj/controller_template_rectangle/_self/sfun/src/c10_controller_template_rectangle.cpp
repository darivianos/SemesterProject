...
static void initialize_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance);
static void initialize_params_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance);
static void enable_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance);
static void disable_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance);
static void ext_mode_exec_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance);
static void set_sim_state_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c10_st);
static void finalize_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance);
static void sf_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance);
static void c10_chartstep_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance);
static void initSimStructsc10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance);
...
static real_T c10_emlrt_marshallIn
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c10_roll_bias_rot, const char_T *c10_identifier);
...
static void c10_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static void c10_eml_scalar_eg(SFc10_controller_template_rectangleInstanceStruct *
  chartInstance);
...
static uint8_T c10_f_emlrt_marshallIn
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance, const
   mxArray *c10_is_active_c10_controller_template_rectangle, const char_T
   *c10_identifier);
...
{
  int32_T *c10_sfEvent;
  uint8_T *c10_is_active_c10_controller_template_rectangle;
  c10_is_active_c10_controller_template_rectangle = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c10_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c10_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c10_is_active_c10_controller_template_rectangle = 0U;
}
...
static void ext_mode_exec_c10_controller_template_rectangle
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance)
{
  c10_update_debugger_state_c10_controller_template_rectangle(chartInstance);
}
  ...
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c10_e_hoistedGlobal = *c10_is_active_c10_controller_template_rectangle;
   ...
   mxArray *c10_st)
{
  ...
  *c10_roll_rot = c10_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c10_u, 3)), "roll_rot");
  *c10_is_active_c10_controller_template_rectangle = c10_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 4)),
     "is_active_c10_controller_template_rectangle");
  ...
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c10_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 9U, *c10_sfEvent);
  ...
  *c10_sfEvent = CALL_EVENT;
  c10_chartstep_c10_controller_template_rectangle(chartInstance);
  ...
  (SFc10_controller_template_rectangleInstanceStruct *chartInstance)
{
  ...
  c10_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 9U, *c10_sfEvent);
  ...
  *c10_b_roll_bias_rot = c10_roll_bias_rot;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 9U, *c10_sfEvent);
}
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc10_controller_template_rectangleInstanceStruct *)
    chartInstanceVoid;
   ...
   *c10_identifier)
{
  ...
  c10_y = c10_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_is_active_c10_controller_template_rectangle), &c10_thisId);
  sf_mex_destroy(&c10_is_active_c10_controller_template_rectangle);
  return c10_y;
}
...
void sf_c10_controller_template_rectangle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_controller_template_rectangle_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c10_controller_template_rectangle
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[15],T\"pitch_bias_rot\",},{M[1],M[11],T\"pitch_rot\",},{M[1],M[14],T\"roll_bias_rot\",},{M[1],M[10],T\"roll_rot\",},{M[8],M[0],T\"is_active_c10_controller_template_rectangle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_controller_template_rectangle_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c10_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc10_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc10_controller_template_rectangleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_controller_template_rectangle
    ((SFc10_controller_template_rectangleInstanceStruct*) chartInstanceVar);
  initialize_c10_controller_template_rectangle
    ((SFc10_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_controller_template_rectangle(void
  *chartInstanceVar)
{
  enable_c10_controller_template_rectangle
    ((SFc10_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_controller_template_rectangle(void
  *chartInstanceVar)
{
  disable_c10_controller_template_rectangle
    ((SFc10_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_controller_template_rectangle(void
  *chartInstanceVar)
{
  sf_c10_controller_template_rectangle
    ((SFc10_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c10_controller_template_rectangle(void
  *chartInstanceVar)
{
  ext_mode_exec_c10_controller_template_rectangle
    ((SFc10_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c10_controller_template_rectangle(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_controller_template_rectangle
    ((SFc10_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_controller_template_rectangle();/* state var info */
...
extern void sf_internal_set_sim_state_c10_controller_template_rectangle
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c10_controller_template_rectangle
    ((SFc10_controller_template_rectangleInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_controller_template_rectangle
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c10_controller_template_rectangle(S);
}

static void sf_opaque_set_sim_state_c10_controller_template_rectangle(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c10_controller_template_rectangle(S, st);
}

static void sf_opaque_terminate_c10_controller_template_rectangle(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_controller_template_rectangleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c10_controller_template_rectangle
      ((SFc10_controller_template_rectangleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_controller_template_rectangle
    ((SFc10_controller_template_rectangleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_controller_template_rectangle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c10_controller_template_rectangle
      ((SFc10_controller_template_rectangleInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c10_controller_template_rectangle_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c10_controller_template_rectangle\",T\"is_active_c10_controller_template_rectangle\"}}"
  };
...
static void mdlSetWorkWidths_c10_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_rectangle_optimization_info();
...
static void mdlRTW_c10_controller_template_rectangle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_controller_template_rectangle(SimStruct *S)
{
  SFc10_controller_template_rectangleInstanceStruct *chartInstance;
  chartInstance = (SFc10_controller_template_rectangleInstanceStruct *)malloc
    (sizeof(SFc10_controller_template_rectangleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_controller_template_rectangle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_controller_template_rectangle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_controller_template_rectangle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c10_controller_template_rectangle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c10_controller_template_rectangle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_controller_template_rectangle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_controller_template_rectangle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_controller_template_rectangle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_controller_template_rectangle;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_controller_template_rectangle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c10_controller_template_rectangle;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c10_controller_template_rectangle;
...
void c10_controller_template_rectangle_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_controller_template_rectangle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_controller_template_rectangle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_controller_template_rectangle_method_dispatcher.\n"
