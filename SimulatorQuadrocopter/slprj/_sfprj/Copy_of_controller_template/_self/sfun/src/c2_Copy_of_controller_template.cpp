...
static void initialize_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance);
static void initialize_params_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance);
static void enable_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance);
static void disable_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance);
static void ext_mode_exec_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance);
static void set_sim_state_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance, const mxArray *
   c2_st);
static void finalize_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance);
static void sf_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance);
static void c2_chartstep_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance);
static void initSimStructsc2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_Copy_of_controller_templateInstanceStruct
...
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_Copy_of_controller_templateInstanceStruct
...
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_Copy_of_controller_templateInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[100]);
...
static const mxArray *c2_i_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_Copy_of_controller_templateInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[400]);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[18]);
static void c2_round(SFc2_Copy_of_controller_templateInstanceStruct
                     *chartInstance, real_T c2_x[4], real_T c2_b_x[4]);
static void c2_mrdivide(SFc2_Copy_of_controller_templateInstanceStruct
  *chartInstance, real_T c2_A[4], real_T c2_B, real_T c2_y[4]);
static void c2_eml_scalar_eg(SFc2_Copy_of_controller_templateInstanceStruct
  *chartInstance);
...
static uint8_T c2_g_emlrt_marshallIn
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance, const mxArray *
   c2_is_active_c2_Copy_of_controller_template, const char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance, const mxArray *
   c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_round(SFc2_Copy_of_controller_templateInstanceStruct
  *chartInstance, real_T c2_x[4]);
static void init_dsm_address_info(SFc2_Copy_of_controller_templateInstanceStruct
  *chartInstance);
...
{
  int32_T *c2_sfEvent;
  uint8_T *c2_is_active_c2_Copy_of_controller_template;
  c2_is_active_c2_Copy_of_controller_template = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c2_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c2_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c2_is_active_c2_Copy_of_controller_template = 0U;
}
...
static void ext_mode_exec_c2_Copy_of_controller_template
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance)
{
  c2_update_debugger_state_c2_Copy_of_controller_template(chartInstance);
}
  ...
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = *c2_is_active_c2_Copy_of_controller_template;
   ...
   c2_st)
{
  ...
  *c2_flag_oob = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 1)), "flag_oob");
  *c2_is_active_c2_Copy_of_controller_template = c2_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_Copy_of_controller_template");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_Copy_of_controller_template(chartInstance);
  ...
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance)
{
  ...
  real_T (*c2_X)[4];
  c2_flag_oob = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c2_Nc = (real_T (*)[141])ssGetInputPortSignal(chartInstance->S, 5);
  c2_Gi = (real_T (*)[141])ssGetInputPortSignal(chartInstance->S, 4);
  c2_Fi = (real_T (*)[564])ssGetInputPortSignal(chartInstance->S, 3);
  c2_Kn = (real_T (*)[1186])ssGetInputPortSignal(chartInstance->S, 2);
  c2_Hn = (real_T (*)[4744])ssGetInputPortSignal(chartInstance->S, 1);
  c2_U = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  (SFc2_Copy_of_controller_templateInstanceStruct *chartInstance)
{
  ...
  c2_b_Nc = (real_T (*)[141])ssGetInputPortSignal(chartInstance->S, 5);
  c2_b_Gi = (real_T (*)[141])ssGetInputPortSignal(chartInstance->S, 4);
  c2_b_Fi = (real_T (*)[564])ssGetInputPortSignal(chartInstance->S, 3);
  c2_b_Kn = (real_T (*)[1186])ssGetInputPortSignal(chartInstance->S, 2);
  c2_b_Hn = (real_T (*)[4744])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c2_i7 = 0; c2_i7 < 4744; c2_i7++) {
    c2_Hn[c2_i7] = (*c2_b_Hn)[c2_i7];
  }

  for (c2_i8 = 0; c2_i8 < 1186; c2_i8++) {
    c2_Kn[c2_i8] = (*c2_b_Kn)[c2_i8];
  }

  for (c2_i9 = 0; c2_i9 < 564; c2_i9++) {
    c2_Fi[c2_i9] = (*c2_b_Fi)[c2_i9];
  }

  for (c2_i10 = 0; c2_i10 < 141; c2_i10++) {
    c2_Gi[c2_i10] = (*c2_b_Gi)[c2_i10];
  }

  for (c2_i11 = 0; c2_i11 < 141; c2_i11++) {
  ...
  do {
    ...
    if (c2_ireg < 141) {
      ...
      c2_d0 = c2_Nc[_SFD_EML_ARRAY_BOUNDS_CHECK("Nc", (int32_T)
        _SFD_INTEGER_CHECK("ireg", c2_b_ireg), 1, 141, 1, 0) - 1];
        ...
        while (c2_j < 4) {
          ...
          c2_Hi[(_SFD_EML_ARRAY_BOUNDS_CHECK("Hi", (int32_T)_SFD_INTEGER_CHECK(
            ...
            [(_SFD_EML_ARRAY_BOUNDS_CHECK("Hn", (int32_T)_SFD_INTEGER_CHECK(
                "abspos + i - 1", (c2_abspos + c2_b_i) - 1.0), 1, 1186, 1, 0) +
              1186 * (_SFD_EML_ARRAY_BOUNDS_CHECK("Hn", (int32_T)
      ...
      c2_c_ireg = _SFD_EML_ARRAY_BOUNDS_CHECK("Fi", (int32_T)_SFD_INTEGER_CHECK(
        "ireg", c2_b_ireg), 1, 141, 1, 0) - 1;
      for (c2_i20 = 0; c2_i20 < 4; c2_i20++) {
        c2_F[c2_i20] = c2_Fi[c2_c_ireg + 141 * c2_i20];
      }
      ...
      c2_b_minreg = _SFD_EML_ARRAY_BOUNDS_CHECK("Fi", (int32_T)
        _SFD_INTEGER_CHECK("minreg", c2_minreg), 1, 141, 1, 0) - 1;
      for (c2_i26 = 0; c2_i26 < 4; c2_i26++) {
        c2_F[c2_i26] = c2_Fi[c2_b_minreg + 141 * c2_i26];
      }

      _SFD_EML_CALL(0U, *c2_sfEvent, 59);
      c2_G = c2_Gi[_SFD_EML_ARRAY_BOUNDS_CHECK("Gi", (int32_T)_SFD_INTEGER_CHECK
        ("minreg", c2_minreg), 1, 141, 1, 0) - 1];
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_Copy_of_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc2_Copy_of_controller_templateInstanceStruct *)
    chartInstanceVoid;
  ...
  *c2_inData)
{
  ...
  chartInstance = (SFc2_Copy_of_controller_templateInstanceStruct *)
    chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i29 = 0; c2_i29 < 141; c2_i29++) {
    c2_b_inData[c2_i29] = (*(real_T (*)[141])c2_inData)[c2_i29];
  }

  for (c2_i30 = 0; c2_i30 < 141; c2_i30++) {
    c2_u[c2_i30] = c2_b_inData[c2_i30];
  }

  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 1, 141), FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
  ...
  *c2_inData)
{
  ...
  for (c2_i32 = 0; c2_i32 < 4; c2_i32++) {
    for (c2_i33 = 0; c2_i33 < 141; c2_i33++) {
      c2_b_inData[c2_i33 + c2_i31] = (*(real_T (*)[564])c2_inData)[c2_i33 +
        c2_i31];
    }
  ...
  for (c2_i35 = 0; c2_i35 < 4; c2_i35++) {
    for (c2_i36 = 0; c2_i36 < 141; c2_i36++) {
  ...
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 2, 141, 4), FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
  ...
  *c2_inData)
{
  ...
  chartInstance = (SFc2_Copy_of_controller_templateInstanceStruct *)
    chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i37 = 0; c2_i37 < 1186; c2_i37++) {
    c2_b_inData[c2_i37] = (*(real_T (*)[1186])c2_inData)[c2_i37];
  }

  for (c2_i38 = 0; c2_i38 < 1186; c2_i38++) {
    c2_u[c2_i38] = c2_b_inData[c2_i38];
  }

  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 1, 1186), FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
  ...
  *c2_inData)
{
  ...
  for (c2_i40 = 0; c2_i40 < 4; c2_i40++) {
    for (c2_i41 = 0; c2_i41 < 1186; c2_i41++) {
      c2_b_inData[c2_i41 + c2_i39] = (*(real_T (*)[4744])c2_inData)[c2_i41 +
        c2_i39];
    }
  ...
  for (c2_i43 = 0; c2_i43 < 4; c2_i43++) {
    for (c2_i44 = 0; c2_i44 < 1186; c2_i44++) {
  ...
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 2, 1186, 4),
                FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
...
const mxArray *sf_c2_Copy_of_controller_template_get_eml_resolved_functions_info
  (void)
{
   ...
   c2_is_active_c2_Copy_of_controller_template, const char_T *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_is_active_c2_Copy_of_controller_template), &c2_thisId);
  sf_mex_destroy(&c2_is_active_c2_Copy_of_controller_template);
  return c2_y;
}
...
void sf_c2_Copy_of_controller_template_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(135235491U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(691539246U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(887401826U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(929737532U);
}

mxArray *sf_c2_Copy_of_controller_template_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("qI4P3iLE8e7I3QzRPdy5fE");
...
static const mxArray *sf_get_sim_state_info_c2_Copy_of_controller_template(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"U\",},{M[1],M[16],T\"flag_oob\",},{M[8],M[0],T\"is_active_c2_Copy_of_controller_template\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Copy_of_controller_template_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_Copy_of_controller_template(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc2_Copy_of_controller_templateInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc2_Copy_of_controller_templateInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_Copy_of_controller_template
    ((SFc2_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
  initialize_c2_Copy_of_controller_template
    ((SFc2_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_Copy_of_controller_template(void
  *chartInstanceVar)
{
  enable_c2_Copy_of_controller_template
    ((SFc2_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_Copy_of_controller_template(void
  *chartInstanceVar)
{
  disable_c2_Copy_of_controller_template
    ((SFc2_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_Copy_of_controller_template(void
  *chartInstanceVar)
{
  sf_c2_Copy_of_controller_template
    ((SFc2_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c2_Copy_of_controller_template(void
  *chartInstanceVar)
{
  ext_mode_exec_c2_Copy_of_controller_template
    ((SFc2_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_Copy_of_controller_template
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_Copy_of_controller_template
    ((SFc2_Copy_of_controller_templateInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_Copy_of_controller_template();/* state var info */
...
extern void sf_internal_set_sim_state_c2_Copy_of_controller_template(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_Copy_of_controller_template
    ((SFc2_Copy_of_controller_templateInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_Copy_of_controller_template
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_Copy_of_controller_template(S);
}

static void sf_opaque_set_sim_state_c2_Copy_of_controller_template(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_Copy_of_controller_template(S, st);
}

static void sf_opaque_terminate_c2_Copy_of_controller_template(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Copy_of_controller_templateInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_Copy_of_controller_template
      ((SFc2_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_Copy_of_controller_template
    ((SFc2_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Copy_of_controller_template(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_Copy_of_controller_template
      ((SFc2_Copy_of_controller_templateInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c2_Copy_of_controller_template_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c2_Copy_of_controller_template\",T\"is_active_c2_Copy_of_controller_template\"}}"
  };
...
static void mdlSetWorkWidths_c2_Copy_of_controller_template(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Copy_of_controller_template_optimization_info();
  ...
  ssSetChecksum0(S,(2246772517U));
  ssSetChecksum1(S,(2553797257U));
  ssSetChecksum2(S,(859923555U));
  ssSetChecksum3(S,(3618383011U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_Copy_of_controller_template(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Copy_of_controller_template(SimStruct *S)
{
  SFc2_Copy_of_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc2_Copy_of_controller_templateInstanceStruct *)malloc
    (sizeof(SFc2_Copy_of_controller_templateInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_Copy_of_controller_templateInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Copy_of_controller_template;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Copy_of_controller_template;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Copy_of_controller_template;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_Copy_of_controller_template;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_Copy_of_controller_template;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Copy_of_controller_template;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Copy_of_controller_template;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Copy_of_controller_template;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Copy_of_controller_template;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Copy_of_controller_template;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Copy_of_controller_template;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c2_Copy_of_controller_template;
...
void c2_Copy_of_controller_template_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Copy_of_controller_template(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Copy_of_controller_template(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Copy_of_controller_template(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Copy_of_controller_template_method_dispatcher.\n"
