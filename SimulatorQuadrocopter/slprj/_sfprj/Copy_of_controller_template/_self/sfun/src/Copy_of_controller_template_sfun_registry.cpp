...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Copy_of_controller_template_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Hquad_control_LIB_MPC_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Copy_of_controller_template_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_Copy_of_controller_template_process_testpoint_info_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Hquad_control_LIB_MPC_process_testpoint_info_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Copy_of_controller_template_process_testpoint_info_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Copy_of_controller_template_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "Copy_of_controller_template") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Copy_of_controller_template_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_Copy_of_controller_template_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "Copy_of_controller_template") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Copy_of_controller_template_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_Copy_of_controller_template_method_dispatcher(SimStruct
  ...
  char* specsCksum, int_T method, void *data)
{
  if (!strcmp(machineName,"Copy_of_controller_template")) {
    return(sf_Copy_of_controller_template_method_dispatcher(simstructPtr,
...
extern void Copy_of_controller_template_terminator(void);
...
extern "C" void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    Copy_of_controller_template_terminator();
...
extern void Copy_of_controller_template_initializer(void);
extern void Hquad_control_LIB_MPC_initializer(void);
extern void Copy_of_controller_template_register_exported_symbols(SimStruct* S);
extern void Hquad_control_LIB_MPC_register_exported_symbols(SimStruct* S);
extern void Copy_of_controller_template_debug_initialize(void);
extern void Hquad_control_LIB_MPC_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Copy_of_controller_template_register_exported_symbols(S);
...
extern "C" void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      Copy_of_controller_template_debug_initialize();
    }

    Copy_of_controller_template_initializer();
    if (!simModeIsRTWGen) {
