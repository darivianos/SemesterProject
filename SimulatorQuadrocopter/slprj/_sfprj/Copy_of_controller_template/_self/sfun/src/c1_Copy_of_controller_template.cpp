...
static void initialize_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance);
static void initialize_params_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance);
static void enable_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance);
static void disable_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance);
static void ext_mode_exec_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance);
static void set_sim_state_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance, const mxArray *
   c1_st);
static void finalize_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance);
static void sf_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance);
static void c1_chartstep_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance);
static void initSimStructsc1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_Copy_of_controller_templateInstanceStruct
...
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_Copy_of_controller_templateInstanceStruct
...
static const mxArray *c1_h_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_Copy_of_controller_templateInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[100]);
...
static const mxArray *c1_i_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_Copy_of_controller_templateInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[400]);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[18]);
static void c1_round(SFc1_Copy_of_controller_templateInstanceStruct
                     *chartInstance, real_T c1_x[4], real_T c1_b_x[4]);
static void c1_mrdivide(SFc1_Copy_of_controller_templateInstanceStruct
  *chartInstance, real_T c1_A[4], real_T c1_B, real_T c1_y[4]);
static void c1_eml_scalar_eg(SFc1_Copy_of_controller_templateInstanceStruct
  *chartInstance);
...
static uint8_T c1_g_emlrt_marshallIn
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance, const mxArray *
   c1_is_active_c1_Copy_of_controller_template, const char_T *c1_identifier);
static uint8_T c1_h_emlrt_marshallIn
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance, const mxArray *
   c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_round(SFc1_Copy_of_controller_templateInstanceStruct
  *chartInstance, real_T c1_x[4]);
static void init_dsm_address_info(SFc1_Copy_of_controller_templateInstanceStruct
  *chartInstance);
...
{
  int32_T *c1_sfEvent;
  uint8_T *c1_is_active_c1_Copy_of_controller_template;
  c1_is_active_c1_Copy_of_controller_template = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c1_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c1_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c1_is_active_c1_Copy_of_controller_template = 0U;
}
...
static void ext_mode_exec_c1_Copy_of_controller_template
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance)
{
  c1_update_debugger_state_c1_Copy_of_controller_template(chartInstance);
}
  ...
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance)
{
  ...
  c1_c_hoistedGlobal = *c1_is_active_c1_Copy_of_controller_template;
   ...
   c1_st)
{
  ...
  *c1_flag_oob = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 1)), "flag_oob");
  *c1_is_active_c1_Copy_of_controller_template = c1_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_Copy_of_controller_template");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_Copy_of_controller_template(chartInstance);
  ...
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance)
{
  ...
  real_T (*c1_X)[4];
  c1_flag_oob = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_Nc = (real_T (*)[141])ssGetInputPortSignal(chartInstance->S, 5);
  c1_Gi = (real_T (*)[141])ssGetInputPortSignal(chartInstance->S, 4);
  c1_Fi = (real_T (*)[564])ssGetInputPortSignal(chartInstance->S, 3);
  c1_Kn = (real_T (*)[1183])ssGetInputPortSignal(chartInstance->S, 2);
  c1_Hn = (real_T (*)[4732])ssGetInputPortSignal(chartInstance->S, 1);
  c1_U = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  (SFc1_Copy_of_controller_templateInstanceStruct *chartInstance)
{
  ...
  c1_b_Nc = (real_T (*)[141])ssGetInputPortSignal(chartInstance->S, 5);
  c1_b_Gi = (real_T (*)[141])ssGetInputPortSignal(chartInstance->S, 4);
  c1_b_Fi = (real_T (*)[564])ssGetInputPortSignal(chartInstance->S, 3);
  c1_b_Kn = (real_T (*)[1183])ssGetInputPortSignal(chartInstance->S, 2);
  c1_b_Hn = (real_T (*)[4732])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c1_i7 = 0; c1_i7 < 4732; c1_i7++) {
    c1_Hn[c1_i7] = (*c1_b_Hn)[c1_i7];
  }

  for (c1_i8 = 0; c1_i8 < 1183; c1_i8++) {
    c1_Kn[c1_i8] = (*c1_b_Kn)[c1_i8];
  }

  for (c1_i9 = 0; c1_i9 < 564; c1_i9++) {
    c1_Fi[c1_i9] = (*c1_b_Fi)[c1_i9];
  }

  for (c1_i10 = 0; c1_i10 < 141; c1_i10++) {
    c1_Gi[c1_i10] = (*c1_b_Gi)[c1_i10];
  }

  for (c1_i11 = 0; c1_i11 < 141; c1_i11++) {
  ...
  do {
    ...
    if (c1_ireg < 141) {
      ...
      c1_d0 = c1_Nc[_SFD_EML_ARRAY_BOUNDS_CHECK("Nc", (int32_T)
        _SFD_INTEGER_CHECK("ireg", c1_b_ireg), 1, 141, 1, 0) - 1];
        ...
        while (c1_j < 4) {
          ...
          c1_Hi[(_SFD_EML_ARRAY_BOUNDS_CHECK("Hi", (int32_T)_SFD_INTEGER_CHECK(
            ...
            [(_SFD_EML_ARRAY_BOUNDS_CHECK("Hn", (int32_T)_SFD_INTEGER_CHECK(
                "abspos + i - 1", (c1_abspos + c1_b_i) - 1.0), 1, 1183, 1, 0) +
              1183 * (_SFD_EML_ARRAY_BOUNDS_CHECK("Hn", (int32_T)
      ...
      c1_c_ireg = _SFD_EML_ARRAY_BOUNDS_CHECK("Fi", (int32_T)_SFD_INTEGER_CHECK(
        "ireg", c1_b_ireg), 1, 141, 1, 0) - 1;
      for (c1_i20 = 0; c1_i20 < 4; c1_i20++) {
        c1_F[c1_i20] = c1_Fi[c1_c_ireg + 141 * c1_i20];
      }
      ...
      c1_b_minreg = _SFD_EML_ARRAY_BOUNDS_CHECK("Fi", (int32_T)
        _SFD_INTEGER_CHECK("minreg", c1_minreg), 1, 141, 1, 0) - 1;
      for (c1_i26 = 0; c1_i26 < 4; c1_i26++) {
        c1_F[c1_i26] = c1_Fi[c1_b_minreg + 141 * c1_i26];
      }

      _SFD_EML_CALL(0U, *c1_sfEvent, 59);
      c1_G = c1_Gi[_SFD_EML_ARRAY_BOUNDS_CHECK("Gi", (int32_T)_SFD_INTEGER_CHECK
        ("minreg", c1_minreg), 1, 141, 1, 0) - 1];
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Copy_of_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc1_Copy_of_controller_templateInstanceStruct *)
    chartInstanceVoid;
  ...
  *c1_inData)
{
  ...
  chartInstance = (SFc1_Copy_of_controller_templateInstanceStruct *)
    chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  for (c1_i29 = 0; c1_i29 < 141; c1_i29++) {
    c1_b_inData[c1_i29] = (*(real_T (*)[141])c1_inData)[c1_i29];
  }

  for (c1_i30 = 0; c1_i30 < 141; c1_i30++) {
  ...
  *c1_inData)
{
  ...
  for (c1_i32 = 0; c1_i32 < 4; c1_i32++) {
    for (c1_i33 = 0; c1_i33 < 141; c1_i33++) {
      c1_b_inData[c1_i33 + c1_i31] = (*(real_T (*)[564])c1_inData)[c1_i33 +
        c1_i31];
    }
  ...
  for (c1_i35 = 0; c1_i35 < 4; c1_i35++) {
    for (c1_i36 = 0; c1_i36 < 141; c1_i36++) {
  ...
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 2, 141, 4), FALSE);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, FALSE);
  return c1_mxArrayOutData;
}
  ...
  *c1_inData)
{
  ...
  chartInstance = (SFc1_Copy_of_controller_templateInstanceStruct *)
    chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  for (c1_i37 = 0; c1_i37 < 1183; c1_i37++) {
    c1_b_inData[c1_i37] = (*(real_T (*)[1183])c1_inData)[c1_i37];
  }

  for (c1_i38 = 0; c1_i38 < 1183; c1_i38++) {
    c1_u[c1_i38] = c1_b_inData[c1_i38];
  }

  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 1, 1183), FALSE);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, FALSE);
  return c1_mxArrayOutData;
}
  ...
  *c1_inData)
{
  ...
  for (c1_i40 = 0; c1_i40 < 4; c1_i40++) {
    for (c1_i41 = 0; c1_i41 < 1183; c1_i41++) {
      c1_b_inData[c1_i41 + c1_i39] = (*(real_T (*)[4732])c1_inData)[c1_i41 +
        c1_i39];
    }
  ...
  for (c1_i43 = 0; c1_i43 < 4; c1_i43++) {
    for (c1_i44 = 0; c1_i44 < 1183; c1_i44++) {
  ...
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 2, 1183, 4),
                FALSE);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, FALSE);
  return c1_mxArrayOutData;
}
...
const mxArray *sf_c1_Copy_of_controller_template_get_eml_resolved_functions_info
  (void)
{
   ...
   c1_is_active_c1_Copy_of_controller_template, const char_T *c1_identifier)
{
  ...
  c1_y = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_is_active_c1_Copy_of_controller_template), &c1_thisId);
  sf_mex_destroy(&c1_is_active_c1_Copy_of_controller_template);
  return c1_y;
}
...
void sf_c1_Copy_of_controller_template_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(523746649U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(954541146U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2605405442U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3567704146U);
}

mxArray *sf_c1_Copy_of_controller_template_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("LGZ4iMGM5zWQjS1DCBXhSE");
...
static const mxArray *sf_get_sim_state_info_c1_Copy_of_controller_template(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"U\",},{M[1],M[16],T\"flag_oob\",},{M[8],M[0],T\"is_active_c1_Copy_of_controller_template\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Copy_of_controller_template_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_Copy_of_controller_template(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc1_Copy_of_controller_templateInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc1_Copy_of_controller_templateInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Copy_of_controller_template
    ((SFc1_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
  initialize_c1_Copy_of_controller_template
    ((SFc1_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_Copy_of_controller_template(void
  *chartInstanceVar)
{
  enable_c1_Copy_of_controller_template
    ((SFc1_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Copy_of_controller_template(void
  *chartInstanceVar)
{
  disable_c1_Copy_of_controller_template
    ((SFc1_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_Copy_of_controller_template(void
  *chartInstanceVar)
{
  sf_c1_Copy_of_controller_template
    ((SFc1_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c1_Copy_of_controller_template(void
  *chartInstanceVar)
{
  ext_mode_exec_c1_Copy_of_controller_template
    ((SFc1_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Copy_of_controller_template
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Copy_of_controller_template
    ((SFc1_Copy_of_controller_templateInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Copy_of_controller_template();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Copy_of_controller_template(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_Copy_of_controller_template
    ((SFc1_Copy_of_controller_templateInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Copy_of_controller_template
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Copy_of_controller_template(S);
}

static void sf_opaque_set_sim_state_c1_Copy_of_controller_template(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_Copy_of_controller_template(S, st);
}

static void sf_opaque_terminate_c1_Copy_of_controller_template(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Copy_of_controller_templateInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_Copy_of_controller_template
      ((SFc1_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_Copy_of_controller_template
    ((SFc1_Copy_of_controller_templateInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Copy_of_controller_template(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_Copy_of_controller_template
      ((SFc1_Copy_of_controller_templateInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c1_Copy_of_controller_template_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c1_Copy_of_controller_template\",T\"is_active_c1_Copy_of_controller_template\"}}"
  };
...
static void mdlSetWorkWidths_c1_Copy_of_controller_template(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Copy_of_controller_template_optimization_info();
  ...
  ssSetChecksum0(S,(40566456U));
  ssSetChecksum1(S,(698160771U));
  ssSetChecksum2(S,(1361384752U));
  ssSetChecksum3(S,(1733333402U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_Copy_of_controller_template(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Copy_of_controller_template(SimStruct *S)
{
  SFc1_Copy_of_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc1_Copy_of_controller_templateInstanceStruct *)malloc
    (sizeof(SFc1_Copy_of_controller_templateInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Copy_of_controller_templateInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Copy_of_controller_template;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Copy_of_controller_template;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Copy_of_controller_template;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_Copy_of_controller_template;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_Copy_of_controller_template;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Copy_of_controller_template;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Copy_of_controller_template;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Copy_of_controller_template;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Copy_of_controller_template;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Copy_of_controller_template;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Copy_of_controller_template;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c1_Copy_of_controller_template;
...
void c1_Copy_of_controller_template_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Copy_of_controller_template(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Copy_of_controller_template(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Copy_of_controller_template(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Copy_of_controller_template_method_dispatcher.\n"
