...
static void c5_update_debugger_state_c5_Hquad_control_LIB_MPC
  (SFc5_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
static void ext_mode_exec_c5_Hquad_control_LIB_MPC
  (SFc5_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
...
static uint8_T c5_j_emlrt_marshallIn(SFc5_Hquad_control_LIB_MPCInstanceStruct
  *chartInstance, const mxArray *c5_is_active_c5_Hquad_control_LIB_MPC, const
  ...
  (SFc5_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c5_is_active_c5_Hquad_control_LIB_MPC = (uint8_T *)ssGetDWork(chartInstance->S,
    3);
  c5_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c5_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c5_is_active_c5_Hquad_control_LIB_MPC = 0U;
}
  ...
  (SFc5_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal = *c5_is_active_c5_Hquad_control_LIB_MPC;
  ...
  (SFc5_Hquad_control_LIB_MPCInstanceStruct *chartInstance, const mxArray *c5_st)
{
  ...
  *c5_is_active_c5_Hquad_control_LIB_MPC = c5_j_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 2)), "is_active_c5_Hquad_control_LIB_MPC");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_Hquad_control_LIB_MPC(chartInstance);
  ...
  *chartInstance)
{
  ...
  c5_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, *c5_sfEvent);
  ...
  (SFc5_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c5_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, *c5_sfEvent);
  ...
  _SFD_EML_CALL(0U, *c5_sfEvent, 11);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, *c5_sfEvent);
}
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_y = c5_i_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_sfEvent), &c5_thisId);
  ...
  char_T *c5_identifier)
{
  ...
  c5_y = c5_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_is_active_c5_Hquad_control_LIB_MPC), &c5_thisId);
  sf_mex_destroy(&c5_is_active_c5_Hquad_control_LIB_MPC);
  return c5_y;
}
...
{
  sf_check_dwork_consistency(((SFc5_Hquad_control_LIB_MPCInstanceStruct*)
    chartInstanceVar)->S);
...
static void sf_opaque_ext_mode_exec_c5_Hquad_control_LIB_MPC(void
  *chartInstanceVar)
{
  ext_mode_exec_c5_Hquad_control_LIB_MPC
    ((SFc5_Hquad_control_LIB_MPCInstanceStruct*) chartInstanceVar);
}
...
mxArray *sf_c5_Hquad_control_LIB_MPC_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c5_Hquad_control_LIB_MPC\",T\"is_active_c5_Hquad_control_LIB_MPC\"}}"
  };
...
static void mdlStart_c5_Hquad_control_LIB_MPC(SimStruct *S)
{
  ...
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c5_Hquad_control_LIB_MPC;
