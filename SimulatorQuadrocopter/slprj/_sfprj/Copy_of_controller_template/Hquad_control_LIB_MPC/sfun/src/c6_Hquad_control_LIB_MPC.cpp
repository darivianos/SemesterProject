  ...
  *chartInstance)
{
  ...
  c6_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, *c6_sfEvent);
  ...
  (SFc6_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c6_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, *c6_sfEvent);
  ...
  *c6_c_J_star = c6_J_star;
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, *c6_sfEvent);
}
...
static void c6_info_helper(c6_ResolvedFunctionInfo c6_info[24])
{
  ...
  c6_info[13].fileTimeLo = 1367485014U;
