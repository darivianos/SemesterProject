...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Simulator_Template_FreeFlight_process_check_sum_call
  ...
  extern unsigned int sf_Hquad_control_LIB_MPC_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Simulator_Template_FreeFlight_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
...
{
  extern unsigned int sf_Simulator_Template_FreeFlight_autoinheritance_info( int
  ...
  if (strcmp(machineName, "Simulator_Template_FreeFlight") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Simulator_Template_FreeFlight_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_Simulator_Template_FreeFlight_third_party_uses_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "Simulator_Template_FreeFlight") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Simulator_Template_FreeFlight_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_Simulator_Template_FreeFlight_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "Simulator_Template_FreeFlight") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Simulator_Template_FreeFlight_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_Simulator_Template_FreeFlight_method_dispatcher(SimStruct
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Simulator_Template_FreeFlight")) {
    return(sf_Simulator_Template_FreeFlight_method_dispatcher(simstructPtr,
...
extern void Simulator_Template_FreeFlight_terminator(void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    Simulator_Template_FreeFlight_terminator();
...
extern void Simulator_Template_FreeFlight_initializer(void);
extern void Hqaud_model_LIB_SI_initializer(void);
extern void Hquad_control_LIB_MPC_initializer(void);
extern void Simulator_Template_FreeFlight_register_exported_symbols(SimStruct* S);
...
extern void Simulator_Template_FreeFlight_debug_initialize(struct
...
{
  Simulator_Template_FreeFlight_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Simulator_Template_FreeFlight_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    Simulator_Template_FreeFlight_initializer();
    if (!simModeIsRTWGen) {
