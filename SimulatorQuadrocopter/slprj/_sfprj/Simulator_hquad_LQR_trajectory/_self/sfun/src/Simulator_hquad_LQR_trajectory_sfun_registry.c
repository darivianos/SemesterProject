...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Simulator_hquad_LQR_trajectory_process_check_sum_call
  ...
  extern unsigned int sf_Hquad_control_LIB_MPC_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Hquad_control_LIB_LQR_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Simulator_hquad_LQR_trajectory_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  ...
  if (sf_Hquad_control_LIB_MPC_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_Hquad_control_LIB_LQR_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_Simulator_hquad_LQR_trajectory_autoinheritance_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  extern unsigned int sf_Hquad_control_LIB_MPC_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Hquad_control_LIB_LQR_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Simulator_hquad_LQR_trajectory") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Simulator_hquad_LQR_trajectory_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
  ...
  if (strcmp(machineName, "Hquad_control_LIB_LQR") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Hquad_control_LIB_LQR_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Simulator_hquad_LQR_trajectory_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  extern unsigned int sf_Hquad_control_LIB_MPC_get_eml_resolved_functions_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Hquad_control_LIB_LQR_get_eml_resolved_functions_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "Simulator_hquad_LQR_trajectory") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Simulator_hquad_LQR_trajectory_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
  ...
  if (strcmp(machineName, "Hquad_control_LIB_LQR") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Hquad_control_LIB_LQR_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_Simulator_hquad_LQR_trajectory_method_dispatcher
...
extern unsigned int sf_Hquad_control_LIB_MPC_method_dispatcher(SimStruct *S,
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data);
extern unsigned int sf_Hquad_control_LIB_LQR_method_dispatcher(SimStruct *S,
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data);
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Simulator_hquad_LQR_trajectory")) {
    return(sf_Simulator_hquad_LQR_trajectory_method_dispatcher(simstructPtr,
  ...
  if (!strcmp(machineName,"Hquad_control_LIB_LQR")) {
    return(sf_Hquad_control_LIB_LQR_method_dispatcher(simstructPtr,
            chartFileNumber,specsCksum,method,data));
  }
...
extern void Simulator_hquad_LQR_trajectory_terminator(void);
extern void Hqaud_model_LIB_SI_terminator(void);
extern void Hquad_control_LIB_MPC_terminator(void);
extern void Hquad_control_LIB_LQR_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    Simulator_hquad_LQR_trajectory_terminator();
    Hqaud_model_LIB_SI_terminator();
    Hquad_control_LIB_MPC_terminator();
    Hquad_control_LIB_LQR_terminator();
    sf_debug_terminate();
  }
...
extern void Simulator_hquad_LQR_trajectory_initializer(void);
extern void Hqaud_model_LIB_SI_initializer(void);
extern void Hquad_control_LIB_MPC_initializer(void);
extern void Hquad_control_LIB_LQR_initializer(void);
extern void Simulator_hquad_LQR_trajectory_register_exported_symbols(SimStruct*
  S);
...
extern void Hquad_control_LIB_LQR_register_exported_symbols(SimStruct* S);
extern void Simulator_hquad_LQR_trajectory_debug_initialize(void);
extern void Hqaud_model_LIB_SI_debug_initialize(void);
extern void Hquad_control_LIB_MPC_debug_initialize(void);
extern void Hquad_control_LIB_LQR_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Simulator_hquad_LQR_trajectory_register_exported_symbols(S);
  Hqaud_model_LIB_SI_register_exported_symbols(S);
  Hquad_control_LIB_MPC_register_exported_symbols(S);
  Hquad_control_LIB_LQR_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      Simulator_hquad_LQR_trajectory_debug_initialize();
    }

    Simulator_hquad_LQR_trajectory_initializer();
    if (!simModeIsRTWGen) {
      Hqaud_model_LIB_SI_debug_initialize();
    }
    ...
    if (!simModeIsRTWGen) {
      Hquad_control_LIB_LQR_debug_initialize();
    }

    Hquad_control_LIB_LQR_initializer();
  }
