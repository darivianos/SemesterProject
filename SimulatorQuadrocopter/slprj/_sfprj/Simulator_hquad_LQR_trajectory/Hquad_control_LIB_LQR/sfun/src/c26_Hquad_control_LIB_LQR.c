...
static void initialize_c26_Hquad_control_LIB_LQR
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void initialize_params_c26_Hquad_control_LIB_LQR
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void enable_c26_Hquad_control_LIB_LQR
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void disable_c26_Hquad_control_LIB_LQR
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void c26_update_debugger_state_c26_Hquad_control_LIB_LQR
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c26_Hquad_control_LIB_LQR
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void set_sim_state_c26_Hquad_control_LIB_LQR
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance, const mxArray
   *c26_st);
static void finalize_c26_Hquad_control_LIB_LQR
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void sf_c26_Hquad_control_LIB_LQR
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void c26_chartstep_c26_Hquad_control_LIB_LQR
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void initSimStructsc26_Hquad_control_LIB_LQR
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
...
static const mxArray *c26_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static real_T c26_emlrt_marshallIn(SFc26_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c26_roll_bias_rot, const char_T *c26_identifier);
static real_T c26_b_emlrt_marshallIn(SFc26_Hquad_control_LIB_LQRInstanceStruct
...
static const mxArray *c26_b_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static void c26_c_emlrt_marshallIn(SFc26_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId,
  real_T c26_y[2]);
...
static const mxArray *c26_c_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static void c26_d_emlrt_marshallIn(SFc26_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId,
  real_T c26_y[4]);
static void c26_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c26_mxArrayInData, const char_T *c26_varName, void *c26_outData);
static void c26_eml_scalar_eg(SFc26_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance);
static const mxArray *c26_d_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static int32_T c26_e_emlrt_marshallIn(SFc26_Hquad_control_LIB_LQRInstanceStruct *
  chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static void c26_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c26_mxArrayInData, const char_T *c26_varName, void *c26_outData);
static uint8_T c26_f_emlrt_marshallIn(SFc26_Hquad_control_LIB_LQRInstanceStruct *
  chartInstance, const mxArray *c26_b_is_active_c26_Hquad_control_LIB_LQR, const
  char_T *c26_identifier);
static uint8_T c26_g_emlrt_marshallIn(SFc26_Hquad_control_LIB_LQRInstanceStruct *
  chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static void init_dsm_address_info(SFc26_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance);
  ...
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance)
{
  ...
  chartInstance->c26_is_active_c26_Hquad_control_LIB_LQR = 0U;
}
  ...
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance)
{
  ...
  c26_e_hoistedGlobal = chartInstance->c26_is_active_c26_Hquad_control_LIB_LQR;
   ...
   *c26_st)
{
  ...
  *c26_roll_rot = c26_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c26_u, 3)), "roll_rot");
  chartInstance->c26_is_active_c26_Hquad_control_LIB_LQR =
    c26_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c26_u, 4)),
    "is_active_c26_Hquad_control_LIB_LQR");
  sf_mex_destroy(&c26_u);
  c26_update_debugger_state_c26_Hquad_control_LIB_LQR(chartInstance);
  ...
  (SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance)
{
  ...
  chartInstance->c26_sfEvent = CALL_EVENT;
  c26_chartstep_c26_Hquad_control_LIB_LQR(chartInstance);
  ...
  *c26_inData)
{
  ...
  const mxArray *c26_y = NULL;
  SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance;
  chartInstance = (SFc26_Hquad_control_LIB_LQRInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c26_Hquad_control_LIB_LQR_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c26_identifier)
{
  ...
  c26_y = c26_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c26_b_is_active_c26_Hquad_control_LIB_LQR), &c26_thisId);
  sf_mex_destroy(&c26_b_is_active_c26_Hquad_control_LIB_LQR);
  return c26_y;
}
...
/* SFunction Glue Code */
void sf_c26_Hquad_control_LIB_LQR_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c26_Hquad_control_LIB_LQR_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c26_Hquad_control_LIB_LQR(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[20],T\"pitch_bias_rot\",},{M[1],M[8],T\"pitch_rot\",},{M[1],M[21],T\"roll_bias_rot\",},{M[1],M[5],T\"roll_rot\",},{M[8],M[0],T\"is_active_c26_Hquad_control_LIB_LQR\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c26_Hquad_control_LIB_LQR_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance;
    chartInstance = (SFc26_Hquad_control_LIB_LQRInstanceStruct *)
...
static void sf_opaque_initialize_c26_Hquad_control_LIB_LQR(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc26_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c26_Hquad_control_LIB_LQR
    ((SFc26_Hquad_control_LIB_LQRInstanceStruct*) chartInstanceVar);
  initialize_c26_Hquad_control_LIB_LQR
    ((SFc26_Hquad_control_LIB_LQRInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c26_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  enable_c26_Hquad_control_LIB_LQR((SFc26_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c26_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  disable_c26_Hquad_control_LIB_LQR((SFc26_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c26_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  sf_c26_Hquad_control_LIB_LQR((SFc26_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c26_Hquad_control_LIB_LQR
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c26_Hquad_control_LIB_LQR
    ((SFc26_Hquad_control_LIB_LQRInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c26_Hquad_control_LIB_LQR();/* state var info */
...
extern void sf_internal_set_sim_state_c26_Hquad_control_LIB_LQR(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c26_Hquad_control_LIB_LQR
    ((SFc26_Hquad_control_LIB_LQRInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c26_Hquad_control_LIB_LQR
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c26_Hquad_control_LIB_LQR(S);
}

static void sf_opaque_set_sim_state_c26_Hquad_control_LIB_LQR(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c26_Hquad_control_LIB_LQR(S, st);
}

static void sf_opaque_terminate_c26_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc26_Hquad_control_LIB_LQRInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c26_Hquad_control_LIB_LQR
      ((SFc26_Hquad_control_LIB_LQRInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc26_Hquad_control_LIB_LQR
    ((SFc26_Hquad_control_LIB_LQRInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c26_Hquad_control_LIB_LQR(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c26_Hquad_control_LIB_LQR
      ((SFc26_Hquad_control_LIB_LQRInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c26_Hquad_control_LIB_LQR(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c26_Hquad_control_LIB_LQR(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c26_Hquad_control_LIB_LQR(SimStruct *S)
{
  SFc26_Hquad_control_LIB_LQRInstanceStruct *chartInstance;
  chartInstance = (SFc26_Hquad_control_LIB_LQRInstanceStruct *)malloc(sizeof
    (SFc26_Hquad_control_LIB_LQRInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc26_Hquad_control_LIB_LQRInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c26_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c26_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c26_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c26_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c26_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c26_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c26_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c26_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c26_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.mdlStart = mdlStart_c26_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c26_Hquad_control_LIB_LQR;
...
void c26_Hquad_control_LIB_LQR_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c26_Hquad_control_LIB_LQR(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c26_Hquad_control_LIB_LQR(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c26_Hquad_control_LIB_LQR(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c26_Hquad_control_LIB_LQR_method_dispatcher.\n"
