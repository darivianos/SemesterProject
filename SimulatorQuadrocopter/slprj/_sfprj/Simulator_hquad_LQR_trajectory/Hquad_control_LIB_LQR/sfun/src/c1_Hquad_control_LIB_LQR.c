...
static void initialize_c1_Hquad_control_LIB_LQR
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void initialize_params_c1_Hquad_control_LIB_LQR
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void enable_c1_Hquad_control_LIB_LQR
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void disable_c1_Hquad_control_LIB_LQR
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Hquad_control_LIB_LQR
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Hquad_control_LIB_LQR
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void set_sim_state_c1_Hquad_control_LIB_LQR
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_Hquad_control_LIB_LQR
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void sf_c1_Hquad_control_LIB_LQR(SFc1_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance);
static void initSimStructsc1_Hquad_control_LIB_LQR
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c1_thrust_comp, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_Hquad_control_LIB_LQR, const
  char_T *c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance);
  ...
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Hquad_control_LIB_LQR = 0U;
}
  ...
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance)
{
  ...
  c1_d_hoistedGlobal = chartInstance->c1_is_active_c1_Hquad_control_LIB_LQR;
  ...
  (SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_thrust_comp = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 2)), "thrust_comp");
  chartInstance->c1_is_active_c1_Hquad_control_LIB_LQR = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 3)),
     "is_active_c1_Hquad_control_LIB_LQR");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_Hquad_control_LIB_LQR(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance;
  chartInstance = (SFc1_Hquad_control_LIB_LQRInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_Hquad_control_LIB_LQR_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_Hquad_control_LIB_LQR), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Hquad_control_LIB_LQR);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_Hquad_control_LIB_LQR_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Hquad_control_LIB_LQR_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_Hquad_control_LIB_LQR(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[12],T\"pitch_cmd_comp\",},{M[1],M[13],T\"roll_cmd_comp\",},{M[1],M[5],T\"thrust_comp\",},{M[8],M[0],T\"is_active_c1_Hquad_control_LIB_LQR\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Hquad_control_LIB_LQR_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance;
    chartInstance = (SFc1_Hquad_control_LIB_LQRInstanceStruct *)
...
static void sf_opaque_initialize_c1_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Hquad_control_LIB_LQR
    ((SFc1_Hquad_control_LIB_LQRInstanceStruct*) chartInstanceVar);
  initialize_c1_Hquad_control_LIB_LQR((SFc1_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  enable_c1_Hquad_control_LIB_LQR((SFc1_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  disable_c1_Hquad_control_LIB_LQR((SFc1_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  sf_c1_Hquad_control_LIB_LQR((SFc1_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Hquad_control_LIB_LQR
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Hquad_control_LIB_LQR
    ((SFc1_Hquad_control_LIB_LQRInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Hquad_control_LIB_LQR();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Hquad_control_LIB_LQR(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_Hquad_control_LIB_LQR
    ((SFc1_Hquad_control_LIB_LQRInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Hquad_control_LIB_LQR(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c1_Hquad_control_LIB_LQR(S);
}

static void sf_opaque_set_sim_state_c1_Hquad_control_LIB_LQR(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_Hquad_control_LIB_LQR(S, st);
}

static void sf_opaque_terminate_c1_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Hquad_control_LIB_LQRInstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_Hquad_control_LIB_LQR((SFc1_Hquad_control_LIB_LQRInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_Hquad_control_LIB_LQR
    ((SFc1_Hquad_control_LIB_LQRInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Hquad_control_LIB_LQR(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_Hquad_control_LIB_LQR
      ((SFc1_Hquad_control_LIB_LQRInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_Hquad_control_LIB_LQR(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_Hquad_control_LIB_LQR(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Hquad_control_LIB_LQR(SimStruct *S)
{
  SFc1_Hquad_control_LIB_LQRInstanceStruct *chartInstance;
  chartInstance = (SFc1_Hquad_control_LIB_LQRInstanceStruct *)malloc(sizeof
    (SFc1_Hquad_control_LIB_LQRInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Hquad_control_LIB_LQRInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Hquad_control_LIB_LQR;
...
void c1_Hquad_control_LIB_LQR_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Hquad_control_LIB_LQR(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Hquad_control_LIB_LQR(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Hquad_control_LIB_LQR(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Hquad_control_LIB_LQR_method_dispatcher.\n"
