...
static void initialize_c4_Hquad_control_LIB_LQR
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void initialize_params_c4_Hquad_control_LIB_LQR
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void enable_c4_Hquad_control_LIB_LQR
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void disable_c4_Hquad_control_LIB_LQR
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_Hquad_control_LIB_LQR
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_Hquad_control_LIB_LQR
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void set_sim_state_c4_Hquad_control_LIB_LQR
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_Hquad_control_LIB_LQR
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void sf_c4_Hquad_control_LIB_LQR(SFc4_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance);
static void c4_chartstep_c4_Hquad_control_LIB_LQR
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void initSimStructsc4_Hquad_control_LIB_LQR
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c4_roll_bias_rot, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_c_emlrt_marshallIn(SFc4_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[2]);
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_d_emlrt_marshallIn(SFc4_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[4]);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void c4_eml_scalar_eg(SFc4_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_e_emlrt_marshallIn(SFc4_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_f_emlrt_marshallIn(SFc4_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_Hquad_control_LIB_LQR, const
  char_T *c4_identifier);
static uint8_T c4_g_emlrt_marshallIn(SFc4_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_Hquad_control_LIB_LQRInstanceStruct
  *chartInstance);
  ...
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_Hquad_control_LIB_LQR = 0U;
}
  ...
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance)
{
  ...
  c4_e_hoistedGlobal = chartInstance->c4_is_active_c4_Hquad_control_LIB_LQR;
  ...
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_roll_rot = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 3)), "roll_rot");
  chartInstance->c4_is_active_c4_Hquad_control_LIB_LQR = c4_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 4)),
     "is_active_c4_Hquad_control_LIB_LQR");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_Hquad_control_LIB_LQR(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_Hquad_control_LIB_LQR(chartInstance);
  ...
  (SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c4_sin_yaw, 0U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_cos_yaw, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c4_R, 2U, c4_c_sf_marshallOut,
    c4_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c4_temp, 3U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c4_nargout, 5U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c4_yaw, 6U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_pitch_cmd, 7U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_roll_cmd, 8U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_pitch_bias, 9U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_roll_bias, 10U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c4_pitch_rot, 11U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_roll_rot, 12U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_pitch_bias_rot, 13U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_roll_bias_rot, 14U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance;
  chartInstance = (SFc4_Hquad_control_LIB_LQRInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_Hquad_control_LIB_LQR_get_eml_resolved_functions_info(void)
{
  ...
  (*c4_b_info)[9].name = "eml_refblas_xgemm";
  (*c4_b_info)[9].dominantType = "int32";
  (*c4_b_info)[9].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m";
  (*c4_b_info)[9].fileTimeLo = 1299076774U;
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_Hquad_control_LIB_LQR), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_Hquad_control_LIB_LQR);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_Hquad_control_LIB_LQR_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_Hquad_control_LIB_LQR_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_Hquad_control_LIB_LQR(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[15],T\"pitch_bias_rot\",},{M[1],M[11],T\"pitch_rot\",},{M[1],M[14],T\"roll_bias_rot\",},{M[1],M[10],T\"roll_rot\",},{M[8],M[0],T\"is_active_c4_Hquad_control_LIB_LQR\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_Hquad_control_LIB_LQR_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance;
    chartInstance = (SFc4_Hquad_control_LIB_LQRInstanceStruct *)
...
static void sf_opaque_initialize_c4_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_Hquad_control_LIB_LQR
    ((SFc4_Hquad_control_LIB_LQRInstanceStruct*) chartInstanceVar);
  initialize_c4_Hquad_control_LIB_LQR((SFc4_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  enable_c4_Hquad_control_LIB_LQR((SFc4_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  disable_c4_Hquad_control_LIB_LQR((SFc4_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  sf_c4_Hquad_control_LIB_LQR((SFc4_Hquad_control_LIB_LQRInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_Hquad_control_LIB_LQR
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_Hquad_control_LIB_LQR
    ((SFc4_Hquad_control_LIB_LQRInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_Hquad_control_LIB_LQR();/* state var info */
...
extern void sf_internal_set_sim_state_c4_Hquad_control_LIB_LQR(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_Hquad_control_LIB_LQR
    ((SFc4_Hquad_control_LIB_LQRInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_Hquad_control_LIB_LQR(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c4_Hquad_control_LIB_LQR(S);
}

static void sf_opaque_set_sim_state_c4_Hquad_control_LIB_LQR(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_Hquad_control_LIB_LQR(S, st);
}

static void sf_opaque_terminate_c4_Hquad_control_LIB_LQR(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_Hquad_control_LIB_LQRInstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_Hquad_control_LIB_LQR((SFc4_Hquad_control_LIB_LQRInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_Hquad_control_LIB_LQR
    ((SFc4_Hquad_control_LIB_LQRInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_Hquad_control_LIB_LQR(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_Hquad_control_LIB_LQR
      ((SFc4_Hquad_control_LIB_LQRInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_Hquad_control_LIB_LQR(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,infoStruct,4,5);
...
static void mdlRTW_c4_Hquad_control_LIB_LQR(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_Hquad_control_LIB_LQR(SimStruct *S)
{
  SFc4_Hquad_control_LIB_LQRInstanceStruct *chartInstance;
  chartInstance = (SFc4_Hquad_control_LIB_LQRInstanceStruct *)malloc(sizeof
    (SFc4_Hquad_control_LIB_LQRInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_Hquad_control_LIB_LQRInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_Hquad_control_LIB_LQR;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_Hquad_control_LIB_LQR;
...
void c4_Hquad_control_LIB_LQR_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Hquad_control_LIB_LQR(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Hquad_control_LIB_LQR(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Hquad_control_LIB_LQR(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_Hquad_control_LIB_LQR_method_dispatcher.\n"
