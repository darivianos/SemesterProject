  ...
  *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(c2_acc, 0U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_nargout, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c2_pitch, 3U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_roll, 4U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_yaw, 5U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_thrust, 6U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_m, 7U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_g, 8U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c2_ax_I, 9U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_ay_I, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_az_I, 11U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  *c2_b_az_I = c2_az_I;
  ...
  sf_debug_check_for_state_inconsistency(_Hqaud_model_LIB_SIMachineNumber_,
...
const mxArray *sf_c2_Hqaud_model_LIB_SI_get_eml_resolved_functions_info(void)
{
  ...
  (*c2_b_info)[7].fileTimeLo = 1289519692U;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3772475106U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3391656559U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(251977184U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2907826430U);
}
...
mxArray *sf_c2_Hqaud_model_LIB_SI_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("dgacxA0tSRgzjN6nLub7GD");
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_disable_implicit_casting
            (_Hqaud_model_LIB_SIMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_Hqaud_model_LIB_SIMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
...
static void mdlSetWorkWidths_c2_Hqaud_model_LIB_SI(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_reusable_outputs(S,infoStruct,2,3);
    }
  ...
  ssSetChecksum0(S,(1857516711U));
  ssSetChecksum1(S,(1951689059U));
  ssSetChecksum2(S,(3887524212U));
  ssSetChecksum3(S,(4273958532U));
...
{
  SFc2_Hqaud_model_LIB_SIInstanceStruct *chartInstance;
  chartInstance = (SFc2_Hqaud_model_LIB_SIInstanceStruct *)malloc(sizeof
