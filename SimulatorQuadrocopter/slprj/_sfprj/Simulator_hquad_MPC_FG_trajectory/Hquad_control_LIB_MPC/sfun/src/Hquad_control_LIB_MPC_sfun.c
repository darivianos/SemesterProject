  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"Hquad_control_LIB_MPC")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1425031648U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(769325812U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2187267333U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(186571653U);
        } else if (nrhs==4) {
...
mxArray* load_Hquad_control_LIB_MPC_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "Hquad_control_LIB_MPC", "Simulator_hquad_MPC_FG_trajectory");
