  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"Hqaud_model_LIB_SI")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2047425919U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2011069132U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(408887757U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3737469549U);
        } else if (nrhs==4) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(aiChksum, "dgacxA0tSRgzjN6nLub7GD") == 0) {
...
void Hqaud_model_LIB_SI_debug_initialize(void)
{
  _Hqaud_model_LIB_SIMachineNumber_ = sf_debug_initialize_machine(
    "Hqaud_model_LIB_SI","sfun",1,1,0,0,0);
  sf_debug_set_machine_event_thresholds(_Hqaud_model_LIB_SIMachineNumber_,0,0);
  sf_debug_set_machine_data_thresholds(_Hqaud_model_LIB_SIMachineNumber_,0);
}
...
mxArray* load_Hqaud_model_LIB_SI_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "Hqaud_model_LIB_SI", "Simulator_hquad_MPC_FG_trajectory");
