...
struct Parameters_controller_template_ {
  ...
  real_T UnitDelay2_X0_d;              /* Expression: 0
                                        ...
                                        */
  real_T Constant_Value_ln[16645];     /* Expression: Hn_Ydir
                                        * Referenced by: '<S50>/Constant'
                                        */
  real_T Constant1_Value_j[3329];      /* Expression: Kn_Ydir
                                        * Referenced by: '<S50>/Constant1'
                                        */
  real_T Constant2_Value_j[1575];      /* Expression: Fi_Ydir
                                        * Referenced by: '<S50>/Constant2'
                                        */
  real_T Constant3_Value_o[315];       /* Expression: Gi_Ydir
                                        * Referenced by: '<S50>/Constant3'
                                        */
  real_T Constant4_Value_g[315];       /* Expression: Nc_Ydir
  ...
  real_T Saturation3_LowerSat_es;      /* Expression: -1
                                        * Referenced by: '<S118>/Saturation3'
                                        */
  real_T X_ref_x_Value[1332];          /* Expression: traj_FG.X_ref_x
  ...
  real_T Constant1_Value_mu;           /* Expression: 1
                                        ...
                                        */
  real_T X_ref_x_Value_k[1332];        /* Expression: traj_FG.X_ref_x
  ...
  real_T Constant1_Value_h;            /* Expression: 1
                                        ...
                                        */
  real_T X_ref_y_Value[1332];          /* Expression: traj_FG.X_ref_y
                                        * Referenced by: '<S98>/X_ref_y'
                                        */
  real_T X_ref_y_Value_e[1332];        /* Expression: traj_FG.X_ref_y
                                        * Referenced by: '<S17>/X_ref_y'
                                        */
  real_T X_ref_z_Value[888];           /* Expression: traj_FG.X_ref_z
                                        * Referenced by: '<S98>/X_ref_z'
                                        */
  real_T X_ref_z_Value_a[888];         /* Expression: traj_FG.X_ref_z
                                        * Referenced by: '<S17>/X_ref_z'
                                        */
  real_T X_ref_yaw_Value[888];         /* Expression: traj_FG.X_ref_yaw
                                        * Referenced by: '<S98>/X_ref_yaw'
                                        */
  real_T X_ref_yaw_Value_f[888];       /* Expression: traj_FG.X_ref_yaw
