 ...
 *    '<S98>/generate_X_ref_x'
 */
void controller_tem_generate_X_ref_x(const real_T rtu_traj_x[1332], real_T
 ...
 *    '<S98>/generate_X_ref_y'
 */
void controller_tem_generate_X_ref_y(const real_T rtu_traj_y[1332], real_T
 ...
 *    '<S98>/generate_X_ref_yaw'
 */
void controller_t_generate_X_ref_yaw(const real_T rtu_X_ref_yaw_unbounded[888],
 ...
 *    '<S98>/generate_X_ref_z'
 */
void controller_tem_generate_X_ref_z(const real_T rtu_traj_z[888], real_T
      ...
      if (ireg < 134) {
        ...
        if (isinside == 1) {
          ...
          rtb_Saturation3_a = (((controller_template_P.Constant7_Value[ireg +
            134] * X[1] + controller_template_P.Constant7_Value[ireg] * X[0]) +
        ...
        rtb_Saturation3_a = (((controller_template_P.Constant7_Value[minreg +
          134] * X[1] + controller_template_P.Constant7_Value[minreg] * X[0]) +
    ...
    do {
      ...
      if (ireg < 315) {
        ...
        if (isinside == 1) {
          ...
          for (i = 0; i < 5; i++) {
            rtb_SliderGain_k += controller_template_P.Constant2_Value_j[315 * i
              + ireg] * X_0[i];
          }
...
void FG_traj_initialize(void)
{
  ...
  /* external mode info */
  controller_template_M->Sizes.checksums[0] = (2797423045U);
  controller_template_M->Sizes.checksums[1] = (3798148326U);
  controller_template_M->Sizes.checksums[2] = (3623658429U);
  controller_template_M->Sizes.checksums[3] = (139371640U);
