...
MODEL                   = FG_traj_fast
MODULES                 = FG_traj_fast_data.cpp rtGetInf.cpp rtGetNaN.cpp rt_nonfinite.cpp 
MAKEFILE                = FG_traj_fast.mk
...
NCSTATES                = 0
COMPUTER                = GLNXA64
BUILDARGS               =  GENERATE_ASAP2=0 OPTS="-DON_TARGET_WAIT_FOR_START=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ONESTEPFCN              = 1
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)/FG_traj_fast_ert_rtw \
	-I$(START_DIR) \
