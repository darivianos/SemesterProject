...
plot([hquad_traj_FG(2,:)',...
    hquad_traj_FG(3,:)',hquad_traj_FG(5,:)',hquad_traj_FG_bias(2,:)']);
...
plot([hquad_traj_FG(7,:)',...
    hquad_traj_FG(8,:)',hquad_traj_FG(10,:)',hquad_traj_FG_bias(3,:)']);
title('Position control with lqg');
legend('position','velocity','reference','Location','SouthEast');
ylabel('position (meter)');
xlabel('time (sec)');
...
plot([hquad_traj_FG(12,:)',...
    hquad_traj_FG(13,:)',hquad_traj_FG(14,:)',hquad_traj_FG_bias(4,:)']);
title('Position control with lqg');
legend('position','velocity','reference','Location','SouthEast');
ylabel('position (meter)');
xlabel('time (sec)');
