...
plot([hquad_pos_FG(2,:)',...
    hquad_pos_FG(4,:)',hquad_pos_FG(3,:)']);

start_time=1000;
end_time=2533;

start_time_camera=3300;
end_time_camera=start_time_camera+23/Ts;


% move starting point to 0/0
hquad_pos_FG(2,:)=hquad_pos_FG(2,:)-2;
hquad_pos_FG(5,:)=hquad_pos_FG(5,:)-2;
hquad_pos_FG(7,:)=hquad_pos_FG(7,:)+1.1391;
hquad_pos_FG(10,:)=hquad_pos_FG(10,:)+1.1391;
...
plot_nicely(hquad_pos_FG,start_time_camera,end_time_camera,'Hovering with Camera')
...
%% yaw - angle
% figure
% plot(hquad_pos_MPC(1,:)'-hquad_pos_MPC(1,1),[hquad_pos_MPC(16,:)',...
%     hquad_pos_MPC(17,:)',hquad_pos_MPC(18,:)']);
...
% %% 2D - Plot
% figure
% plot(hquad_pos_MPC(2,:)', hquad_pos_MPC(7,:)');
% hold on
% plot(hquad_pos_MPC(5,:)', hquad_pos_MPC(10,:)','-r');
...
% %% 3D - Plot
% figure
% plot3(hquad_pos_MPC(2,:)', hquad_pos_MPC(7,:)',hquad_pos_MPC(12,:)');
% hold on
% plot3(hquad_pos_MPC(5,:)', hquad_pos_MPC(10,:)',hquad_pos_MPC(14,:)','-r');
