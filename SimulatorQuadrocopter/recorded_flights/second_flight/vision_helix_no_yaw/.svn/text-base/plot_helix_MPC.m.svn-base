...
xlabel('time (sec)');
axis([0 25 -1.2 1.2]);
x=hquad_traj_FG(2,:)'-hquad_traj_FG(5,:)';
rms_vision_x = norm(x)/sqrt(length(x))  
...
xlabel('time (sec)');
axis([0 25 -1.2 1.2]);
y=hquad_traj_FG(7,:)'-hquad_traj_FG(10,:)';
rms_vision_y = norm(y)/sqrt(length(y))  
...
xlabel('time (sec)');
axis([0 25 -1.2 1.2]);
z=hquad_traj_FG(12,:)'-hquad_traj_FG(14,:)';
rms_vision_z = norm(z)/sqrt(length(z)) 
