...
load hquad_pos_LQR_bias.mat

plot([hquad_pos_LQR(7,:)',...
    hquad_pos_LQR(6,:)',hquad_pos_LQR_bias(3,:)']);

start_time=1000;
end_time=2144;

start_time_camera=2145;
end_time_camera=3140;


% move starting point to 0/0
hquad_pos_LQR(2,:)=hquad_pos_LQR(2,:)-2;
hquad_pos_LQR(5,:)=hquad_pos_LQR(5,:)-2;
hquad_pos_LQR(7,:)=hquad_pos_LQR(7,:)+0.4;
hquad_pos_LQR(10,:)=hquad_pos_LQR(10,:)+0.4;
...
% get trajectory data
hovering_vicon=hquad_pos_LQR(:,start_time:end_time);
hovering_camera=hquad_pos_LQR(:,start_time_camera:end_time_camera);
