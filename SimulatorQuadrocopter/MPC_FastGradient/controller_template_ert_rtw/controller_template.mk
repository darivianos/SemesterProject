...
#
# File    : ert_unix.tmf   $Revision: 1.55.4.55 $
#
# Abstract:
...
MODEL                   = controller_template
MODULES                 = controller_template_data.cpp rtGetInf.cpp rtGetNaN.cpp rt_nonfinite.cpp 
MAKEFILE                = controller_template.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2011b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2011b
MASTER_ANCHOR_DIR       = 
START_DIR               = /home/burrimi/git/darivianakis/SimulatorQuadrocopter/MPC_FastGradient
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
...
MODELLIB                  = controller_templatelib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)/controller_template_ert_rtw \
	-I$(START_DIR) \
	-I/home/burrimi/git/darivianakis/SimulatorQuadrocopter \
...
ifeq ($(SFCN),0)
  ...
  ifeq ($(MODELREF_TARGET_TYPE), NONE)
    ifeq ($(SHRLIBTARGET), 1)
      ...
      PRODUCT            = $(MODEL).so
      BIN_SETTING        = $(LD) $(SHRLIBLDFLAGS)$(MODEL).def -o $(PRODUCT) $(SYSLIBS) 
...
$(PRODUCT) : $(PREBUILT_OBJS) $(OBJS) $(SHARED_LIB) $(LIBS) $(SRC_DEP) $(MODELLIB) $(MODELREF_LINK_LIBS)
	$(BIN_SETTING) $(LINK_OBJS) $(PREBUILT_OBJS) $(MODELLIB) $(MODELREF_LINK_LIBS) $(SHARED_LIB) $(LIBFIXPT) $(LIBS) 
