  ...
  *chartInstance)
{
  ...
  real_T (*c1_X)[4];
  c1_flag_oob = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_Nc = (real_T (*)[346])ssGetInputPortSignal(chartInstance->S, 5);
  c1_Gi = (real_T (*)[346])ssGetInputPortSignal(chartInstance->S, 4);
  c1_Fi = (real_T (*)[1384])ssGetInputPortSignal(chartInstance->S, 3);
  c1_Kn = (real_T (*)[3068])ssGetInputPortSignal(chartInstance->S, 2);
  c1_Hn = (real_T (*)[12272])ssGetInputPortSignal(chartInstance->S, 1);
  c1_U = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  (SFc1_controller_templateInstanceStruct *chartInstance)
{
  ...
  real_T (*c1_b_Fi)[1384];
  real_T (*c1_b_Kn)[3068];
  real_T (*c1_b_Hn)[12272];
  real_T (*c1_b_X)[4];
  int32_T *c1_sfEvent;
  int32_T exitg1;
  c1_b_flag_oob = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_b_Nc = (real_T (*)[346])ssGetInputPortSignal(chartInstance->S, 5);
  c1_b_Gi = (real_T (*)[346])ssGetInputPortSignal(chartInstance->S, 4);
  c1_b_Fi = (real_T (*)[1384])ssGetInputPortSignal(chartInstance->S, 3);
  c1_b_Kn = (real_T (*)[3068])ssGetInputPortSignal(chartInstance->S, 2);
  c1_b_Hn = (real_T (*)[12272])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c1_i7 = 0; c1_i7 < 12272; c1_i7++) {
    c1_Hn[c1_i7] = (*c1_b_Hn)[c1_i7];
  }

  for (c1_i8 = 0; c1_i8 < 3068; c1_i8++) {
    c1_Kn[c1_i8] = (*c1_b_Kn)[c1_i8];
  }

  for (c1_i9 = 0; c1_i9 < 1384; c1_i9++) {
    c1_Fi[c1_i9] = (*c1_b_Fi)[c1_i9];
  }

  for (c1_i10 = 0; c1_i10 < 346; c1_i10++) {
    c1_Gi[c1_i10] = (*c1_b_Gi)[c1_i10];
  }

  for (c1_i11 = 0; c1_i11 < 346; c1_i11++) {
  ...
  do {
    ...
    if (c1_ireg < 346) {
      ...
      c1_d0 = c1_Nc[_SFD_EML_ARRAY_BOUNDS_CHECK("Nc", (int32_T)
        _SFD_INTEGER_CHECK("ireg", c1_b_ireg), 1, 346, 1, 0) - 1];
        ...
        while (c1_j < 4) {
          ...
          c1_Hi[(_SFD_EML_ARRAY_BOUNDS_CHECK("Hi", (int32_T)_SFD_INTEGER_CHECK(
            ...
            [(_SFD_EML_ARRAY_BOUNDS_CHECK("Hn", (int32_T)_SFD_INTEGER_CHECK(
                "abspos + i - 1", (c1_abspos + c1_b_i) - 1.0), 1, 3068, 1, 0) +
              3068 * (_SFD_EML_ARRAY_BOUNDS_CHECK("Hn", (int32_T)
      ...
      c1_c_ireg = _SFD_EML_ARRAY_BOUNDS_CHECK("Fi", (int32_T)_SFD_INTEGER_CHECK(
        "ireg", c1_b_ireg), 1, 346, 1, 0) - 1;
      for (c1_i20 = 0; c1_i20 < 4; c1_i20++) {
        c1_F[c1_i20] = c1_Fi[c1_c_ireg + 346 * c1_i20];
      }
      ...
      c1_b_minreg = _SFD_EML_ARRAY_BOUNDS_CHECK("Fi", (int32_T)
        _SFD_INTEGER_CHECK("minreg", c1_minreg), 1, 346, 1, 0) - 1;
      for (c1_i26 = 0; c1_i26 < 4; c1_i26++) {
        c1_F[c1_i26] = c1_Fi[c1_b_minreg + 346 * c1_i26];
      }

      _SFD_EML_CALL(0U, *c1_sfEvent, 59);
      c1_G = c1_Gi[_SFD_EML_ARRAY_BOUNDS_CHECK("Gi", (int32_T)_SFD_INTEGER_CHECK
        ("minreg", c1_minreg), 1, 346, 1, 0) - 1];
  ...
  *c1_inData)
{
  ...
  chartInstance = (SFc1_controller_templateInstanceStruct *)chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  for (c1_i29 = 0; c1_i29 < 346; c1_i29++) {
    c1_b_inData[c1_i29] = (*(real_T (*)[346])c1_inData)[c1_i29];
  }

  for (c1_i30 = 0; c1_i30 < 346; c1_i30++) {
    c1_u[c1_i30] = c1_b_inData[c1_i30];
  }

  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 1, 346), FALSE);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, FALSE);
  return c1_mxArrayOutData;
}
  ...
  *c1_inData)
{
  ...
  for (c1_i32 = 0; c1_i32 < 4; c1_i32++) {
    for (c1_i33 = 0; c1_i33 < 346; c1_i33++) {
      c1_b_inData[c1_i33 + c1_i31] = (*(real_T (*)[1384])c1_inData)[c1_i33 +
        c1_i31];
    }
  ...
  for (c1_i35 = 0; c1_i35 < 4; c1_i35++) {
    for (c1_i36 = 0; c1_i36 < 346; c1_i36++) {
  ...
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 2, 346, 4), FALSE);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, FALSE);
  return c1_mxArrayOutData;
}
  ...
  *c1_inData)
{
  ...
  chartInstance = (SFc1_controller_templateInstanceStruct *)chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  for (c1_i37 = 0; c1_i37 < 3068; c1_i37++) {
    c1_b_inData[c1_i37] = (*(real_T (*)[3068])c1_inData)[c1_i37];
  }

  for (c1_i38 = 0; c1_i38 < 3068; c1_i38++) {
    c1_u[c1_i38] = c1_b_inData[c1_i38];
  }

  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 1, 3068), FALSE);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, FALSE);
  return c1_mxArrayOutData;
}
  ...
  *c1_inData)
{
  ...
  for (c1_i40 = 0; c1_i40 < 4; c1_i40++) {
    for (c1_i41 = 0; c1_i41 < 3068; c1_i41++) {
      c1_b_inData[c1_i41 + c1_i39] = (*(real_T (*)[12272])c1_inData)[c1_i41 +
        c1_i39];
    }
  ...
  for (c1_i43 = 0; c1_i43 < 4; c1_i43++) {
    for (c1_i44 = 0; c1_i44 < 3068; c1_i44++) {
  ...
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 2, 3068, 4),
                FALSE);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, FALSE);
  return c1_mxArrayOutData;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(48674005U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1813687898U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(302422372U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1555539197U);
}
...
mxArray *sf_c1_controller_template_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("TprF1xYTje6Pr6DKDNBLJC");
...
static void mdlSetWorkWidths_c1_controller_template(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2361051595U));
  ssSetChecksum1(S,(1103067838U));
  ssSetChecksum2(S,(2897913086U));
  ssSetChecksum3(S,(638479870U));
