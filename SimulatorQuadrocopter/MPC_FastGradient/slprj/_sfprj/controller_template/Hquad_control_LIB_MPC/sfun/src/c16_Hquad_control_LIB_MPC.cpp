...
static void c16_update_debugger_state_c16_Hquad_control_LIB_MPC
  (SFc16_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
static void ext_mode_exec_c16_Hquad_control_LIB_MPC
  (SFc16_Hquad_control_LIB_MPCInstanceStruct *chartInstance);
...
static uint8_T c16_j_emlrt_marshallIn(SFc16_Hquad_control_LIB_MPCInstanceStruct *
  chartInstance, const mxArray *c16_is_active_c16_Hquad_control_LIB_MPC, const
  ...
  (SFc16_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c16_is_active_c16_Hquad_control_LIB_MPC = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c16_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c16_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c16_is_active_c16_Hquad_control_LIB_MPC = 0U;
}
  ...
  (SFc16_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c16_hoistedGlobal = *c16_is_active_c16_Hquad_control_LIB_MPC;
   ...
   *c16_st)
{
  ...
  *c16_is_active_c16_Hquad_control_LIB_MPC = c16_j_emlrt_marshallIn
  ...
  (SFc16_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c16_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 10U, *c16_sfEvent);
  ...
  (SFc16_Hquad_control_LIB_MPCInstanceStruct *chartInstance)
{
  ...
  c16_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 10U, *c16_sfEvent);
  ...
  sf_debug_symbol_scope_push_eml(0U, 18U, 18U, c16_debug_family_names,
    c16_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(&c16_n, 0U, c16_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c16_x_, 1U, c16_b_sf_marshallOut,
    c16_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c16_P_, 2U, c16_sf_marshallOut,
    c16_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c16_K, 3U, c16_g_sf_marshallOut,
    c16_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c16_nargin, 4U, c16_d_sf_marshallOut,
    c16_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c16_nargout, 5U,
    c16_d_sf_marshallOut, c16_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c16_A, 6U, c16_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c16_B, 7U, c16_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c16_C, 8U, c16_f_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c16_D, 9U, c16_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c16_Q, 10U, c16_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c16_R, 11U, c16_e_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c16_u, 12U, c16_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c16_y, 13U, c16_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c16_P, 14U, c16_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c16_state, 15U, c16_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c16_state_est, 16U,
    c16_b_sf_marshallOut, c16_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c16_P_est, 17U, c16_sf_marshallOut,
    c16_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 10U, *c16_sfEvent);
}
...
const mxArray *sf_c16_Hquad_control_LIB_MPC_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c16_m0, sf_mex_createstruct("nameCaptureInfo", 1, 29), FALSE);
  for (c16_i162 = 0; c16_i162 < 29; c16_i162++) {
...
static void c16_info_helper(c16_ResolvedFunctionInfo c16_info[29])
{
  ...
  c16_info[1].fileTimeLo = 1286818778U;
  ...
  c16_info[5].name = "eml_refblas_xgemm";
  c16_info[5].dominantType = "int32";
  c16_info[5].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m";
  c16_info[5].fileTimeLo = 1299076774U;
  c16_info[5].fileTimeHi = 0U;
  c16_info[5].mFileTimeLo = 0U;
  c16_info[5].mFileTimeHi = 0U;
  c16_info[6].context = "";
  c16_info[6].name = "mpower";
  c16_info[6].dominantType = "double";
  c16_info[6].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c16_info[6].fileTimeLo = 1286818842U;
  c16_info[6].fileTimeHi = 0U;
  c16_info[6].mFileTimeLo = 0U;
  c16_info[6].mFileTimeHi = 0U;
  c16_info[7].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c16_info[7].name = "eml_scalar_floor";
  c16_info[7].dominantType = "double";
  c16_info[7].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_floor.m";
  c16_info[7].fileTimeLo = 1286818726U;
  ...
  c16_info[8].name = "eml_scalar_abs";
  c16_info[8].dominantType = "double";
  c16_info[8].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m";
  c16_info[8].fileTimeLo = 1286818712U;
  ...
  c16_info[9].fileTimeLo = 1305318000U;
  ...
  if (c16_e > 0.0) {
    ...
    do {
      ...
      if (c16_ed2 == 0.0) {
        ...
        c16_g_eml_scalar_eg(chartInstance);
        c16_g_eml_scalar_eg(chartInstance);
        for (c16_i176 = 0; c16_i176 < 4; c16_i176++) {
          c16_A[c16_i176] = c16_a[c16_i176];
        }

        for (c16_i177 = 0; c16_i177 < 2; c16_i177++) {
          c16_i178 = 0;
          for (c16_i179 = 0; c16_i179 < 2; c16_i179++) {
            c16_a[c16_i178 + c16_i177] = 0.0;
            c16_i180 = 0;
            for (c16_i181 = 0; c16_i181 < 2; c16_i181++) {
              c16_a[c16_i178 + c16_i177] += c16_A[c16_i180 + c16_i177] *
                c16_A[c16_i181 + c16_i178];
              c16_i180 += 2;
            }
    ...
    if (c16_b < 0.0) {
      ...
      c16_f_x = 0.0;
      c16_g_x = c16_f_x;
      c16_c_y = muDoubleScalarAbs(c16_g_x);
      ...
      c16_k_x = 0.0;
      c16_l_x = c16_k_x;
      c16_e_y = muDoubleScalarAbs(c16_l_x);
      ...
      if (c16_d > c16_b_d) {
        ...
        c16_n_x = c16_m_x;
        c16_g_y = c16_f_y;
        c16_r = c16_n_x / c16_g_y;
        c16_b_a = c16_r;
        c16_c_b = c16_A[3];
        c16_h_y = c16_b_a * c16_c_b;
        c16_b_B = c16_h_y - c16_A[2];
        c16_i_y = c16_b_B;
        c16_j_y = c16_i_y;
        c16_t = 1.0 / c16_j_y;
        c16_c_A = c16_A[3];
        ...
        c16_p_x = c16_o_x;
        c16_l_y = c16_k_y;
        c16_m_y = c16_p_x / c16_l_y;
        c16_c_a = c16_m_y;
        c16_d_b = c16_t;
        c16_n_y = c16_c_a * c16_d_b;
        c16_c[0] = c16_n_y;
        c16_c[1] = -c16_t;
        c16_d_A = -c16_A[2];
        c16_d_B = c16_A[1];
        ...
        c16_r_x = c16_q_x;
        c16_p_y = c16_o_y;
        c16_q_y = c16_r_x / c16_p_y;
        c16_d_a = c16_q_y;
        c16_e_b = c16_t;
        c16_r_y = c16_d_a * c16_e_b;
        c16_c[2] = c16_r_y;
        c16_e_a = c16_r;
        c16_f_b = c16_t;
        c16_s_y = c16_e_a * c16_f_b;
        c16_c[3] = c16_s_y;
      } else {
        c16_e_A = c16_A[1];
        c16_e_B = c16_A[0];
        ...
        c16_t_x = c16_s_x;
        c16_u_y = c16_t_y;
        c16_r = c16_t_x / c16_u_y;
        c16_f_a = c16_r;
        c16_g_b = c16_A[2];
        c16_v_y = c16_f_a * c16_g_b;
        c16_f_B = c16_A[3] - c16_v_y;
        c16_w_y = c16_f_B;
        c16_x_y = c16_w_y;
        c16_t = 1.0 / c16_x_y;
        c16_f_A = c16_A[3];
        ...
        c16_v_x = c16_u_x;
        c16_ab_y = c16_y_y;
        c16_bb_y = c16_v_x / c16_ab_y;
        c16_g_a = c16_bb_y;
        c16_h_b = c16_t;
        c16_cb_y = c16_g_a * c16_h_b;
        c16_c[0] = c16_cb_y;
        c16_h_a = -c16_r;
        c16_i_b = c16_t;
        c16_db_y = c16_h_a * c16_i_b;
        c16_c[1] = c16_db_y;
        c16_g_A = -c16_A[2];
        c16_h_B = c16_A[0];
        c16_w_x = c16_g_A;
        ...
        c16_x_x = c16_w_x;
        c16_fb_y = c16_eb_y;
        c16_gb_y = c16_x_x / c16_fb_y;
        c16_i_a = c16_gb_y;
        c16_j_b = c16_t;
        c16_hb_y = c16_i_a * c16_j_b;
        c16_c[2] = c16_hb_y;
        c16_c[3] = c16_t;
      }

      for (c16_i172 = 0; c16_i172 < 4; c16_i172++) {
        c16_h_A[c16_i172] = c16_A[c16_i172];
      }

      c16_n1x = c16_norm(chartInstance, c16_h_A);
      for (c16_i173 = 0; c16_i173 < 4; c16_i173++) {
        c16_b_c[c16_i173] = c16_c[c16_i173];
      }

      c16_n1xinv = c16_norm(chartInstance, c16_b_c);
      c16_j_a = c16_n1x;
      c16_k_b = c16_n1xinv;
      c16_ib_y = c16_j_a * c16_k_b;
      c16_rc = 1.0 / c16_ib_y;
      guard1 = FALSE;
      guard2 = FALSE;
      if (c16_n1x == 0.0) {
        ...
        c16_y_x = c16_rc;
        c16_l_b = muDoubleScalarIsNaN(c16_y_x);
        guard3 = FALSE;
        if (c16_l_b) {
          guard3 = TRUE;
        } else {
        ...
        if (guard3 == TRUE) {
          c16_ab_x = c16_rc;
          for (c16_i174 = 0; c16_i174 < 8; c16_i174++) {
            c16_u[c16_i174] = c16_cv0[c16_i174];
          }

          c16_jb_y = NULL;
          sf_mex_assign(&c16_jb_y, sf_mex_create("y", c16_u, 10, 0U, 1U, 0U, 2,
            1, 8), FALSE);
          c16_b_u = 14.0;
          c16_kb_y = NULL;
          sf_mex_assign(&c16_kb_y, sf_mex_create("y", &c16_b_u, 0, 0U, 0U, 0U, 0),
                        FALSE);
          c16_c_u = 6.0;
          c16_lb_y = NULL;
          sf_mex_assign(&c16_lb_y, sf_mex_create("y", &c16_c_u, 0, 0U, 0U, 0U, 0),
                        FALSE);
          c16_d_u = c16_ab_x;
          c16_mb_y = NULL;
          sf_mex_assign(&c16_mb_y, sf_mex_create("y", &c16_d_u, 0, 0U, 0U, 0U, 0),
                        FALSE);
          c16_g_emlrt_marshallIn(chartInstance, sf_mex_call_debug("sprintf", 1U,
            2U, 14, sf_mex_call_debug("sprintf", 1U, 3U, 14, c16_jb_y, 14,
            c16_kb_y, 14, c16_lb_y), 14, c16_mb_y), "sprintf", c16_str);
          for (c16_i175 = 0; c16_i175 < 14; c16_i175++) {
            c16_b_str[c16_i175] = c16_str[c16_i175];
          }
    ...
    for (c16_i182 = 0; c16_i182 < 4; c16_i182++) {
      c16_c[c16_i182] = 0.0;
    }
  ...
  real_T c16_x[4])
{
  ...
  c16_j = 0;
  exitg1 = 0U;
  while ((exitg1 == 0U) && (c16_j < 2)) {
    c16_b_j = 1.0 + (real_T)c16_j;
    c16_s = 0.0;
    for (c16_i = 0; c16_i < 2; c16_i++) {
      c16_b_i = 1.0 + (real_T)c16_i;
      c16_b_x = c16_x[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
        _SFD_INTEGER_CHECK("", c16_b_i), 1, 2, 1, 0) +
                       ((_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
        _SFD_INTEGER_CHECK("", c16_b_j), 1, 2, 2, 0) - 1) << 1)) - 1];
      c16_c_x = c16_b_x;
  ...
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData)
{
  ...
  c16_thisId.fIdentifier = c16_identifier;
  c16_thisId.fParent = NULL;
  c16_y = c16_i_emlrt_marshallIn(chartInstance, sf_mex_dup(c16_sfEvent),
    &c16_thisId);
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_is_active_c16_Hquad_control_LIB_MPC), &c16_thisId);
  sf_mex_destroy(&c16_is_active_c16_Hquad_control_LIB_MPC);
  return c16_y;
}
...
static void sf_opaque_initialize_c16_Hquad_control_LIB_MPC(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc16_Hquad_control_LIB_MPCInstanceStruct*)
    chartInstanceVar)->S);
...
static void sf_opaque_ext_mode_exec_c16_Hquad_control_LIB_MPC(void
  *chartInstanceVar)
{
  ext_mode_exec_c16_Hquad_control_LIB_MPC
    ((SFc16_Hquad_control_LIB_MPCInstanceStruct*) chartInstanceVar);
}
...
mxArray *sf_c16_Hquad_control_LIB_MPC_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c16_Hquad_control_LIB_MPC\",T\"is_active_c16_Hquad_control_LIB_MPC\"}}"
  };
...
static void mdlSetWorkWidths_c16_Hquad_control_LIB_MPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,infoStruct,16,10);
      sf_mark_chart_reusable_outputs(S,infoStruct,16,2);
    }
...
{
  SFc16_Hquad_control_LIB_MPCInstanceStruct *chartInstance;
  chartInstance = (SFc16_Hquad_control_LIB_MPCInstanceStruct *)malloc(sizeof
  ...
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c16_Hquad_control_LIB_MPC;
