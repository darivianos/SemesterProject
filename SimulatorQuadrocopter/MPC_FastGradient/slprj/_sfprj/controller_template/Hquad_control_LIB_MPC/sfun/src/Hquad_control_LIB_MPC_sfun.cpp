  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==2) {
    c2_Hquad_control_LIB_MPC_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (chartFileNumber==22) {
    c22_Hquad_control_LIB_MPC_method_dispatcher(simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==23) {
    c23_Hquad_control_LIB_MPC_method_dispatcher(simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==24) {
    c24_Hquad_control_LIB_MPC_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (!strcmp(machineName, "Hquad_control_LIB_MPC")) {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        extern mxArray *sf_c2_Hquad_control_LIB_MPC_get_testpoint_info(void);
        plhs[0] = sf_c2_Hquad_control_LIB_MPC_get_testpoint_info();
        break;
      }
     ...
     case 22:
      {
        extern mxArray *sf_c22_Hquad_control_LIB_MPC_get_testpoint_info(void);
        plhs[0] = sf_c22_Hquad_control_LIB_MPC_get_testpoint_info();
        break;
      }

     case 23:
      {
        extern mxArray *sf_c23_Hquad_control_LIB_MPC_get_testpoint_info(void);
        plhs[0] = sf_c23_Hquad_control_LIB_MPC_get_testpoint_info();
        break;
      }

     case 24:
      {
        extern mxArray *sf_c24_Hquad_control_LIB_MPC_get_testpoint_info(void);
        plhs[0] = sf_c24_Hquad_control_LIB_MPC_get_testpoint_info();
        break;
      }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"Hquad_control_LIB_MPC")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1120869933U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1701885706U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2997490313U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1529694908U);
        } else if (nrhs==4) {
          unsigned int chartFileNumber;
          ...
          switch (chartFileNumber) {
           ...
           case 2:
            {
              extern void sf_c2_Hquad_control_LIB_MPC_get_check_sum(mxArray
                *plhs[]);
              sf_c2_Hquad_control_LIB_MPC_get_check_sum(plhs);
              break;
            }
           ...
           case 22:
            {
              extern void sf_c22_Hquad_control_LIB_MPC_get_check_sum(mxArray
                *plhs[]);
              sf_c22_Hquad_control_LIB_MPC_get_check_sum(plhs);
              break;
            }

           case 23:
            {
              extern void sf_c23_Hquad_control_LIB_MPC_get_check_sum(mxArray
                *plhs[]);
              sf_c23_Hquad_control_LIB_MPC_get_check_sum(plhs);
              break;
            }

           case 24:
            {
              extern void sf_c24_Hquad_control_LIB_MPC_get_check_sum(mxArray
                *plhs[]);
              sf_c24_Hquad_control_LIB_MPC_get_check_sum(plhs);
              break;
            }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "OHyhmGlgSOxrtod3vbHBvD") == 0) {
          extern mxArray *sf_c2_Hquad_control_LIB_MPC_get_autoinheritance_info
            (void);
          plhs[0] = sf_c2_Hquad_control_LIB_MPC_get_autoinheritance_info();
          break;
        }
     ...
     case 22:
      {
        if (strcmp(aiChksum, "XyCL0xeYkImGQUKVG2ob4E") == 0) {
          extern mxArray *sf_c22_Hquad_control_LIB_MPC_get_autoinheritance_info
            (void);
          plhs[0] = sf_c22_Hquad_control_LIB_MPC_get_autoinheritance_info();
          break;
        }
     ...
     case 23:
      {
        if (strcmp(aiChksum, "QWvqjCTmE70DHayvSjWvyB") == 0) {
          extern mxArray *sf_c23_Hquad_control_LIB_MPC_get_autoinheritance_info
            (void);
          plhs[0] = sf_c23_Hquad_control_LIB_MPC_get_autoinheritance_info();
          break;
        }
     ...
     case 24:
      {
        if (strcmp(aiChksum, "1NZmy9QUKO8Wfv2iXGmfmE") == 0) {
          extern mxArray *sf_c24_Hquad_control_LIB_MPC_get_autoinheritance_info
            (void);
          plhs[0] = sf_c24_Hquad_control_LIB_MPC_get_autoinheritance_info();
          break;
        }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        ...
        mxArray *persistentMxArray = (mxArray *)
          sf_c2_Hquad_control_LIB_MPC_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
     ...
     case 22:
      {
        ...
        mxArray *persistentMxArray = (mxArray *)
          sf_c22_Hquad_control_LIB_MPC_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
     ...
     case 23:
      {
        extern const mxArray
          *sf_c23_Hquad_control_LIB_MPC_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c23_Hquad_control_LIB_MPC_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
     ...
     case 24:
      {
        extern const mxArray
          *sf_c24_Hquad_control_LIB_MPC_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c24_Hquad_control_LIB_MPC_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
...
void Hquad_control_LIB_MPC_debug_initialize(void)
{
  _Hquad_control_LIB_MPCMachineNumber_ = sf_debug_initialize_machine(
    "Hquad_control_LIB_MPC","sfun",1,15,0,0,0);
