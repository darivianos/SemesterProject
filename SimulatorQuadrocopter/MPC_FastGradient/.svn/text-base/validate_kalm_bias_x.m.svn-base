...
%
% function: validate the kalman filter for the x - Axis
%
...
load validation_data/hquad_pos_FG_bad_vicon.mat;
...
cmd=hquad_pos_FG(6,:);
y_meas=[hquad_pos_FG(2,:);hquad_pos_FG(3,:);hquad_pos_FG(4,:)];
x_init=[y_meas(:,1);0];


% simulate filter
x_est=simulate_kalman(kalm_mpc_x, cmd, y_meas, x_init);
