...
static void c3_update_debugger_state_c3_controller_template
  (SFc3_controller_templateInstanceStruct *chartInstance);
static void ext_mode_exec_c3_controller_template
  (SFc3_controller_templateInstanceStruct *chartInstance);
...
static void c3_round(SFc3_controller_templateInstanceStruct *chartInstance,
                     real_T c3_x[3], real_T c3_b_x[3]);
static void c3_mrdivide(SFc3_controller_templateInstanceStruct *chartInstance,
  real_T c3_A[3], real_T c3_B, real_T c3_y[3]);
...
static uint8_T c3_g_emlrt_marshallIn(SFc3_controller_templateInstanceStruct
  *chartInstance, const mxArray *c3_is_active_c3_controller_template, const
...
{
  int32_T *c3_sfEvent;
  uint8_T *c3_is_active_c3_controller_template;
  c3_is_active_c3_controller_template = (uint8_T *)ssGetDWork(chartInstance->S,
    3);
  c3_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c3_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c3_is_active_c3_controller_template = 0U;
}
  ...
  (SFc3_controller_templateInstanceStruct *chartInstance)
{
  ...
  c3_c_hoistedGlobal = *c3_is_active_c3_controller_template;
  ...
  (SFc3_controller_templateInstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_flag_oob = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 1)), "flag_oob");
  *c3_is_active_c3_controller_template = c3_g_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 2)), "is_active_c3_controller_template");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_controller_template(chartInstance);
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_is_active_c3_controller_template), &c3_thisId);
  sf_mex_destroy(&c3_is_active_c3_controller_template);
  return c3_y;
}
...
{
  sf_check_dwork_consistency(((SFc3_controller_templateInstanceStruct*)
    chartInstanceVar)->S);
...
static void sf_opaque_ext_mode_exec_c3_controller_template(void
  *chartInstanceVar)
{
  ext_mode_exec_c3_controller_template((SFc3_controller_templateInstanceStruct*)
    chartInstanceVar);
}
...
mxArray *sf_c3_controller_template_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c3_controller_template\",T\"is_active_c3_controller_template\"}}"
  };
...
{
  SFc3_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc3_controller_templateInstanceStruct *)malloc(sizeof
  ...
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c3_controller_template;
