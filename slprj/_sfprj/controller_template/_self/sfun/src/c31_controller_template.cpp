  ...
  *chartInstance)
{
  ...
  real_T (*c31_b_traj_x)[909];
  c31_b_idx = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c31_b_X_ref_x = (real_T (*)[93])ssGetOutputPortSignal(chartInstance->S, 1);
  c31_b_traj_x = (real_T (*)[909])ssGetInputPortSignal(chartInstance->S, 0);
  c31_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 22U, *c31_sfEvent);
  for (c31_i2 = 0; c31_i2 < 909; c31_i2++) {
  ...
  *c31_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 22U, *c31_sfEvent);
  c31_hoistedGlobal = *c31_b_idx;
  for (c31_i4 = 0; c31_i4 < 909; c31_i4++) {
    ...
    for (c31_i6 = 0; c31_i6 < 3; c31_i6++) {
      c31_X_ref_x[c31_i6 + 3 * c31_i5] = c31_traj_x[c31_i6 + 3 *
        (_SFD_EML_ARRAY_BOUNDS_CHECK("traj_x", (int32_T)_SFD_INTEGER_CHECK(
           "idx:idx+pred_horizon_x", c31_idx + (real_T)c31_i5), 1, 303, 2, 0) -
         1)];
    }
  }
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 22U, *c31_sfEvent);
  ...
  *c31_inData)
{
  ...
  c31_mxArrayOutData = NULL;
  c31_i18 = 0;
  for (c31_i19 = 0; c31_i19 < 303; c31_i19++) {
    for (c31_i20 = 0; c31_i20 < 3; c31_i20++) {
      c31_b_inData[c31_i20 + c31_i18] = (*(real_T (*)[909])c31_inData)[c31_i20 +
        c31_i18];
    }
  ...
  c31_i21 = 0;
  for (c31_i22 = 0; c31_i22 < 303; c31_i22++) {
  ...
  c31_y = NULL;
  sf_mex_assign(&c31_y, sf_mex_create("y", c31_u, 0, 0U, 1U, 0U, 2, 3, 303),
                FALSE);
  sf_mex_assign(&c31_mxArrayOutData, c31_y, FALSE);
  return c31_mxArrayOutData;
}
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c31_X_ref_x = (real_T (*)[93])ssGetOutputPortSignal(chartInstance->S,
            1);
          c31_traj_x = (real_T (*)[909])ssGetInputPortSignal(chartInstance->S, 0);
