  ...
  *chartInstance)
{
  ...
  c12_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 8U, *c12_sfEvent);
  ...
  *c12_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 8U, *c12_sfEvent);
  ...
  *c12_b_pitch_cmd_out = c12_pitch_cmd_out;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 8U, *c12_sfEvent);
