...
static void initialize_c29_controller_template
  (SFc29_controller_templateInstanceStruct *chartInstance);
static void initialize_params_c29_controller_template
  (SFc29_controller_templateInstanceStruct *chartInstance);
static void enable_c29_controller_template
  (SFc29_controller_templateInstanceStruct *chartInstance);
static void disable_c29_controller_template
  (SFc29_controller_templateInstanceStruct *chartInstance);
static void c29_update_debugger_state_c29_controller_template
  (SFc29_controller_templateInstanceStruct *chartInstance);
static void ext_mode_exec_c29_controller_template
  (SFc29_controller_templateInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c29_controller_template
  (SFc29_controller_templateInstanceStruct *chartInstance);
static void set_sim_state_c29_controller_template
  (SFc29_controller_templateInstanceStruct *chartInstance, const mxArray *c29_st);
static void finalize_c29_controller_template
  (SFc29_controller_templateInstanceStruct *chartInstance);
static void sf_c29_controller_template(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_chartstep_c29_controller_template
  (SFc29_controller_templateInstanceStruct *chartInstance);
...
static const mxArray *c29_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static void c29_emlrt_marshallIn(SFc29_controller_templateInstanceStruct
  *chartInstance, const mxArray *c29_P_est, const char_T *c29_identifier, real_T
  c29_y[9]);
static void c29_b_emlrt_marshallIn(SFc29_controller_templateInstanceStruct
...
static const mxArray *c29_b_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static void c29_c_emlrt_marshallIn(SFc29_controller_templateInstanceStruct
  *chartInstance, const mxArray *c29_state_est, const char_T *c29_identifier,
  real_T c29_y[3]);
static void c29_d_emlrt_marshallIn(SFc29_controller_templateInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId,
  real_T c29_y[3]);
...
static const mxArray *c29_f_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static real_T c29_e_emlrt_marshallIn(SFc29_controller_templateInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
...
static const mxArray *c29_g_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static void c29_f_emlrt_marshallIn(SFc29_controller_templateInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId,
  real_T c29_y[6]);
...
static void c29_eml_scalar_eg(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_b_eml_scalar_eg(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_c_eml_scalar_eg(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_d_eml_scalar_eg(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_e_eml_scalar_eg(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_mpower(SFc29_controller_templateInstanceStruct *chartInstance,
  real_T c29_a[4], real_T c29_c[4]);
static void c29_matrix_to_integer_power(SFc29_controller_templateInstanceStruct *
  chartInstance, real_T c29_a[4], real_T c29_b, real_T c29_c[4]);
static void c29_f_eml_scalar_eg(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_g_eml_scalar_eg(SFc29_controller_templateInstanceStruct
  *chartInstance);
static real_T c29_norm(SFc29_controller_templateInstanceStruct *chartInstance,
  real_T c29_x[4]);
static void c29_eml_warning(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_b_eml_warning(SFc29_controller_templateInstanceStruct
  *chartInstance, char_T c29_varargin_2[14]);
static void c29_h_eml_scalar_eg(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_i_eml_scalar_eg(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_j_eml_scalar_eg(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_eye(SFc29_controller_templateInstanceStruct *chartInstance,
                    real_T c29_I[9]);
static void c29_k_eml_scalar_eg(SFc29_controller_templateInstanceStruct
  *chartInstance);
static void c29_g_emlrt_marshallIn(SFc29_controller_templateInstanceStruct
  *chartInstance, const mxArray *c29_sprintf, const char_T *c29_identifier,
  char_T c29_y[14]);
static void c29_h_emlrt_marshallIn(SFc29_controller_templateInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId,
  char_T c29_y[14]);
static const mxArray *c29_h_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static int32_T c29_i_emlrt_marshallIn(SFc29_controller_templateInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
static void c29_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c29_mxArrayInData, const char_T *c29_varName, void *c29_outData);
static uint8_T c29_j_emlrt_marshallIn(SFc29_controller_templateInstanceStruct
  *chartInstance, const mxArray *c29_is_active_c29_controller_template, const
  char_T *c29_identifier);
static uint8_T c29_k_emlrt_marshallIn(SFc29_controller_templateInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
static void init_dsm_address_info(SFc29_controller_templateInstanceStruct
  *chartInstance);
...
{
  int32_T *c29_sfEvent;
  uint8_T *c29_is_active_c29_controller_template;
  c29_is_active_c29_controller_template = (uint8_T *)ssGetDWork(chartInstance->S,
    3);
  c29_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c29_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c29_is_active_c29_controller_template = 0U;
}
...
static void ext_mode_exec_c29_controller_template
  (SFc29_controller_templateInstanceStruct *chartInstance)
{
  c29_update_debugger_state_c29_controller_template(chartInstance);
}
  ...
  (SFc29_controller_templateInstanceStruct *chartInstance)
{
  ...
  c29_hoistedGlobal = *c29_is_active_c29_controller_template;
  ...
  (SFc29_controller_templateInstanceStruct *chartInstance, const mxArray *c29_st)
{
  ...
  *c29_is_active_c29_controller_template = c29_j_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c29_u, 2)), "is_active_c29_controller_template");
  ...
  *chartInstance)
{
  ...
  c29_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 20U, *c29_sfEvent);
  ...
  *c29_sfEvent = CALL_EVENT;
  c29_chartstep_c29_controller_template(chartInstance);
  ...
  (SFc29_controller_templateInstanceStruct *chartInstance)
{
  ...
  c29_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 20U, *c29_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 20U, *c29_sfEvent);
}
  ...
  *c29_inData)
{
  ...
  const mxArray *c29_y = NULL;
  SFc29_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc29_controller_templateInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c29_controller_template_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c29_identifier)
{
  ...
  c29_y = c29_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c29_is_active_c29_controller_template), &c29_thisId);
  sf_mex_destroy(&c29_is_active_c29_controller_template);
  return c29_y;
}
...
void sf_c29_controller_template_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c29_controller_template_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c29_controller_template(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[29],T\"P_est\",},{M[1],M[5],T\"state_est\",},{M[8],M[0],T\"is_active_c29_controller_template\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c29_controller_template_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc29_controller_templateInstanceStruct *chartInstance;
    chartInstance = (SFc29_controller_templateInstanceStruct *)
...
static void sf_opaque_initialize_c29_controller_template(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc29_controller_templateInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc29_controller_templateInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c29_controller_template
    ((SFc29_controller_templateInstanceStruct*) chartInstanceVar);
  initialize_c29_controller_template((SFc29_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c29_controller_template(void *chartInstanceVar)
{
  enable_c29_controller_template((SFc29_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c29_controller_template(void *chartInstanceVar)
{
  disable_c29_controller_template((SFc29_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c29_controller_template(void *chartInstanceVar)
{
  sf_c29_controller_template((SFc29_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c29_controller_template(void
  *chartInstanceVar)
{
  ext_mode_exec_c29_controller_template((SFc29_controller_templateInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c29_controller_template
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c29_controller_template
    ((SFc29_controller_templateInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c29_controller_template();/* state var info */
...
extern void sf_internal_set_sim_state_c29_controller_template(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c29_controller_template((SFc29_controller_templateInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c29_controller_template(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c29_controller_template(S);
}

static void sf_opaque_set_sim_state_c29_controller_template(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c29_controller_template(S, st);
}

static void sf_opaque_terminate_c29_controller_template(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc29_controller_templateInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c29_controller_template((SFc29_controller_templateInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc29_controller_template((SFc29_controller_templateInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c29_controller_template(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c29_controller_template
      ((SFc29_controller_templateInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c29_controller_template_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c29_controller_template\",T\"is_active_c29_controller_template\"}}"
  };
...
static void mdlSetWorkWidths_c29_controller_template(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_optimization_info();
...
static void mdlRTW_c29_controller_template(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c29_controller_template(SimStruct *S)
{
  SFc29_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc29_controller_templateInstanceStruct *)malloc(sizeof
    (SFc29_controller_templateInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc29_controller_templateInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c29_controller_template;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c29_controller_template;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c29_controller_template;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c29_controller_template;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c29_controller_template;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c29_controller_template;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c29_controller_template;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c29_controller_template;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c29_controller_template;
  chartInstance->chartInfo.mdlStart = mdlStart_c29_controller_template;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c29_controller_template;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c29_controller_template;
...
void c29_controller_template_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c29_controller_template(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c29_controller_template(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c29_controller_template(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c29_controller_template_method_dispatcher.\n"
