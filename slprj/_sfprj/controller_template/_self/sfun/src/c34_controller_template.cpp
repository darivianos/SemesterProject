  ...
  *chartInstance)
{
  ...
  real_T (*c34_b_traj_z)[606];
  c34_b_idx = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c34_b_X_ref_z = (real_T (*)[62])ssGetOutputPortSignal(chartInstance->S, 1);
  c34_b_traj_z = (real_T (*)[606])ssGetInputPortSignal(chartInstance->S, 0);
  c34_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 25U, *c34_sfEvent);
  for (c34_i2 = 0; c34_i2 < 606; c34_i2++) {
  ...
  *c34_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 25U, *c34_sfEvent);
  c34_hoistedGlobal = *c34_b_idx;
  for (c34_i4 = 0; c34_i4 < 606; c34_i4++) {
    ...
    for (c34_i6 = 0; c34_i6 < 2; c34_i6++) {
      c34_X_ref_z[c34_i6 + (c34_i5 << 1)] = c34_traj_z[c34_i6 +
        ((_SFD_EML_ARRAY_BOUNDS_CHECK("traj_z", (int32_T)_SFD_INTEGER_CHECK(
            "idx:idx+pred_horizon_z", c34_idx + (real_T)c34_i5), 1, 303, 2, 0) -
          1) << 1)];
    }
  }
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 25U, *c34_sfEvent);
  ...
  *c34_inData)
{
  ...
  c34_mxArrayOutData = NULL;
  c34_i18 = 0;
  for (c34_i19 = 0; c34_i19 < 303; c34_i19++) {
    for (c34_i20 = 0; c34_i20 < 2; c34_i20++) {
      c34_b_inData[c34_i20 + c34_i18] = (*(real_T (*)[606])c34_inData)[c34_i20 +
        c34_i18];
    }
  ...
  c34_i21 = 0;
  for (c34_i22 = 0; c34_i22 < 303; c34_i22++) {
  ...
  c34_y = NULL;
  sf_mex_assign(&c34_y, sf_mex_create("y", c34_u, 0, 0U, 1U, 0U, 2, 2, 303),
                FALSE);
  sf_mex_assign(&c34_mxArrayOutData, c34_y, FALSE);
  return c34_mxArrayOutData;
}
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c34_X_ref_z = (real_T (*)[62])ssGetOutputPortSignal(chartInstance->S,
            1);
          c34_traj_z = (real_T (*)[606])ssGetInputPortSignal(chartInstance->S, 0);
