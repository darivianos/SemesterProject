  ...
  *chartInstance)
{
  ...
  real_T (*c20_b_traj_y)[909];
  c20_b_idx = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c20_b_X_ref_y = (real_T (*)[93])ssGetOutputPortSignal(chartInstance->S, 1);
  c20_b_traj_y = (real_T (*)[909])ssGetInputPortSignal(chartInstance->S, 0);
  c20_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 13U, *c20_sfEvent);
  for (c20_i2 = 0; c20_i2 < 909; c20_i2++) {
  ...
  *c20_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 13U, *c20_sfEvent);
  c20_hoistedGlobal = *c20_b_idx;
  for (c20_i4 = 0; c20_i4 < 909; c20_i4++) {
    ...
    for (c20_i6 = 0; c20_i6 < 3; c20_i6++) {
      c20_X_ref_y[c20_i6 + 3 * c20_i5] = c20_traj_y[c20_i6 + 3 *
        (_SFD_EML_ARRAY_BOUNDS_CHECK("traj_y", (int32_T)_SFD_INTEGER_CHECK(
           "idx:idx+pred_horizon_y", c20_idx + (real_T)c20_i5), 1, 303, 2, 0) -
         1)];
    }
  }
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 13U, *c20_sfEvent);
  ...
  *c20_inData)
{
  ...
  c20_mxArrayOutData = NULL;
  c20_i18 = 0;
  for (c20_i19 = 0; c20_i19 < 303; c20_i19++) {
    for (c20_i20 = 0; c20_i20 < 3; c20_i20++) {
      c20_b_inData[c20_i20 + c20_i18] = (*(real_T (*)[909])c20_inData)[c20_i20 +
        c20_i18];
    }
  ...
  c20_i21 = 0;
  for (c20_i22 = 0; c20_i22 < 303; c20_i22++) {
  ...
  c20_y = NULL;
  sf_mex_assign(&c20_y, sf_mex_create("y", c20_u, 0, 0U, 1U, 0U, 2, 3, 303),
                FALSE);
  sf_mex_assign(&c20_mxArrayOutData, c20_y, FALSE);
  return c20_mxArrayOutData;
}
      ...
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c20_X_ref_y = (real_T (*)[93])ssGetOutputPortSignal(chartInstance->S,
            1);
          c20_traj_y = (real_T (*)[909])ssGetInputPortSignal(chartInstance->S, 0);
