  ...
  *chartInstance)
{
  ...
  c44_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 28U, *c44_sfEvent);
  ...
  *c44_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 28U, *c44_sfEvent);
  ...
  *c44_c_M = c44_M;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 28U, *c44_sfEvent);
