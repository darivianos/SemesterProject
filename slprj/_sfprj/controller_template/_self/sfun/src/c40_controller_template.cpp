...
static void initialize_params_c40_controller_template
  (SFc40_controller_templateInstanceStruct *chartInstance);
static void enable_c40_controller_template
  (SFc40_controller_templateInstanceStruct *chartInstance);
static void disable_c40_controller_template
  (SFc40_controller_templateInstanceStruct *chartInstance);
static void c40_update_debugger_state_c40_controller_template
  (SFc40_controller_templateInstanceStruct *chartInstance);
static void ext_mode_exec_c40_controller_template
  (SFc40_controller_templateInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c40_controller_template
  (SFc40_controller_templateInstanceStruct *chartInstance);
static void set_sim_state_c40_controller_template
  (SFc40_controller_templateInstanceStruct *chartInstance, const mxArray *c40_st);
static void finalize_c40_controller_template
  (SFc40_controller_templateInstanceStruct *chartInstance);
static void sf_c40_controller_template(SFc40_controller_templateInstanceStruct
  *chartInstance);
static void initSimStructsc40_controller_template
  (SFc40_controller_templateInstanceStruct *chartInstance);
...
static const mxArray *c40_b_sf_marshallOut(void *chartInstanceVoid, void
  *c40_inData);
static int32_T c40_c_emlrt_marshallIn(SFc40_controller_templateInstanceStruct
  *chartInstance, const mxArray *c40_u, const emlrtMsgIdentifier *c40_parentId);
static void c40_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c40_mxArrayInData, const char_T *c40_varName, void *c40_outData);
static uint8_T c40_d_emlrt_marshallIn(SFc40_controller_templateInstanceStruct
  *chartInstance, const mxArray *c40_is_active_c40_controller_template, const
  char_T *c40_identifier);
static uint8_T c40_e_emlrt_marshallIn(SFc40_controller_templateInstanceStruct
  *chartInstance, const mxArray *c40_u, const emlrtMsgIdentifier *c40_parentId);
static void init_dsm_address_info(SFc40_controller_templateInstanceStruct
  *chartInstance);
  ...
  (SFc40_controller_templateInstanceStruct *chartInstance)
{
  ...
  *c40_is_active_c40_controller_template = 0U;
}
...
static void ext_mode_exec_c40_controller_template
  (SFc40_controller_templateInstanceStruct *chartInstance)
{
  c40_update_debugger_state_c40_controller_template(chartInstance);
}
  ...
  (SFc40_controller_templateInstanceStruct *chartInstance)
{
  ...
  c40_b_hoistedGlobal = *c40_is_active_c40_controller_template;
  ...
  *chartInstance)
{
  ...
  c40_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 27U, *c40_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c40_b_u, 0U);
  _SFD_DATA_RANGE_CHECK(*c40_b_y, 1U);
  _SFD_DATA_RANGE_CHECK(*c40_b_thres, 2U);
  *c40_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 27U, *c40_sfEvent);
  ...
  *c40_b_y = c40_y;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 27U, *c40_sfEvent);
...
const mxArray *sf_c40_controller_template_get_eml_resolved_functions_info(void)
{
...
static void c40_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c40_mxArrayInData, const char_T *c40_varName, void *c40_outData)
{
  const mxArray *c40_sfEvent;
  const char_T *c40_identifier;
  emlrtMsgIdentifier c40_thisId;
  int32_T c40_y;
  SFc40_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc40_controller_templateInstanceStruct *)chartInstanceVoid;
  c40_sfEvent = sf_mex_dup(c40_mxArrayInData);
  c40_identifier = c40_varName;
  c40_thisId.fIdentifier = c40_identifier;
  c40_thisId.fParent = NULL;
  c40_y = c40_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c40_sfEvent),
    &c40_thisId);
  sf_mex_destroy(&c40_sfEvent);
  ...
  char_T *c40_identifier)
{
  ...
  c40_y = c40_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c40_is_active_c40_controller_template), &c40_thisId);
  sf_mex_destroy(&c40_is_active_c40_controller_template);
  return c40_y;
}
...
static const mxArray *sf_get_sim_state_info_c40_controller_template(void)
{
  ...
  sf_c40_controller_template_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc40_controller_templateInstanceStruct *chartInstance;
    chartInstance = (SFc40_controller_templateInstanceStruct *)
...
static void sf_opaque_initialize_c40_controller_template(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc40_controller_templateInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc40_controller_templateInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c40_controller_template
    ((SFc40_controller_templateInstanceStruct*) chartInstanceVar);
  initialize_c40_controller_template((SFc40_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c40_controller_template(void *chartInstanceVar)
{
  enable_c40_controller_template((SFc40_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c40_controller_template(void *chartInstanceVar)
{
  disable_c40_controller_template((SFc40_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c40_controller_template(void *chartInstanceVar)
{
  sf_c40_controller_template((SFc40_controller_templateInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c40_controller_template(void
  *chartInstanceVar)
{
  ext_mode_exec_c40_controller_template((SFc40_controller_templateInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c40_controller_template
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c40_controller_template
    ((SFc40_controller_templateInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c40_controller_template();/* state var info */
...
extern void sf_internal_set_sim_state_c40_controller_template(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c40_controller_template((SFc40_controller_templateInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c40_controller_template(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c40_controller_template(S);
}

static void sf_opaque_set_sim_state_c40_controller_template(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c40_controller_template(S, st);
}

static void sf_opaque_terminate_c40_controller_template(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc40_controller_templateInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c40_controller_template((SFc40_controller_templateInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc40_controller_template((SFc40_controller_templateInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c40_controller_template(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c40_controller_template
      ((SFc40_controller_templateInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c40_controller_template_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c40_controller_template\",T\"is_active_c40_controller_template\"}}"
  };
...
static void mdlSetWorkWidths_c40_controller_template(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_controller_template_optimization_info();
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,infoStruct,40);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,infoStruct,40,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,infoStruct,40,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,infoStruct,40,2);
      sf_mark_chart_reusable_outputs(S,infoStruct,40,1);
    }

    sf_set_rtw_dwork_info(S,infoStruct,40);
...
static void mdlRTW_c40_controller_template(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c40_controller_template(SimStruct *S)
{
  SFc40_controller_templateInstanceStruct *chartInstance;
  chartInstance = (SFc40_controller_templateInstanceStruct *)malloc(sizeof
    (SFc40_controller_templateInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc40_controller_templateInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c40_controller_template;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c40_controller_template;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c40_controller_template;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c40_controller_template;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c40_controller_template;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c40_controller_template;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c40_controller_template;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c40_controller_template;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c40_controller_template;
  chartInstance->chartInfo.mdlStart = mdlStart_c40_controller_template;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c40_controller_template;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c40_controller_template;
...
void c40_controller_template_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c40_controller_template(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c40_controller_template(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c40_controller_template(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c40_controller_template_method_dispatcher.\n"
