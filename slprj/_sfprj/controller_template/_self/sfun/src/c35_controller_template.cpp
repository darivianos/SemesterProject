  ...
  *chartInstance)
{
  ...
  c35_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 26U, *c35_sfEvent);
  ...
  *c35_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 26U, *c35_sfEvent);
  ...
  *c35_b_en = c35_en;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 26U, *c35_sfEvent);
