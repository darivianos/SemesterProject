  ...
  *chartInstance)
{
  ...
  c4_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, *c4_sfEvent);
  ...
  (SFc4_controller_templateInstanceStruct *chartInstance)
{
  ...
  c4_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, *c4_sfEvent);
  ...
  *c4_b_flag_oob = c4_flag_oob;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, *c4_sfEvent);
}
